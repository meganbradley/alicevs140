...
3.  If the error continues, save your work and restart [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)].  
  
4.  If the error reoccurs, reinstall [!INCLUDE[vbprvb](../vs140/includes/vbprvb_md.md)].  
