...
The base class or interface 'class' in assembly 'assembly' referenced by type 'type' could not be resolved  
 ...
 For more information, see [Add Reference Dialog Box](assetId:///2feb0fe2-0805-4cc9-8cba-b0315849dfb7) and [/reference (Import Metadata) (C# Compiler Options)](../vs140/-reference--C#-Compiler-Options-.md).  
