...
|`name`|Required. Name of the array variable. See [Declared Element Names](../vs140/Declared-Element-Names--Visual-Basic-.md).|  
...
## Example  
 ...
 For additional examples, see [Arrays in Visual Basic](../Topic/Arrays%20in%20Visual%20Basic.md).  
