...
The following example refactors the previous example, [Refactoring Using an Extension Method (C#)](../vs140/Refactoring-Using-an-Extension-Method--C#-.md), to use a pure function In this example, the code to find the text of a paragraph is moved to the pure static method `ParagraphText`.  
...
-   [Projecting XML in a Different Shape (C#)](../vs140/Projecting-XML-in-a-Different-Shape--C#-.md)  
