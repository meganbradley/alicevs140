...
> [!NOTE]
>  You must use wildcards with items to specifiy the inputs for a build; you cannot specify the inputs using the `Sources` attribute in [!INCLUDE[vstecmsbuild](../vs140/includes/vstecmsbuild_md.md)] tasks such as [Csc](../vs140/Csc-Task.md) or [Vbc](../Topic/Vbc%20Task.md). The following example is not valid in a project file:  
>   
>  `<CSC Sources="*.cs">...</CSC>`  
