...
The `CSettingsStoreSP` class is a helper class that you can use to create instances of the [CSettingsStore Class](../vs140/CSettingsStore-Class.md).  
...
2.  Use [DECLARE_DYNCREATE](../vs140/DECLARE_DYNCREATE.md) and [IMPLEMENT_DYNCREATE](../vs140/IMPLEMENT_DYNCREATE.md) macros with your custom `CSettingsStore` class to enable dynamic creation.  
...
4.  In your application, call `CSettingsStoreSP::SetRuntimeClass` and pass in a pointer to the [CRuntimeClass Structure](../vs140/CRuntimeClass-Structure.md) obtained from your class.  
