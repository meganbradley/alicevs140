...
In [!INCLUDE[vsPreShort](../vs140/includes/vsPreShort_md.md)] and [!INCLUDE[vsUltShort](../vs140/includes/vsUltShort_md.md)] you can select from a list of Code Analysis *rule sets* to apply to [!INCLUDE[vstecasp](../vs140/includes/vstecasp_md.md)] Web application. The default rule set is the Microsoft Mininimum Recommended Rules. You can select another rule set to apply to the Web site.  
