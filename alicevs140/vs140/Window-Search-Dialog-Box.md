...
Use this dialog box to find and select the node for a specific window in [Windows View](../vs140/Windows-View.md). To display this dialog box, move the focus to the Windows view window. Then choose **Find Window** from the **Search** menu.  
