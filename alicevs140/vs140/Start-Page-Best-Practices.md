...
### Windows Presentation Framework (WPF)  
 Your XAML markup should follow WPF best practices. For information about [!INCLUDE[TLA#tla_winclient](../vs140/includes/TLA#tla_winclient_md.md)] and [!INCLUDE[TLA#tla_netframewk](../vs140/includes/TLA#tla_netframewk_md.md)] best practices for application development, see the following topics, as appropriate.  
...
## See Also  
 [Start Page Architecture](../Topic/Start%20Page%20Architecture.md)   
