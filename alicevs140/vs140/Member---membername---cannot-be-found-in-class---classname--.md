...
2.  If the error recurs, save your work and restart [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)].  
  
3.  If the error persists, reinstall [!INCLUDE[vbprvb](../vs140/includes/vbprvb_md.md)].  
