...
|[IDataObjectImpl::DUnadvise](../vs140/IDataObjectImpl--DUnadvise.md)|Terminates a connection previously established through `DAdvise`.|  
...
|[IDataObjectImpl::GetDataHere](../vs140/IDataObjectImpl--GetDataHere.md)|Similar to `GetData`, except the client must allocate the **STGMEDIUM** structure. The ATL implementation returns **E_NOTIMPL**.|  
