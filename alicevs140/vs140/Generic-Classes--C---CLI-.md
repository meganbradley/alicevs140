 ...
 *accessibility-modifiers*  
 Accessibility modifiers for the generic class. For the [!INCLUDE[wrt](../vs140/includes/wrt_md.md)], the only allowed modifier is `private`. For the common language runtime, the allowed modifiers are `private` and `public`.  
