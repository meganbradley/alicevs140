---
title: "Call Tree View - .NET Memory Instrumentation Data"
ms.custom: na
ms.date: 09/19/2016
...
|**Type**|The context of the function:<br /><br /> -   **0** - the current function<br />-   **1** - a function that calls the current function<br />-   **2** - a function that is called by the current function<br /><br /> Only in [VSReport](../vs140/VSPerfReport.md) command-line reports.|  
|**Root Function Name**|The name of the current function. Only in [VSReport](../vs140/VSPerfReport.md) command-line reports.|  
