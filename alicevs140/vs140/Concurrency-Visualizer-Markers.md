...
## Marker Importance  
 Markers can have one of four importance levels: low, normal, high, and critical.  You can filter the sources of markers based on importance level.  For example, if you only want to see markers from a particular source that has normal or critical importance, you can configure the filter in the [Advanced Settings](../Topic/Advanced%20Settings%20Dialog%20Box%20\(Concurrency%20Visualizer\).md) dialog box.The importance of a marker is displayed in its tooltip, and in the [Markers Report](../vs140/Markers-Report.md).  
  
## Marker Category  
 A marker category indicates a group of marker events that come from the same source.  The Concurrency Visualizer uses color to distinguish different categories of flags and spans. You can configure the Concurrency Visualizer to use categories to filter the marker events from a particular event provider.  Use the [Advanced Settings](../Topic/Advanced%20Settings%20Dialog%20Box%20\(Concurrency%20Visualizer\).md) dialog box to configure the filter.  
...
-   [Task Parallel Library](assetId:///b8f99f43-9104-45fd-9bff-385a20488a23)  
  
-   [Dataflow (Task Parallel Library)](assetId:///643575d0-d26d-4c35-8de7-a9c403e97dd6)  
...
-   [C++ Accelerated Massive Parallelism (C++ AMP)](../vs140/C---AMP--C---Accelerated-Massive-Parallelism-.md)  
 ...
 You can use the Markers tab in the [Advanced Settings](../Topic/Advanced%20Settings%20Dialog%20Box%20\(Concurrency%20Visualizer\).md) dialog box to control whether markers from various sources are displayed in the Concurrency Visualizer and you can filter for markers based on importance and category.  
  
## Markers from EventSource  
 The Concurrency Visualizer can also display EventSource events.  For more information, see [Visualizing EventSource Events as Markers](../vs140/Visualizing-EventSource-Events-as-Markers.md).  
  
## See Also  
 [Flag Markers](../vs140/Flag-Markers.md)   
 [Message Markers](../vs140/Message-Markers.md)   
 [Span Markers](../vs140/Span-Markers.md)   
 [Visualizing EventSource Events as Markers](../vs140/Visualizing-EventSource-Events-as-Markers.md)