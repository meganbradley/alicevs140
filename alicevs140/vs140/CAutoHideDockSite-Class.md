...
The `CAutoHideDockSite` extends the [CDockSite Class](../vs140/CDockSite-Class.md) to implement auto-hide dock panes.  
...
|[CAutoHideDockSite::UnSetAutoHideMode](#cautohidedocksite__unsetautohidemode)|Calls [CMFCAutoHideBar::UnSetAutoHideMode](../vs140/CMFCAutoHideBar-Class.md#cmfcautohidebar__unsetautohidemode) for objects on the `CAutoHideDockSite`.|  
...
## Remarks  
 When you call [CFrameWndEx::EnableAutoHidePanes](../vs140/CFrameWndEx-Class.md#cframewndex__enableautohidepanes), the framework automatically creates a `CAutoHideDockSite` object. In most cases, you should not have to instantiate or use this class directly.  
