...
Converts the argument to unsigned native integer ([unativeint](../vs140/Core.unativeint-Type-Abbreviation--F#-.md)) using a direct conversion for all primitive numeric types. Otherwise, the operation requires an appropriate static conversion method on the input type.  
...
## See Also  
 ...
 [Operators.unativeint<^T> Function (F#)](../vs140/Operators.unativeint-^T--Function--F#-.md)