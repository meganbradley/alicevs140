...
1.  Open a Visual Studio command prompt or a [!INCLUDE[winsdkshort](../vs140/includes/winsdkshort_md.md)] command prompt, and change to the directory in which you will store your [!INCLUDE[ndptecclick](../vs140/includes/ndptecclick_md.md)] files.  
...
1.  Open a Visual Studio command prompt or a [!INCLUDE[winsdkshort](../vs140/includes/winsdkshort_md.md)] command prompt, and navigate to the directory in which you will store your [!INCLUDE[ndptecclick](../vs140/includes/ndptecclick_md.md)] files.  
...
8.  Select the **Application Options** tab and click **Use Application Manifest for Trust Information**. This will enable third-party branding for this [!INCLUDE[ndptecclick](../vs140/includes/ndptecclick_md.md)] application.  
...
16. Switch to the **Update** tab, and specify how often you want this application to update. If your application uses the [!INCLUDE[ndptecclick](../vs140/includes/ndptecclick_md.md)] Deployment API to check for updates itself, clear the check box labeled **This application should check for updates**.  
