---
title: "Memory Usage without Debugging2"
ms.custom: na
ms.date: 09/19/2016
ms.devlang: 
  - FSharp
...
translation.priority.ht: 
  ...
  - ja-jp
---
# Memory Usage without Debugging2
...
3.  Select **Memory Usage** and then choose the **Start** button at the bottom of the page.  
     ...
     ![Start a Memory Usage diagnostic session](../vs140/media/MEMUSE_Start_DiagnosticsSession.png "MEMUSE_Start_DiagnosticsSession")  
...
##  <a name="BKMK_Monitor_memory_use"></a> Monitor memory use  
 ...
 ![Memory Usage overview page](../vs140/media/MEMUSE__ReportOverview.png "MEMUSE__ReportOverview")  
...
###  <a name="BKMK_Close_a_monitoring_session"></a> Close a monitoring session  
 ![Stop collection](../vs140/media/MEMUSE__StopCollection.png "MEMUSE__StopCollection")  
...
-   A [Snapshot details report](../vs140/Memory-Usage-without-Debugging2.md#BKMK_Snapshot_details_reports) shows the types and instances in one snapshot.  
  
-   A [Snapshot difference (diff) report](../vs140/Memory-Usage-without-Debugging2.md#BKMK_Snapshot_difference__diff__reports) compares the types and instances in two snapshots.  
  
 ![Snapshot view links](../vs140/media/MEMUSE__SnapshotView_Numbered.png "MEMUSE__SnapshotView_Numbered")  
  
 The numbered items in the picture of the snapshot view are links that open Memory Usage report views.  
  
|||  
|-|-|  
|![Step 1](../vs140/media/ProcGuid_1.png "ProcGuid_1")|The link text shows the total number of bytes in memory when the snapshot was taken.<br /><br /> Choose this link to display a snapshot details report that's sorted by the total size of the type instances.|  
|![Step 2](../vs140/media/ProcGuid_2.png "ProcGuid_2")|The link text shows the total number of objects in memory when the snapshot was taken.<br /><br /> Choose this link to display a snapshot details report that's sorted by the count of instances of the types.|  
|![Step 3](../vs140/media/ProcGuid_3.png "ProcGuid_3")|The link text shows the difference between the total size of objects in memory at the moment of this snapshot and the total size of the previous snapshot.<br /><br /> The link text is a positive number when the memory size of this snapshot is larger than the previous one, and a negative number when the size is smaller. The link text **Baseline** indicates that this snapshot is the first in the diagnostic session; **No Difference** indicates that the difference is zero.<br /><br /> Choose this link to display a snapshot diff report that's sorted by the difference in the total size of instances of the types.|  
|![Step 4](../vs140/media/ProcGuid_4.png "ProcGuid_4")|The link text shows the difference between the total number of memory objects in this snapshot and the number of objects in the previous snapshot.<br /><br /> Choose this link to display a snapshot diff report that's sorted by the difference in the total count of instances of the types.|  
  
##  <a name="BKMK_Snapshot_reports"></a> Snapshot reports  
 ![Memory Usage snapshot report](../vs140/media/MEMUSE_SnapshotReport_All.png "MEMUSE_SnapshotReport_All")  
  
###  <a name="BKMK_Snapshot_report_trees"></a> Snapshot report trees  
  
####  <a name="BKMK_Managed_Heap"></a> Managed Heap  
 The managed heap tree [Managed Heap tree (Snapshot details)](../vs140/Memory-Usage-without-Debugging2.md#BKMK_Managed_Heap_tree__Snapshot_details_) and the [Managed Heap tree (Snapshot diff)](../vs140/Memory-Usage-without-Debugging2.md#BKMK_Managed_Heap_tree__Snapshot_diff_) show the types and instances in the report. Selecting a type or instance displays the **Paths to Root** and **Referenced Objects** trees for the selected item.  
  
####  <a name="BKMK_Paths_to_Root"></a> Paths to Root  
 The [Paths to Root tree (Snapshot details)](../vs140/Memory-Usage-without-Debugging2.md#BKMK_Paths_to_Root_tree__Snapshot_details_) and the [Paths to Root tree (Snapshot diff)](../vs140/Memory-Usage-without-Debugging2.md#BKMK_Paths_to_Root_tree__Snapshot_diff_) show the chain of objects that reference the type or instance. The .NET Framework garbage collector cleans up the memory for an object only when all references to it have been released.  
  
####  <a name="BKMK_Referenced_Objects"></a> Referenced Objects  
 The [Referenced Objects tree (Snapshot details)](../vs140/Memory-Usage-without-Debugging2.md#BKMK_Referenced_Objects_tree__Snapshot_details_) and the [Referenced Objects tree (Snapshot diff)](../vs140/Memory-Usage-without-Debugging2.md#BKMK_Referenced_Objects_tree__Snapshot_diff_) show the objects that the selected type or instance references.  
...
###  <a name="BKMK_Report_tree_filters_"></a> Report tree filters  
 ...
 ![Sort and filter options](../vs140/media/MEMUSE_SortAndFilter.png "MEMUSE_SortAndFilter")  
...
##  <a name="BKMK_Snapshot_details_reports"></a> Snapshot details reports  
 ...
 ![Links to snapshot report in a snapshot view](../vs140/media/MEMUSE_SnapshotView_SnapshotDetailsLinks.png "MEMUSE_SnapshotView_SnapshotDetailsLinks")  
...
###  <a name="BKMK_Managed_Heap_tree__Snapshot_details_"></a> Managed Heap tree (Snapshot details)  
 ...
 ![Managed Heap tree](../vs140/media/MEMUSE__SnapshotDetails_ManagedHeapTree.png "MEMUSE__SnapshotDetails_ManagedHeapTree")  
...
###  <a name="BKMK_Paths_to_Root_tree__Snapshot_details_"></a> Paths to Root tree (Snapshot details)  
 ...
 ![Paths to Root tree for Types](../vs140/media/MEMUSE_SnapshotDetails_Type_PathsToRootTree.png "MEMUSE_SnapshotDetails_Type_PathsToRootTree")  
...
###  <a name="BKMK_Referenced_Objects_tree__Snapshot_details_"></a> Referenced Objects tree (Snapshot details)  
 ...
 ![Referenced Objjects tree for instances](../vs140/media/MEMUSE_SnapshotDetails_ReferencedObjects_Instance.png "MEMUSE_SnapshotDetails_ReferencedObjects_Instance")  
...
##  <a name="BKMK_Snapshot_difference__diff__reports"></a> Snapshot difference (diff) reports  
 ...
 ![Links to difference report in a snapshot view](../vs140/media/MEMUSE_SnapshotView_SnapshotDiffLinks.png "MEMUSE_SnapshotView_SnapshotDiffLinks")  
...
###  <a name="BKMK_Managed_Heap_tree__Snapshot_diff_"></a> Managed Heap tree (Snapshot diff)  
 ...
 ![Managed Heap tree for a type in difference report](../vs140/media/MEMUSE_SnapshotDiff_Type_Heap.png "MEMUSE_SnapshotDiff_Type_Heap")  
...
###  <a name="BKMK_Paths_to_Root_tree__Snapshot_diff_"></a> Paths to Root tree (Snapshot diff)  
 ...
 ![Paths To Root tree for instances in a diff view](../vs140/media/MEMUSE_SnapshotDiff_PathsToRoot_Instance_All.png "MEMUSE_SnapshotDiff_PathsToRoot_Instance_All")  
...
## See Also  
 [Analyze memory usage (JavaScript)](../vs140/JavaScript-Memory.md)   
 [Analyze the performance of Windows Store apps using Visual Studio diagnostic tools](../vs140/Analyze-the-performance-of-Windows-Store-apps-using-Visual-Studio-diagnostic-tools.md)   
 [Run analysis tools from the Performance and Diagnostic page](../vs140/Run-analysis-tools-from-the-Performance-and-Diagnostic-page.md)   
