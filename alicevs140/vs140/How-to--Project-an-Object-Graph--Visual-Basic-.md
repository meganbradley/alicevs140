...
## Example  
 The following code populates an object graph with the `Address`, `PurchaseOrder`, and `PurchaseOrderItem` classes from the [Sample XML File: Typical Purchase Order (LINQ to XML)](../vs140/Sample-XML-File--Typical-Purchase-Order--LINQ-to-XML-2.md) XML document.  
...
```  
 ...
 In this example, the result of the [!INCLUDE[vbteclinq](../vs140/includes/vbteclinq_md.md)] query is returned as an <xref:System.Collections.Generic.IEnumerable`1?qualifyHint=False> of `PurchaseOrderItem`. The items in the `PurchaseOrder` class are of type <xref:System.Collections.Generic.IEnumerable`1?qualifyHint=False> of `PurchaseOrderItem`. The code uses the <xref:System.Linq.Enumerable.ToList``1?qualifyHint=False> extension method to create a <xref:System.Collections.Generic.List`1?qualifyHint=False> collection from the results of the query.  
...
## See Also  
 <xref:System.Linq.Enumerable.Select?qualifyHint=False>   
 <xref:System.Linq.Enumerable.ToList``1?qualifyHint=False>   
