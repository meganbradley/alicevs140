...
## Command IDs  
 See Visual C++ for an explanation of the command routing and binding process. [Technical Note 20](../vs140/TN020--ID-Naming-and-Numbering-Conventions.md) contains information on ID naming.  
 ...
 **CFrameWnd** also handles the **WM_ENTERIDLE** message to describe the current menu item selected on the status bar (also known as the message line).  
 ...
 The same sort of **ON_UPDATE_COMMAND_UI** processing is done for toolbars (and other control bars) when the application enters its idle loop. See the *Class Library Reference* and [Technical Note 31](../vs140/TN031--Control-Bars.md) for more information on control bars.  
...
## Window Message Routing  
 ...
 Please refer to [Technical Note 17](../vs140/TN017--Destroying-Window-Objects.md) for details on Window cleanup, a very important topic for all **CWnd**-derived classes.  
