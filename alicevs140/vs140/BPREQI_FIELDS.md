...
## Members  
 BPREQI_BPLOCATION  
 Initialize/use the `bpLocation` (breakpoint location) field of the [BP_REQUEST_INFO](../vs140/BP_REQUEST_INFO.md) or [BP_REQUEST_INFO2](../vs140/BP_REQUEST_INFO2.md) structure.  
