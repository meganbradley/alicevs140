...
## Setting up the Extension  
 In this procedure we will use the same Hello World code snippet created in [Walkthrough: Creating a Code Snippet](../vs140/Walkthrough--Creating-a-Code-Snippet.md). We will supply the .snippet text, so you don’t have to go back and make one.  
