...
-   If both operands are of arithmetic or enumeration types, the usual arithmetic conversions (covered in [Arithmetic Conversions](../vs140/Arithmetic-Conversions.md)) are performed to convert them to a common type.  
...
## See Also  
 ...
 [Conditional-Expression Operator](../vs140/Conditional-Expression-Operator.md)