...
A tool returned an error code from  
 ...
 See [Troubleshooting Custom Build Steps and Build Events](../vs140/Troubleshooting-Build-Customizations.md) for more information.  
  
 This error can also occur when you are running as a member of the Users group and Administrative access is needed. For more information, see [Running as a Member of the Users Group](../vs140/Running-as-a-Member-of-the-Users-Group.md).