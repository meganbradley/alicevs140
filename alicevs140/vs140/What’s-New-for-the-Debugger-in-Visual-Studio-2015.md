...
## Visual Studio 2015 Update 1 Changes  
 C++ Edit and Continue supports more features. For more information, see [Edit and Continue (VIsual C++](../vs140/Edit-and-Continue--Visual-C---.md).  
  
 For debugging Visual C++ access violations, a new exception dialog specifies the pointer that caused the exception. For more information, please see [How Can I Debug an Access Violation?](../vs140/How-Can-I-Debug-an-Access-Violation-.md) and [Improvement to Debugging C++ Access Violations in Visual Studio 2015 Update 1](http://blogs.msdn.com/b/visualstudioalm/archive/2015/10/29/improvement-to-debugging-c-access-violations-in-visual-studio-2015-update-1.aspx)  
...
1.  [Using Breakpoints](../vs140/Using-Breakpoints.md)  
...
1.  [Exception Handling](../Topic/Managing%20Exceptions%20with%20the%20Debugger.md)  
