...
The XAML Designer in Visual Studio provides a visual interface to help you design XAML-based Windows Store, Windows Phone, WPF, and Silverlight apps. You can create user interfaces for your apps by dragging controls from the **Toolbox** and setting properties in the **Properties** window. You can also edit XAML directly in XAML view.  
 ...
 For advanced XAML design tasks such as animations and behaviors, see [Creating a UI by using Blend for Visual Studio](../vs140/Creating-a-UI-by-using-Blend-for-Visual-Studio.md).  
...
## Authoring views  
 ...
 In Design view, the window containing the *artboard* is the active window and you can use it as a primary work surface. You can use it to visually design a page in your app by adding or drawing elements, and then by modifying them. For more info, see [Working with elements in XAML Designer](../Topic/Working%20with%20elements%20in%20XAML%20Designer.md). This illustration shows the artboard in Design view.  
  
 ![Design view of XAML Designer](../vs140/media/xaml_editor_design_view.png "xaml_editor_design_view")  
 ...
 **Resize handles**  
 Resize handles appear on selected controls and enable you to resize the control. When you resize a control, width and height values typically appear to help you size the control. For more info about manipulating controls in Design view, see [Working with elements in XAML Designer](../Topic/Working%20with%20elements%20in%20XAML%20Designer.md).  
 ...
 **Element handles**  
 ...
 ![Design view commands](../vs140/media/xaml_editor_design_controls.png "xaml_editor_design_controls")  
 ...
 **Turn on/off snapping to snaplines**  
 ...
 ![XAML view](../vs140/media/xaml_editor.png "xaml_editor")  
...
## Device window  
 ...
 ![Device window](../vs140/media/xaml_editor_device_panel.png "xaml_editor_device_panel")  
...
-   Select elements so that you can modify them (move them around in the hierarchy, modify them on the artboard, set their properties in the Properties window, and so on). For more info, see [Working with elements in XAML Designer](../Topic/Working%20with%20elements%20in%20XAML%20Designer.md)  
...
-   Use the context menu for selected elements. The same menu is also available for selected elements in the artboard.  
 ...
 ![Document Outline window](../vs140/media/xaml_editor_doc_outline.png "xaml_editor_doc_outline")  
...
## Properties window  
 ...
 ![Properties window](../vs140/media/xaml_editor_prop_window.png "xaml_editor_prop_window")  
...
## See Also  
 ...
 [How to create and apply a resource](../Topic/How%20to%20create%20and%20apply%20a%20resource.md)   
 [How to create a data binding in XAML Designer](../vs140/Walkthrough--Binding-to-data-in-XAML-Designer.md)