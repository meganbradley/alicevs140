...
The `SccStatus` enumerator contains named constant values that specify the state of a file in the source control system. This enumeration is used by the [SccQueryInfo Function](../vs140/SccQueryInfo-Function.md) and the `POPLISTFUNC` callback function (see [POPLISTFUNC](../vs140/POPLISTFUNC.md) for details).  
...
## See Also  
 ...
 [SccQueryInfo Function](../vs140/SccQueryInfo-Function.md)   
