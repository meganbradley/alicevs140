...
### Menu Commands  
 To write a menu command, define a class that implements <xref:Microsoft.VisualStudio.Modeling.ExtensionEnablement.ICommandExtension?qualifyHint=False> and prefix the class with the attribute that is defined in your DSL, named *YourDsl*`CommandExtension`. You can write more than one menu command class.  
...
### Gesture Handlers  
 ...
 You can write handlers to deal with drags from other DSL models and UML models. For more information, see [How to Add a Drag-and-Drop Handler](../Topic/How%20to:%20Add%20a%20Drag-and-Drop%20Handler.md).  
...
### Validation constraints  
 Validation methods are marked by the `ValidationExtension` attribute that is generated by the DSL, and also by <xref:Microsoft.VisualStudio.Modeling.Validation.ValidationMethodAttribute?qualifyHint=False>. The method can appear in any class that is not marked by an attribute.  
  
 For more information, see [Validation in a Domain-Specific Language](../Topic/Validation%20in%20a%20Domain-Specific%20Language.md).  
...
## See Also  
 ...
 [How to Add a Drag-and-Drop Handler](../Topic/How%20to:%20Add%20a%20Drag-and-Drop%20Handler.md)   
 [Validation in a Domain-Specific Language](../Topic/Validation%20in%20a%20Domain-Specific%20Language.md)