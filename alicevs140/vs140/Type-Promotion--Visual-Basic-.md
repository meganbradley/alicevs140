...
When you declare a programming element in a module, [!INCLUDE[vbprvb](../vs140/includes/vbprvb_md.md)] promotes its scope to the namespace containing the module. This is known as *type promotion*.  
