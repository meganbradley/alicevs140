...
-   Stdole2.tlb  
 ...
 If your application uses one of the ActiveX controls that connects to a database, you must have the Microsoft Data Access Components (MDAC) installed on the target system. For more information, see [Redistributing Database Support Files](../vs140/Redistributing-Database-Support-Files.md).  
