...
#### Parameters  
 `dwFields`  
 [in] A combination of flags from the [BPRESI_FIELDS](../vs140/BPRESI_FIELDS.md) enumeration that determine which fields of the `pBPResolutionInfo` parameter are to be filled out.  
...
## Example  
 The following example implements this method for a simple `CDebugBreakpointResolution` object that exposes the [IDebugBreakpointResolution2](../vs140/IDebugBreakpointResolution2.md) interface.  
