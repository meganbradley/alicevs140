...
```  
 ...
 When run with the sample Open XML document described in [Creating the Source Office Open XML Document (C#)](../vs140/Creating-the-Source-Office-Open-XML-Document--C#-.md), this example produces the following output:  
