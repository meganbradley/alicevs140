...
The [!INCLUDE[vbprvb](../vs140/includes/vbprvb_md.md)] compiler cannot successfully interpret one of its internally written files.  
...
2.  If the error recurs, reinstall the [!INCLUDE[vbprvb](../vs140/includes/vbprvb_md.md)] compiler.  
