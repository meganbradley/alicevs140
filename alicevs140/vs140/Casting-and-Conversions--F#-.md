...
## Arithmetic Types  
 ...
 [!CODE [FsLangRef2#4401](../CodeSnippet/VS_Snippets_Fsharp/fslangref2#4401)]  
...
## Enumerated Types  
 ...
 [!CODE [FsLangRef2#4402](../CodeSnippet/VS_Snippets_Fsharp/fslangref2#4402)]  
...
```  
 ...
 For more information, see [Enumerations (F#)](../vs140/Enumerations--F#-.md).  
...
### Upcasting  
 In many object-oriented languages, upcasting is implicit; in F#, the rules are slightly different. Upcasting is applied automatically when you pass arguments to methods on an object type. However, for let-bound functions in a module, upcasting is not automatic, unless the parameter type is declared as a flexible type. For more information, see [Flexible Types (F#)](../vs140/Flexible-Types--F#-.md).  
...
### Downcasting  
 ...
 [!CODE [FsLangRef2#4403](../CodeSnippet/VS_Snippets_Fsharp/fslangref2#4403)]  
 ...
 For more information about type tests, see [Pattern Matching (F#)](../vs140/Match-Expressions--F#-.md).  
