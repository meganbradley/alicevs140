...
2.  Use the [MakeDir](../Topic/MakeDir%20Task.md) task to create the directory if the directory does not exist. For example:  
...
## See Also  
 ...
 [MakeDir Task](../Topic/MakeDir%20Task.md)   
