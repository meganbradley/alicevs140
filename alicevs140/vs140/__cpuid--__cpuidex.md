...
**Microsoft Specific**  
 ...
 Generates the `cpuid` instruction that is available on x86 and [!INCLUDE[vcprx64](../vs140/includes/vcprx64_md.md)]. This instruction queries the processor for information about supported features and the CPU type.  
...
|---------------|------------------|  
|`__cpuid`|x86, [!INCLUDE[vcprx64](../vs140/includes/vcprx64_md.md)]|  
|`__cpuidex`|x86, [!INCLUDE[vcprx64](../vs140/includes/vcprx64_md.md)]|  
