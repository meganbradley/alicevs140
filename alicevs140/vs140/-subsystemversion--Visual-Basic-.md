...
> [!NOTE]
>  To specify the subsystem itself, use the [/target](../Topic/-target%20\(C%23%20Compiler%20Options\).md) compiler option.  
...
-   The default value is 6.02 if any compiler option in the following list is set:  
    ...
    -   [/target:appcontainerexe](../Topic/-target%20\(Visual%20Basic\).md)  
  
    -   [/target:winmdobj](../Topic/-target%20\(Visual%20Basic\).md)  
  
    -   [/platform:arm](../Topic/-platform%20\(Visual%20Basic\).md)  
