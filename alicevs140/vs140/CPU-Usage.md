...
1.  In Visual Studio, set the solution configuration to **Release** and choose the deployment target.  
     ...
     ![Select Release and Local Machine](../vs140/media/CPUUSE_SelectReleaseLocalMachine.png "CPUUSE_SelectReleaseLocalMachine")  
...
3.  Choose **CPU Usage** and then choose **Start**.  
     ...
     ![Choose CPU Usage](../vs140/media/CPUUSE_LIB_ChooseCpuUsage.png "CPUUSE_LIB_ChooseCpuUsage")  
