...
ms.tgt_pltfrm: na
ms.topic: article
ms.assetid: 52a89182-efed-405b-b4e9-0ebd00503706
...
---
# DFX_Double
Transfers **double float** data between the field data members of a [CDaoRecordset](../vs140/CDaoRecordset-Class.md) object and the columns of a record on the data source.  
