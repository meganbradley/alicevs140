---
title: "Caller-Callee View - Instrumentation Data"
ms.custom: na
ms.date: 09/19/2016
...
ms.tgt_pltfrm: na
ms.topic: article
H1: Caller/Callee View - Instrumentation Data
...
|**Type**|The context of the function:<br /><br /> **0** - the current function<br /><br /> **1** - a function that calls the current function<br /><br /> **2** - a function that is called by the current function<br /><br /> Only in [VSReport](../vs140/VSPerfReport.md) command-line reports.|  
