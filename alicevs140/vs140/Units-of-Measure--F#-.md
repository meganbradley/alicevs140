...
```  
 ...
 [!CODE [FsLangRef2#6901](../CodeSnippet/VS_Snippets_Fsharp/fslangref2#6901)]  
 ...
 [!CODE [FsLangRef2#6902](../CodeSnippet/VS_Snippets_Fsharp/fslangref2#6902)]  
...
## Using Generic Units  
 ...
 [!CODE [FsLangRef2#6903](../CodeSnippet/VS_Snippets_Fsharp/fslangref2#6903)]  
...
## Creating Aggregate Types with Generic Units  
 ...
 [!CODE [FsLangRef2#6904](../CodeSnippet/VS_Snippets_Fsharp/fslangref2#6904)]  
...
## Conversions  
 ...
 [!CODE [FsLangRef2#6905](../CodeSnippet/VS_Snippets_Fsharp/fslangref2#6905)]  
  
 To convert a unitless value to a value that has units, you can multiply by a 1 or 1.0 value that is annotated with the appropriate units. However, for writing interoperability layers, there are also some explicit functions that you can use to convert unitless values to values with units. These are in the [Microsoft.FSharp.Core.LanguagePrimitives](../Topic/Core.LanguagePrimitives%20Module%20\(F%23\).md) module. For example, to convert from a unitless `float` to a `float<cm>`, use [FloatWithMeasure](../vs140/LanguagePrimitives.FloatWithMeasure--Measure--Function.md), as shown in the following code.  
  
 [!CODE [FsLangRef2#6906](../CodeSnippet/VS_Snippets_Fsharp/fslangref2#6906)]  
