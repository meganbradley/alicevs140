...
## Prerequisites  
 Before you read this walkthrough, we highly recommended that you build and run the LinqToXmlDataBinding program as described in [How to: Build and Run the LinqToXmlDataBinding Example](../Topic/How%20to:%20Build%20and%20Run%20the%20LinqToXmlDataBinding%20Example.md).  
...
|Topic|Description|  
|-----------|-----------------|  
|[L2DBForm.xaml Source Code](../Topic/L2DBForm.xaml%20Source%20Code.md)|Contains the contents and description of the XAML code in file L2DBForm.xaml.|  
|[L2DBForm.xaml.cs Source Code](../Topic/L2DBForm.xaml.cs%20Source%20Code.md)|Contains the contents and description of the C# source code in the file L2DBForm.xaml.cs.|  
  
## See Also  
 [WPF Data Binding using LINQ to XML Example](../vs140/WPF-Data-Binding-Using-LINQ-to-XML-Example.md)   
 [How to: Build and Run the LinqToXmlDataBinding Example](../Topic/How%20to:%20Build%20and%20Run%20the%20LinqToXmlDataBinding%20Example.md)