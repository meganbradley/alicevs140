...
### Remarks  
 Specifically, if [pptr](../vs140/basic_streambuf-Class.md#basic_streambuf__pptr) is a null pointer, the function returns zero. Otherwise, it returns `pptr` – [pbase](../vs140/basic_streambuf-Class.md#basic_streambuf__pbase).  
