...
-   Functions that are referred to through a pointer elsewhere in the translation unit.  
 ...
 The [/Ob](../Topic/-Ob%20\(Inline%20Function%20Expansion\).md) compiler optimization option helps to determine whether inline function expansion actually occurs.  
...
## When to use inline functions  
 ...
 The `Point` class, introduced in [Function-Call Results](../vs140/Function-Call-Results.md) can be optimized as follows:  
