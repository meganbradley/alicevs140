...
### Remarks  
 ...
 An empty `basic_regex` object does not match any character sequence when passed to [regex_match](../vs140/-regex--functions.md#regex_match_function), [regex_search](../vs140/-regex--functions.md#regex_search_function), or [regex_replace](../vs140/-regex--functions.md#regex_replace_function).  
...
### Remarks  
 The member function returns the value of the `flag_type` argument passed to the most recent call to one of the [assign](#basic_regex__assign) member functions or, if no such call has been made, the value passed to the constructor.  
...
### Remarks  
 The member function returns `traits.`[getloc](../vs140/regex_traits-Class.md#regex_traits__getloc)`()`.  
...
### Remarks  
 The member function empties `*this` and returns `traits.`[imbue](../vs140/regex_traits-Class.md#regex_traits__imbue)`(loc)`.  
