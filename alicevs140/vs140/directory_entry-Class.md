...
Describes an object that is returned by `*X`, where *X* is a [directory_iterator](../vs140/directory_iterator-Class.md) or a [recursive_directory_iterator](../vs140/recursive_directory_iterator-Class.md).  
