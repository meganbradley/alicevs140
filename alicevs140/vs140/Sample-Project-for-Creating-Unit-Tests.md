...
-   [Walkthrough: Creating and Running Unit Tests](../Topic/Walkthrough:%20Creating%20and%20Running%20Unit%20Tests%20for%20Managed%20Code.md). This walkthrough leads you through the steps to create and customize unit tests, run them, and examine the test results.  
...
## Working with the Code  
 To work with this code, you first have to create a project for it in [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)]. Follow the steps in the "Prepare the Walkthrough" section in [Walkthrough: Creating and Running Unit Tests](../Topic/Walkthrough:%20Creating%20and%20Running%20Unit%20Tests%20for%20Managed%20Code.md).  
  
## See Also  
 [Walkthrough: Creating and Running Unit Tests](../Topic/Walkthrough:%20Creating%20and%20Running%20Unit%20Tests%20for%20Managed%20Code.md)   
