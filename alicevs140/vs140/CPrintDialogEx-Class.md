...
## Remarks  
 ...
 For more information on using `CPrintDialogEx`, see [Common Dialog Classes](../vs140/Common-Dialog-Classes.md).  
...
### Remarks  
 Use a pointer to the `CString` object returned by `GetDeviceName` as the value of `lpszDeviceName` in a call to [CDC::CreateDC](../vs140/CDC-Class.md#cdc__createdc).  
