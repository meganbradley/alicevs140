 ...
 **Microsoft Specific**  
 ...
 Defining macros and constants with the [/D](../Topic/-D%20\(Preprocessor%20Definitions\).md) compiler option has the same effect as using a `#define` preprocessing directive at the start of your file. Up to 30 macros can be defined by using the /D option.  
