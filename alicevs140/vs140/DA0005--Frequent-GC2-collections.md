...
## How to Investigate a Warning  
 Review the [Profiling Tools .NET Memory Data Views](../vs140/.NET-Memory-Data-Views.md) reports to understand the application’s pattern of memory allocation. Use the [Object Lifetime View](../vs140/Object-Lifetime-View.md) to determine which of the program’s data objects are surviving into generation 2 and then being reclaimed from there. Use the [.NET Memory Allocations View](../vs140/.NET-Memory-Allocations-View.md) to determine the execution path that resulted in these allocations.  
