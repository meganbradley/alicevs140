...
## Remarks  
 The member function returns `(float)`[size](../vs140/unordered_set--size.md)`() / (float)`[bucket_count](../vs140/unordered_set--bucket_count.md)`()`, the average number of elements per bucket.  
