...
## Cause  
 A public or protected type or member has the <xref:System.Security.SuppressUnmanagedCodeSecurityAttribute?qualifyHint=True> attribute.  
  
## Rule Description  
 <xref:System.Security.SuppressUnmanagedCodeSecurityAttribute?qualifyHint=False> changes the default security system behavior for members that execute unmanaged code using COM interop or platform invocation. Generally, the system makes a [demand](assetId:///8c37635d-e2c1-4b64-a258-61d9e87405e6) for unmanaged code permission. This demand occurs at run time for every invocation of the member, and checks every caller in the call stack for permission. When the attribute is present, the system makes a [link demand](assetId:///a33fd5f9-2de9-4653-a4f0-d9df25082c4d) for the permission: the permissions of the immediate caller are checked when the caller is JIT-compiled.  
...
## See Also  
 <xref:System.Security.SuppressUnmanagedCodeSecurityAttribute?qualifyHint=True>   
 ...
 [Security Demand](assetId:///8c37635d-e2c1-4b64-a258-61d9e87405e6)   
 [Link Demand](assetId:///a33fd5f9-2de9-4653-a4f0-d9df25082c4d)