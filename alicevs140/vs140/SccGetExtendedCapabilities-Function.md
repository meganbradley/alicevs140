...
#### Parameters  
 ...
 lSccExCaps  
 [in] A flag specifying an extended capability for which to test (see the Extended Capability Code table in [Capability Flags](../vs140/Capability-Flags.md) for the possible flags).  
