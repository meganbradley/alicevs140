...
## Observing expressions with the Watch window  
 ...
 ![WatchExpression](../vs140/media/WatchExpression.png "WatchExpression")  
 ...
 ![WatchExpressionError](../vs140/media/WatchExpressionError.png "WatchExpressionError")  
...
```  
 ...
 ![RefreshWatch](../vs140/media/RefreshWatch.png "RefreshWatch")  
...
## DynamicView and the Watch window  
 ...
 When the Watch window displays a or an object created from a type that implements the [IDynamicMetaObjectProvider Interface](assetId:///e887a72d-ebe2-4253-a7e8-3d8d05154647), the debugger adds a special **Dynamic View**  node to the **Autos** display. This node shows the dynamic members of the dynamic object but does not allow editing of the member values.  
