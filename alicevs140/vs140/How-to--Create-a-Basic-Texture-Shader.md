...
>  In this illustration, a plane is used as the preview shape, and a texture has been specified to better demonstrate the effect of the shader.  
 ...
 ![Shader graph and a preview of its effect](../vs140/media/Digit-Texture-Effect.png "Digit-Texture-Effect")  
  
 Certain shapes might provide better previews for some shaders. For more information about how to preview shaders in the Shader Designer, see [The Shader Designer](../vs140/Shader-Designer.md)  
  
## See Also  
 [How to: Apply a Shader to a 3D Model](../vs140/How-to--Apply-a-Shader-to-a-3-D-Model.md)   
 [Working with Images and Textures](../vs140/Image-Editor.md)   
