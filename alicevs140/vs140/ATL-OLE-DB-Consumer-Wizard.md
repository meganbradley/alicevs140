...
-   If you select a consumer **Type** of Command, the wizard uses the `db_source` and **db_command** attributes, and uses **db_column** to create the column map, for example:  
 ...
 See [Basic Mechanics of Attributes](../vs140/Basic-Mechanics-of-Attributes.md) for more information.  
...
## See Also  
 [Adding an ATL OLE DB Consumer](../vs140/Adding-an-ATL-OLE-DB-Consumer.md)   
