...
## Remarks  
 ...
 initializes the controlled sequence with the sequence `[``right``.`[begin](../vs140/hash_set--begin--STL-CLR-.md)`(),` `right``.`[end](../vs140/hash_set--end--STL-CLR-.md)`())`, with the default ordering predicate, and with the default hash function. You use it to specify an initial controlled sequence that is a copy of the sequence controlled by the hash_set object `right`, with the default ordering predicate and hash function.  
...
## See Also  
 ...
 [generic_container](../vs140/hash_set--generic_container--STL-CLR-.md)   
