...
An import alias in an `Imports` statement contains at least one identifier type character.  
 ...
 An import alias must be a valid Visual Basic name. The allowed characters do not include any of the identifier type characters (`%`, `&`, `@`, `!`, `#`, and `$`). See [Declared Element Names](../vs140/Declared-Element-Names--Visual-Basic-.md).  
