...
|`CDynamicParameterAccessor`|Automatic, but can be [overridden](../vs140/Overriding-a-Dynamic-Accessor.md).|Yes, if the provider supports `ICommandWithParameters`. Parameters bound automatically.|Slower than `CDynamicAccessor` but useful for calling generic stored procedures.|  
