...
Code maps can help you avoid getting lost in large code bases, unfamiliar code, or legacy code. For example, when you’re debugging, you might have to look at code across many files and projects. Use code maps to navigate around pieces of code and understand the relationships between them. That way, you don't have to keep track of this code in your head, or draw a separate diagram. So, when your work is interrupted, code maps help refresh your memory about the code you're working on.  
 ...
 ![Code map &#45; Map relationships in code](../vs140/media/CodeMapStoryboardPaint.png "CodeMapStoryboardPaint")  
...
## Understand the problem  
 ...
 ![Code map &#45; Repro bug](../vs140/media/CodeMapStoryboardPaint0.png "CodeMapStoryboardPaint0")  
  
 So you start investigating by searching for the `Undo` method. You find it in the `PaintCanvas` class.  
  
 ![Code map &#45; Find code](../vs140/media/CodeMapStoryboardPaint1.png "CodeMapStoryboardPaint1")  
...
## Start mapping the code  
 ...
 ![Code map &#45; Show method and related fields](../vs140/media/CodeMapStoryboardPaint3.png "CodeMapStoryboardPaint3")  
...
>  The green highlighting shows the last items that were added to the map. The green arrow shows your cursor’s position in the code. Arrows between items represent different relationships. You can get more info about items on the map by moving the mouse over them and examining their tooltips.  
 ...
 ![Code map &#45; Show tooltips](../vs140/media/CodeMapStoryboardPaint4.png "CodeMapStoryboardPaint4")  
...
## Navigate and examine code from the map  
 ...
 ![Code map &#45; Examine field definition](../vs140/media/CodeMapStoryboardPaint5.png "CodeMapStoryboardPaint5")  
  
 ![Code map &#45; Examine field definition](../vs140/media/CodeMapStoryboardPaint5A.png "CodeMapStoryboardPaint5A")  
...
## Understand relationships between pieces of code  
 ...
 ![Code map &#45; Find all references](../vs140/media/CodeMapStoryboardPaint6.png "CodeMapStoryboardPaint6")  
  
 ![Open a code map from the code editor](../vs140/media/CodeMapStoryboardPaint6A.PNG "CodeMapStoryboardPaint6A")  
...
>  If you add items from a project that's shared across multiple apps, like Windows Phone or Windows Store, then those items always appear with the currently active app project on the map. So, if you change the context to another app project, then the context on the map also changes for any newly added items from the shared project. Operations that you perform with an item on the map apply only to those items that share the same context.  
 ...
 ![Code map &#45; Change layout](../vs140/media/CodeMapStoryboardPaint7A.png "CodeMapStoryboardPaint7A")  
...
>  By default, **Incremental Layout** is turned on. This rearranges the map as little as possible when you add new items. To rearrange the entire map every time you add new items, turn off **Incremental Layout**.  
 ...
 ![Code map &#45; Change layout](../vs140/media/CodeMapStoryboardPaint7.png "CodeMapStoryboardPaint7")  
 ...
 ![Code map &#45; Examine method definition](../vs140/media/CodeMapStoryboardPaint8.png "CodeMapStoryboardPaint8")  
 ...
 ![Code map &#45; Examine method definition](../vs140/media/CodeMapStoryboardPaint9.png "CodeMapStoryboardPaint9")  
 ...
 ![Code map &#45; Examine method definition](../vs140/media/CodeMapStoryboardPaint10.png "CodeMapStoryboardPaint10")  
...
## Find the problem by examining the map  
 ...
 ![Code map &#45; Find missing method call](../vs140/media/CodeMapStoryboardPaint11.png "CodeMapStoryboardPaint11")  
...
## Share your discovery and next steps  
 ...
 ![Code map &#45; Comment and flag items for followup](../vs140/media/CodeMapStoryboardPaint12.png "CodeMapStoryboardPaint12")  
  
 For example, you can add comments to the map and flag items using colors.  
  
 ![Code map &#45; Commented and flagged items](../vs140/media/CodeMapStoryboardPaint12A.png "CodeMapStoryboardPaint12A")  
 ...
 ![Code map &#45; Share, export, mail](../vs140/media/CodeMapStoryboardPaint13.png "CodeMapStoryboardPaint13")  
  
## Fix the problem and show what you did  
 To fix this bug, you add the call for `Repaint` to `undo`.  
  
 ![Code map &#45; Add missing method call](../vs140/media/CodeMapStoryboardPaint14.png "CodeMapStoryboardPaint14")  
 ...
 ![Code map &#45; Confirm code fix](../vs140/media/CodeMapStoryboardPaint15.png "CodeMapStoryboardPaint15")  
  
 You can update the map to show the fix you made.  
  
 ![Code map &#45; Update map with missing method call](../vs140/media/CodeMapStoryboardPaint16.png "CodeMapStoryboardPaint16")  
  
 Your map now shows a link between **undo** and **Repaint**.  
  
 ![Code map &#45; Updated map with method call](../vs140/media/CodeMapStoryboardPaint17.png "CodeMapStoryboardPaint17")  
...
## See Also  
 ...
 [Visualize Code](../vs140/Visualize-code.md)