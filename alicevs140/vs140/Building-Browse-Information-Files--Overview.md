...
To create browse information for symbol browsing, the compiler creates an .sbr file for each source file in your project, then BSCMAKE.EXE concatenates the .sbr files into one .bsc file.  
 ...
 Use [/FR](../vs140/-FR---Fr--Create-.Sbr-File-.md) or [/Fr](../vs140/-FR---Fr--Create-.Sbr-File-.md) to tell the compiler to create .sbr files. To create .bsc files, you can call [BSCMAKE](../vs140/BSCMAKE-Command-Line.md) from the command line. Using BSCMAKE from the command line gives you more precise control over the manipulation of browse information files. See [BSCMAKE Reference](../vs140/BSCMAKE-Reference.md) for more information.  
...
>  You can turn on .sbr file generation but leave .bsc file generation turned off. This provides fast builds but also enables you to create a fresh .bsc file quickly by turning on .bsc file generation and building the project.  
 ...
 See [General Property Page (Project)](../Topic/General%20Property%20Page%20\(Project\).md) for information on how to build a browser file in the development environment.  
  
### To create a smaller .bsc file  
  
1.  Use [BSCMAKE command-line options](../vs140/BSCMAKE-Options.md) to exclude information from the browse information file.  
