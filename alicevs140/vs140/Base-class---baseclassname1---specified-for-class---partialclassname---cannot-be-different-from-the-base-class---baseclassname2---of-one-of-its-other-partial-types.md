...
A class is defined in two or more partial declarations, which contain more than one [Inherits Statement](../vs140/Inherits-Statement.md) specifying more than one base class.  
