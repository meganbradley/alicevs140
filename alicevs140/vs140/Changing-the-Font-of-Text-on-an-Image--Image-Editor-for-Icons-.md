...
2.  In Solution Explorer, double-click the file app.ico. The [Image Editor](../vs140/Image-Editor-for-Icons.md) will open.  
  
3.  From the **Image** menu, select **Tools** and then select **Text Tool**. The [Text Tool Dialog Box](../vs140/Text-Tool-Dialog-Box--Image-Editor-for-Icons-.md) will appear.  
...
6.  In the Text Tool Dialog Box, click the **Font** button. The [Text Tool Font Dialog Box](../vs140/Text-Tool-Font-Dialog-Box--Image-Editor-for-Icons-.md) will appear.  
...
## See Also  
 ...
 [Toolbar](../vs140/Toolbar--Image-Editor-for-Icons-.md)