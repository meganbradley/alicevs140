...
## Remarks  
 ...
 For more information on using `CSpinButtonCtrl`, see [Controls](../vs140/Controls--MFC-.md) and [Using CSpinButtonCtrl](../vs140/Using-CSpinButtonCtrl.md).  
...
```  
DWORD GetRange( ) const; void GetRange(    int & lower ,    int& upper ) const; void GetRange32(    int & lower ,     int  &upper ) const;  
...
```  
int SetPos(    int nPos ); int SetPos32(    int nPos );  
