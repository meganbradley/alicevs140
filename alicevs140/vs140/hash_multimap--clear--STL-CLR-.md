...
## Remarks  
 The member function effectively calls [erase](../vs140/hash_multimap--erase--STL-CLR-.md)`(` [begin](../vs140/hash_multimap--begin--STL-CLR-.md)`(),` [end](../vs140/hash_multimap--end--STL-CLR-.md)`())`. You use it to ensure that the controlled sequence is empty.  
