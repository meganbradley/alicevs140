...
### Simple Control Flows  
 You can show a sequence of actions with branches and loops. For more information about how to use the elements described here, see the Describing Control Flow section of the topic [Guidelines for Drawing an Activity Diagram](../vs140/UML-Activity-Diagrams--Guidelines.md).  
  
 ![A simple control flow](../vs140/media/UML_ActOvSimple.png "UML_ActOvSimple")  
