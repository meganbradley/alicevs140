...
The steps in this walkthrough show you how to debug an [!INCLUDE[vstecasp](../vs140/includes/vstecasp_md.md)] Web application, also known as a Web Form. It shows you how to start and stop execution, set breakpoints, and examine variables in the **Watch** window.  
  
> [!NOTE]
>  To complete this walkthrough, you must have Administrator privileges on the server computer. By default, the [!INCLUDE[vstecasp](../vs140/includes/vstecasp_md.md)] process, aspnet_wp.exe or w3wp.exe, runs as an [!INCLUDE[vstecasp](../vs140/includes/vstecasp_md.md)] process. To debug [!INCLUDE[vstecasp](../vs140/includes/vstecasp_md.md)], you must have Administrator privileges on the computer where [!INCLUDE[vstecasp](../vs140/includes/vstecasp_md.md)] runs it. For more information, see [ASP.NET Debugging: System Requirements](../vs140/ASP.NET-Debugging--System-Requirements.md).  
...
6.  Click **OK**.  
     ...
     [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)] creates a new project, and displays the default HTML source code. It also creates a new virtual directory named **WebSite** under **Default Web Site** in IIS.  
...
11. Double-click the button control you dropped.  
     ...
     This takes you to the code page: Default.aspx.cs for C# or Default.aspx.vb for [!INCLUDE[vbprvb](../vs140/includes/vbprvb_md.md)]. The cursor should be in the function `Button1_Click`.  
...
4.  In Internet Explorer, click the button.  
     ...
     In [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)], this takes you to the line where you set your breakpoint on the code page Default.aspx.cs or Default.aspx.vb. This line should be highlighted in yellow. You can now view the variables in your application and control its execution. Your application stops executing and waits for a command from you.  
...
1.  In [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)], you can attach the debugger to a running process. For most effective debugging, compile the executable as a Debug version with symbol (PDB) files.  
...
4.  Attach to the [!INCLUDE[vstecasp](../vs140/includes/vstecasp_md.md)] process. For more information, see [Debugging Deployed ASP.NET Web Applications](../vs140/Debugging-Deployed-Web-Applications.md).  
  
5.  In Internet Explorer, click the button on your form.  
  
     In [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)], you should hit the breakpoint in Default.aspx.cs, Default.aspx.vb, or Default.aspx.  
