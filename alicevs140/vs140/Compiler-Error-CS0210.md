...
You must provide an initializer in a fixed or using statement declaration  
 ...
 You must declare and initialize the variable in a [fixed statement](../vs140/fixed-Statement--C#-Reference-.md). For more information, see [Unsafe Code and Pointers (C# Programmers Reference)](../vs140/Unsafe-Code-and-Pointers--C#-Programming-Guide-.md).  
