...
-   ID_CONTEXT_HELP   Enters SHIFT-F1 help mode.  
    ...
    >  You must connect this to your `CWinApp`-derived class's message map to enable this functionality.  
     ...
     `CWinApp::OnContextHelp` handles this command by setting the help mode cursor, entering a modal loop and waiting for the user to select a window to get help on. Please refer to [Technical Note 28](../vs140/TN028--Context-Sensitive-Help-Support.md) for more details on the MFC Help implementation.  
...
-   ID_HELP   Gives help on the current context  
    ...
    >  You must connect this to your `CWinApp`-derived class's message map to enable this functionality.  
     ...
     `CWinApp::OnHelp` handles this command by getting the right help context for the current application context. This handles simple F1 help, help on message boxes and so on. Please refer to [Technical Note 28](../vs140/TN028--Context-Sensitive-Help-Support.md) for more details on the MFC help implementation.  
