...
#### Parameters  
 ...
 `wszCommand`  
 [in] The command to execute, passed as a Unicode string. Can be **NULL** when using `CAccessor`, in which case the command will be retrieved from the value passed to the [DEFINE_COMMAND](../vs140/DEFINE_COMMAND.md) macro. See [ICommand::Execute](https://msdn.microsoft.com/en-us/library/ms718095.aspx) in the *OLE DB Programmer's Reference* for details.  
