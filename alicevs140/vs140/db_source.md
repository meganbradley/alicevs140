...
## Remarks  
 `db_source` creates a [CDataSource](../vs140/CDataSource-Class.md) and a [CSession](../vs140/CSession-Class.md) object, which together represent a connection with an OLE DB consumer data source.  
