...
>  Application Wizard-generated container code uses this class.  
 ...
 For more information on OLE-specific dialog boxes, see the article [Dialog Boxes in OLE](../vs140/Dialog-Boxes-in-OLE.md).  
...
```  
explicit COleBusyDialog(    HTASK htaskBusy ,    BOOL bNotResponding = FALSE,    DWORD dwFlags = 0,    CWnd* pParentWnd = NULL );  
