...
1.  In the **Call Stack** window, open the shortcut menu. Choose **Show Call Stack on Code Map**. (Keyboard: **CTRL** + **SHIFT** + **`**)  
     ...
     See [Visualize and Debug Code Execution with Call Stacks](../vs140/Map-methods-on-the-call-stack-while-debugging-in-Visual-Studio.md).  
...
-   See [Run to a specified location or function](../vs140/Navigating-through-Code-with-the-Debugger.md#BKMK_Run_to_a_specified_location_or_function).  
  
### To set a breakpoint on the exit point of a function call  
  
-   See [Set a breakpoint at a source line, assembly instruction, or call stack function](../vs140/Using-Breakpoints.md#BKMK_Set_a_breakpoint_at_a_source_line__assembly_instruction__or_call_stack_function_).  
...
## See Also  
 [Mixed Code and Missing Information in the Call Stack Window](../vs140/Mixed-Code-and-Missing-Information-in-the-Call-Stack-Window.md)   
 [How to: Change the Numeric Format of Debugger Windows](../vs140/How-to--Change-the-Numeric-Format-of-Debugger-Windows.md)   
