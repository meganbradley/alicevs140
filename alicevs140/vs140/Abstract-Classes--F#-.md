...
## Remarks  
 ...
 In the previous syntax, `accessibility-modifier` can be `public`, `private` or `internal`. For more information, see [Access Control (F#)](../vs140/Access-Control--F#-.md).  
...
## Example  
 ...
 [!CODE [FsLangRef1#2901](../CodeSnippet/VS_Snippets_Fsharp/fslangref1#2901)]  
...
## See Also  
 ...
 [Properties (F#)](../vs140/Properties--F#-.md)