...
2.  (Optional) Apply a filter to the data. For more information, see [Profiler Report View Filter](../vs140/Performance-Report-View-Filter.md).  
...
## See Also  
 ...
 [Comparing Profiling Tools Data Files](../vs140/Comparing-Performance-Data-Files.md)   
