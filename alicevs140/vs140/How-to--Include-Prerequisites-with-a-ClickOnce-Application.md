...
2.  Open the folder for the prerequisite that you want to add, and then open the language folder for your installed version of [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)] (for example, **en** for English).  
