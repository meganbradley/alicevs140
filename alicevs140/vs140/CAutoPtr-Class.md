...
|[CAutoPtr::Free](../vs140/CAutoPtr--Free.md)|Call this method to delete an object pointed to by a `CAutoPtr`.|  
...
## Remarks  
 ...
 [CHeapPtr](../vs140/CHeapPtr-Class.md) and variants work in the same way as `CAutoPtr`, except that they allocate and free memory using different heap functions instead of the C++                 **new** and **delete** operators. [CAutoVectorPtr](../vs140/CAutoVectorPtr-Class.md) is similar to `CAutoPtr`, the only difference being that it uses **vector new[]** and **vector delete[]** to allocate and free memory.  
