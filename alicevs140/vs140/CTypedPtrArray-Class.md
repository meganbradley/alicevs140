...
## Remarks  
 ...
 For more information on using `CTypedPtrArray`, see the articles [Collections](../vs140/Collections.md) and [Template-Based Classes](../vs140/Template-Based-Classes.md).  
...
```  
void InsertAt(    INT_PTR  nIndex ,    TYPE  newElement ,    INT_PTR  nCount  = 1  ); void InsertAt(    INT_PTR  nStartIndex ,    CTypedPtrArray< BASE_CLASS, TYPE >*  pNewArray );  
...
```  
TYPE & operator[ ](INT_PTR nIndex); TYPE operator[ ](INT_PTR nIndex) const;  
