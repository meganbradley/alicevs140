...
## Example  
 The following example demonstrates how to retrieve the default values of a `CMFCVisualManager` object. This code snippet is part of the [Tasks Pane sample](../vs140/Visual-C---Samples.md).  
...
### Remarks  
 ...
 The default implementation for this method calls [CDC::DrawFrameControl](../vs140/CDC-Class.md#cdc__drawframecontrol) with the `DFC_CAPTION` type. Override this method in your derived visual manager class to customize the appearance of system buttons.  
