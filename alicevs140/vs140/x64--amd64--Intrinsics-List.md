...
|[__addgsword](../vs140/__addgsbyte--__addgsword--__addgsdword--__addgsqword.md)||intrin.h|void __addgsword(unsigned long,unsigned short)|  
...
|[_InterlockedAnd64_HLEAcquire](../vs140/_InterlockedAnd-Intrinsic-Functions.md)|HLE [2]|immintrin.h|__int64 _InterlockedAnd64_HLEAcquire(\__int64 volatile *,\__int64)|  
...
|[_mm_stream_sd](../vs140/_mm_stream_sd.md)|SSE4a|intrin.h|void _mm_stream_sd(double*,\__m128d)|  
...
|[_mm_stream_si64x](../vs140/_mm_stream_si64x.md)|SSE2|intrin.h|void _mm_stream_si64x(\__int64 *,\__int64)|  
|[_mm_stream_ss](../vs140/_mm_stream_ss.md)|SSE4a|intrin.h|void _mm_stream_ss(float*,\__m128)|  
...
|[__movsb](../vs140/__movsb.md)||intrin.h|VOID __movsb(IN PBYTE,IN BYTE const *,IN SIZE_T)|  
|[__movsd](../vs140/__movsd.md)||intrin.h|VOID __movsd(IN PDWORD,IN DWORD const *,IN SIZE_T)|  
|[__movsq](../vs140/__movsq.md)||intrin.h|VOID __movsq(IN PDWORD64,IN DWORD64 const *,IN SIZE_T)|  
|[__movsw](../vs140/__movsw.md)||intrin.h|VOID __movsw(IN PWORD,IN WORD const *,IN SIZE_T)|  
|[_mul128](../vs140/__mul128.md)||intrin.h|__int64 _mul128(\__int64 multiplier,\__int64 multiplicand,\__int64 *highproduct)|  
|[__mulh](../vs140/__mulh.md)||intrin.h|__int64 \__mulh(\__int64,\__int64)|  
...
|[__nop](../vs140/__nop.md)||intrin.h|void __nop(void)|  
|__nvreg_restore_fence||intrin.h|void __nvreg_restore_fence(void)|  
|__nvreg_save_fence||intrin.h|void __nvreg_save_fence(void)|  
|[__outbyte](../vs140/__outbyte.md)||intrin.h|void __outbyte(unsigned short Port,unsigned char Data)|  
|[__outbytestring](../vs140/__outbytestring.md)||intrin.h|void __outbytestring(unsigned short Port,unsigned char *Buffer,unsigned long Count)|  
|[__outdword](../vs140/__outdword.md)||intrin.h|void __outdword(unsigned short Port,unsigned long Data)|  
|[__outdwordstring](../vs140/__outdwordstring.md)||intrin.h|void __outdwordstring(unsigned short Port,unsigned long *Buffer,unsigned long Count)|  
|[__outword](../vs140/__outword.md)||intrin.h|void __outword(unsigned short Port,unsigned short Data)|  
|[__outwordstring](../vs140/__outwordstring.md)||intrin.h|void __outwordstring(unsigned short Port,unsigned short *Buffer,unsigned long Count)|  
...
|[__popcnt](../vs140/__popcnt16--__popcnt--__popcnt64.md)|POPCNT|intrin.h|unsigned int __popcnt(unsigned int)|  
|[__popcnt16](../vs140/__popcnt16--__popcnt--__popcnt64.md)|POPCNT|intrin.h|unsigned short __popcnt16(unsigned short)|  
|[__popcnt64](../vs140/__popcnt16--__popcnt--__popcnt64.md)|POPCNT|intrin.h|unsigned __int64 \__popcnt64(unsigned \__int64)|  
...
|[__rdtsc](../vs140/__rdtsc.md)||intrin.h|unsigned __int64 \__rdtsc(void)|  
|[__rdtscp](../vs140/__rdtscp.md)|RDTSCP|intrin.h|unsigned __int64 \__rdtscp(unsigned int*)|  
|[_ReadBarrier](../vs140/_ReadBarrier.md)||intrin.h|void _ReadBarrier(void)|  
|[__readcr0](../vs140/__readcr0.md)||intrin.h|unsigned __int64 \__readcr0(void)|  
|[__readcr2](../vs140/__readcr2.md)||intrin.h|unsigned __int64 \__readcr2(void)|  
|[__readcr3](../vs140/__readcr3.md)||intrin.h|unsigned __int64 \__readcr3(void)|  
|[__readcr4](../vs140/__readcr4.md)||intrin.h|unsigned __int64 \__readcr4(void)|  
|[__readcr8](../vs140/__readcr8.md)||intrin.h|unsigned __int64 \__readcr8(void)|  
|[__readdr](../vs140/__readdr.md)||intrin.h|unsigned __int64 \__readdr(unsigned)|  
|[__readeflags](../vs140/__readeflags.md)||intrin.h|unsigned __int64 \__readeflags(void)|  
...
|[__readgsbyte](../vs140/__readgsbyte--__readgsdword--__readgsqword--__readgsword.md)||intrin.h|unsigned char __readgsbyte(unsigned long Offset)|  
|[__readgsdword](../vs140/__readgsbyte--__readgsdword--__readgsqword--__readgsword.md)||intrin.h|unsigned long __readgsdword(unsigned long Offset)|  
|[__readgsqword](../vs140/__readgsbyte--__readgsdword--__readgsqword--__readgsword.md)||intrin.h|unsigned __int64 \__readgsqword(unsigned long Offset)|  
|[__readgsword](../vs140/__readgsbyte--__readgsdword--__readgsqword--__readgsword.md)||intrin.h|unsigned short __readgsword(unsigned long Offset)|  
|[__readmsr](../vs140/__readmsr.md)||intrin.h|unsigned __int64 \__readmsr(unsigned long)|  
|[__readpmc](../vs140/__readpmc.md)||intrin.h|unsigned __int64 \__readpmc(unsigned long a)|  
|[_ReadWriteBarrier](../vs140/_ReadWriteBarrier.md)||intrin.h|void _ReadWriteBarrier(void)|  
|[_ReturnAddress](../vs140/_ReturnAddress.md)||intrin.h|void * _ReturnAddress(void)|  
...
|[_rotl16](../vs140/_rotl8--_rotl16.md)||intrin.h|unsigned short _rotl16(unsigned short value,unsigned char shift)|  
|[_rotl8](../vs140/_rotl8--_rotl16.md)||intrin.h|unsigned char _rotl8(unsigned char value,unsigned char shift)|  
|[_rotr16](../vs140/_rotr8--_rotr16.md)||intrin.h|unsigned short _rotr16(unsigned short value,unsigned char shift)|  
|[_rotr8](../vs140/_rotr8--_rotr16.md)||intrin.h|unsigned char _rotr8(unsigned char value,unsigned char shift)|  
...
|[__segmentlimit](../vs140/__segmentlimit.md)||intrin.h|unsigned long __segmentlimit(unsigned long a)|  
|_sgdt||intrin.h|void _sgdt(void*)|  
|[__shiftleft128](../vs140/__shiftleft128.md)||intrin.h|unsigned __int64 \__shiftleft128(unsigned \__int64 LowPart,unsigned \__int64 HighPart,unsigned char Shift)|  
|[__shiftright128](../vs140/__shiftright128.md)||intrin.h|unsigned __int64 \__shiftright128(unsigned \__int64 LowPart,unsigned \__int64 HighPart,unsigned char Shift)|  
...
|[__sidt](../vs140/__sidt.md)||intrin.h|void __sidt(void*)|  
...
|[__stosb](../vs140/__stosb.md)||intrin.h|void __stosb(IN PBYTE,IN BYTE,IN SIZE_T)|  
|[__stosd](../vs140/__stosd.md)||intrin.h|void __stosd(IN PDWORD,IN DWORD,IN SIZE_T)|  
|[__stosq](../vs140/__stosq.md)||intrin.h|void __stosq(IN PDWORD64,IN DWORD64,IN SIZE_T)|  
|[__stosw](../vs140/__stosw.md)||intrin.h|void __stosw(IN PWORD,IN WORD,IN SIZE_T)|  
...
|[__svm_clgi](../vs140/__svm_clgi.md)||intrin.h|void __svm_clgi(void)|  
|[__svm_invlpga](../vs140/__svm_invlpga.md)||intrin.h|void __svm_invlpga(void*,int)|  
|[__svm_skinit](../vs140/__svm_skinit.md)||intrin.h|void __svm_skinit(int)|  
|[__svm_stgi](../vs140/__svm_stgi.md)||intrin.h|void __svm_stgi(void)|  
|[__svm_vmload](../vs140/__svm_vmload.md)||intrin.h|void __svm_vmload(size_t)|  
|[__svm_vmrun](../vs140/__svm_vmrun.md)||intrin.h|void __svm_vmrun(size_t)|  
|[__svm_vmsave](../vs140/__svm_vmsave.md)||intrin.h|void __svm_vmsave(size_t)|  
...
|[__ud2](../vs140/__ud2.md)||intrin.h|void __ud2(void)|  
|[__ull_rshift](../vs140/__ull_rshift.md)||intrin.h|unsigned __int64 [pascal/cdecl] \__ull_rshift(unsigned \__int64,int)|  
|[_umul128](../vs140/_umul128.md)||intrin.h|unsigned __int64 _umul128(unsigned \__int64 multiplier,unsigned \__int64 multiplicand,unsigned \__int64 *highproduct)|  
|[__umulh](../vs140/__umulh.md)||intrin.h|unsigned __int64 \__umulh(unsigned \__int64,unsigned \__int64)|  
|[__vmx_off](../vs140/__vmx_off.md)||intrin.h|void __vmx_off(void)|  
|[__vmx_on](../vs140/__vmx_on.md)||intrin.h|unsigned char __vmx_on(unsigned \__int64*)|  
|[__vmx_vmclear](../vs140/__vmx_vmclear.md)||intrin.h|unsigned char __vmx_vmclear(unsigned \__int64*)|  
|[__vmx_vmlaunch](../vs140/__vmx_vmlaunch.md)||intrin.h|unsigned char __vmx_vmlaunch(void)|  
|[__vmx_vmptrld](../vs140/__vmx_vmptrld.md)||intrin.h|unsigned char __vmx_vmptrld(unsigned \__int64*)|  
|[__vmx_vmptrst](../vs140/__vmx_vmptrst.md)||intrin.h|void __vmx_vmptrst(unsigned \__int64 *)|  
|[__vmx_vmread](../vs140/__vmx_vmread.md)||intrin.h|unsigned char __vmx_vmread(size_t,size_t*)|  
|[__vmx_vmresume](../vs140/__vmx_vmresume.md)||intrin.h|unsigned char __vmx_vmresume(void)|  
|[__vmx_vmwrite](../vs140/__vmx_vmwrite.md)||intrin.h|unsigned char __vmx_vmwrite(size_t,size_t)|  
|[__wbinvd](../vs140/__wbinvd.md)||intrin.h|void __wbinvd(void)|  
|[_WriteBarrier](../vs140/_WriteBarrier.md)||intrin.h|void _WriteBarrier(void)|  
|[__writecr0](../vs140/__writecr0.md)||intrin.h|void __writecr0(unsigned \__int64)|  
|[__writecr3](../vs140/__writecr3.md)||intrin.h|void __writecr3(unsigned \__int64)|  
|[__writecr4](../vs140/__writecr4.md)||intrin.h|void __writecr4(unsigned \__int64)|  
|[__writecr8](../vs140/__writecr8.md)||intrin.h|void __writecr8(unsigned \__int64)|  
|[__writedr](../vs140/__writedr.md)||intrin.h|void __writedr(unsigned,unsigned \__int64)|  
|[__writeeflags](../vs140/__writeeflags.md)||intrin.h|void __writeeflags(unsigned \__int64)|  
...
|[__writegsbyte](../vs140/__writegsbyte--__writegsdword--__writegsqword--__writegsword.md)||intrin.h|void __writegsbyte(unsigned long Offset,unsigned char Data)|  
|[__writegsdword](../vs140/__writegsbyte--__writegsdword--__writegsqword--__writegsword.md)||intrin.h|void __writegsdword(unsigned long Offset,unsigned long Data)|  
|[__writegsqword](../vs140/__writegsbyte--__writegsdword--__writegsqword--__writegsword.md)||intrin.h|void __writegsqword(unsigned long Offset,unsigned \__int64 Data)|  
|[__writegsword](../vs140/__writegsbyte--__writegsdword--__writegsqword--__writegsword.md)||intrin.h|void __writegsword(unsigned long Offset,unsigned short Data)|  
|[__writemsr](../vs140/__writemsr.md)||intrin.h|void __writemsr(unsigned long,unsigned \__int64)|  
