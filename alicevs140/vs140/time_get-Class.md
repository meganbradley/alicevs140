...
### Remarks  
 ...
 `'a'` or `'A'` -- behaves the same as [get_weekday](#time_get__get_weekday).  
  
 `'b'`, `'B'`, or `'h'` -- behaves the same as [get_monthname](#time_get__get_monthname).  
 ...
 `'Y'` -- behaves the same as [get_year](#time_get__get_year).  
