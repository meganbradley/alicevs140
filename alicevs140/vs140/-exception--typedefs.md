...
### Example  
  See [set_terminate](../vs140/-exception--functions.md#set_terminate) for an example of the use of `terminate_handler`.  
...
### Example  
  See [set_unexpected](../vs140/-exception--functions.md#set_unexpected) for an example of the use of `unexpected_handler`.  
