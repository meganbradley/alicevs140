...
These examples demonstrate how to use covariance and contravariance in the `Func` and `Action` generic delegates to enable reuse of methods and provide more flexibility in your code.  
 ...
 For more information about covariance and contravariance, see [Variance in Delegates (Visual Basic)](../Topic/Variance%20in%20Delegates%20\(Visual%20Basic\).md).  
...
## See Also  
 [Covariance and Contravariance (Visual Basic)](../Topic/Covariance%20and%20Contravariance%20\(Visual%20Basic\).md)   
