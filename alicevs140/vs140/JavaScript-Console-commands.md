...
|`select(element)`|Selects the specified HTML `element` in the [DOM Explorer](../vs140/Quickstart--Debug-HTML-and-CSS.md).|console.select(element);|  
...
|`select(element)`|Selects the specified element in [DOM Explorer](../vs140/Quickstart--Debug-HTML-and-CSS.md).|`select(document.getElementById("element"));`<br /><br /> `select($("element"));`<br /><br /> `select($1);`|  
