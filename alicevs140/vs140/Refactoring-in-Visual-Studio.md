...
### Refactoring in C#  
 [Refactoring (C#)](../vs140/Refactoring--C#-.md)  
  
### Refactoring in Visual Basic  
 [Refactoring and Rename Dialog Box (Visual Basic)](../vs140/Refactoring-and-Rename-Dialog-Box--Visual-Basic-.md)  
  
### Refactoring in C++  
 [Writing and refactoring code (C++)](../vs140/Writing-and-refactoring-code--C---.md)  
...
## See Also  
 ...
 [Writing Code in the Code and Text Editor](../vs140/Writing-Code-in-the-Code-and-Text-Editor.md)