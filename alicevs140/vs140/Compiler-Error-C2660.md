...
## Example  
 C2660 can also occur if you attempt to directly call the Dispose method of a managed type. For more information, see [Destructors and Finalizers](../Topic/How%20to:%20Define%20and%20Consume%20Classes%20and%20Structs%20\(C++-CLI\).md#BKMK_Destructors_and_finalizers). The following sample generates C2660.  
