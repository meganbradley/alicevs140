...
## Creating a basic texture  
 ...
 !["Bullseye" target with transparency shown in green](../vs140/media/Digit-Bullseye-Texture-In-Editor.png "Digit-Bullseye-Texture-In-Editor")  
...
11. Using the **Ellipse** tool, draw a circle from pixel coordinate `(3, 3)` to pixel coordinate `(508, 508)`. To draw the circle more easily, you can press and hold the Shift key while you draw.  
    ...
    > [!NOTE]
    >  The pixel coordinates of the current pointer location are displayed on the [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)] status bar.  
...
17. Draw another circle from pixel coordinate `(192, 192)` to pixel coordinate `(320, 320)`.  
 ...
 ![The complete "bullseye" target texture](../vs140/media/gfx_image_demo_bullseye.png "gfx_image_demo_bullseye")  
  
 As a next step, you can generate MIP levels for this texture. For information, see [How to: Generate and Modify MIP Levels](../vs140/How-to--Create-and-Modify-MIP-Levels.md).  
