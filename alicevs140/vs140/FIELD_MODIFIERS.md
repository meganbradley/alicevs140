...
## Members  
 ...
 Indicates that the field has a special name, for example, `.ctor` for a constructor ([!INCLUDE[vbprvb](../vs140/includes/vbprvb_md.md)] only).  
  
 FIELD_MOD_HIDEBYSIG  
 Indicates that the field has the `Overloads` keyword applied to it ([!INCLUDE[vbprvb](../vs140/includes/vbprvb_md.md)] only).  
...
## Remarks  
 Used for the `dwModifiers` member of the [FIELD_INFO](../vs140/FIELD_INFO.md) structure.  
