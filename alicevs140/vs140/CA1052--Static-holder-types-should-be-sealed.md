...
## Cause  
 A public or protected type contains only static members and is not declared with the [sealed](../vs140/sealed--C#-Reference-.md) ([NotInheritable](../vs140/NotInheritable--Visual-Basic-.md)) modifier.  
...
## How to Fix Violations  
 To fix a violation of this rule, mark the type as `sealed`. If you are targeting [!INCLUDE[dnprdnshort](../vs140/includes/dnprdnshort_md.md)] 2.0 or earlier, a better approach is to mark the type as `static`. In this manner, you avoid having to declare a private constructor to prevent the class from being created.  
...
## Related Rules  
 [Static holder types should not have constructors](../vs140/CA1053--Static-holder-types-should-not-have-constructors.md)