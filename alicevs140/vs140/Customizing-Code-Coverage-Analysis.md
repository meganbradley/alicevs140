...
5.  To turn the custom settings off and on, deselect or select the file in the **Test**, **Test Settings** menu.  
 ...
 Other aspects of unit tests can be configured in the same .runsettings file. For more information, see [Configuring unit tests with .runsettings](../Topic/Unit%20Test%20Your%20Code.md).  
...
## See Also  
 ...
 [Configuring unit tests with .runsettings](../Topic/Unit%20Test%20Your%20Code.md)