...
The **/lib** option specifies the location of assemblies referenced by means of the [/reference](../vs140/-reference--C#-Compiler-Options-.md) option.  
 ...
 **/lib** is additive; specifying it more than once appends to any prior values.  
 ...
 Because the compiler can reference the assembly does not imply the common language runtime will be able to find and load the assembly at runtime. See [How the Runtime Locates Assemblies](assetId:///772ac6f4-64d2-4cfb-92fd-58096dcd6c34) for details on how the runtime searches for referenced assemblies.  
...
3.  Modify the contents of the list box.  
 ...
 For information on how to set this compiler option programmatically, see <xref:VSLangProj80.ProjectProperties3.ReferencePath?qualifyHint=False>.  
