...
```  
 ...
 As with all [pragma directives](../vs140/Pragma-Directives-and-the-__Pragma-Keyword.md), the alternate pragma syntax `__pragma(loop(hint_parallel(n)))` is also supported.  
...
## Auto-Vectorizer  
 ...
 By default, the Auto-Vectorizer is enabled. If you want to compare the performance of your code under vectorization, you can use [#pragma loop(no_vector)](../vs140/loop.md) to disable vectorization of any given loop.  
...
```  
 ...
 As with all [pragma directives](../vs140/Pragma-Directives-and-the-__Pragma-Keyword.md), the alternate pragma syntax `__pragma(loop(no_vector))` is also supported.  
  
 As with the Auto-Parallelizer, you can specify the [/Qvec-report](../Topic/-Qvec-report%20\(Auto-Vectorizer%20Reporting%20Level\).md) command-line option to report either successfully vectorized loops only—**/Qvec-report:1**—or both successfully and unsuccessfully vectorized loops—**/Qvec-report:2**).  
...
## See Also  
 ...
 [/Qpar](../Topic/-Qpar%20\(Auto-Parallelizer\).md)   
 [/Qpar-report](../vs140/-Qpar-report--Auto-Parallelizer-Reporting-Level-.md)   
 [/Qvec-report](../Topic/-Qvec-report%20\(Auto-Vectorizer%20Reporting%20Level\).md)   
 [Vectorizer/Parallelizer Messages](../vs140/Vectorizer-and-Parallelizer-Messages.md)