...
An <xref:System.IdentityModel.Selectors.UnsupportedPolicyOptionsException?qualifyHint=False> exception indicates that a policy was provided to the system that includes options that are not supported. Restrictions that can cause these failures include the following:  
...
## See Also  
 <xref:System.IdentityModel.Selectors.UnsupportedPolicyOptionsException?qualifyHint=False>   
