...
You can use the Model Editor in [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)] to create 3-D models. You can use the models in your DirectX-based game or app.  
...
|Title|Description|  
|-----------|-----------------|  
|[The Model Editor](../vs140/Model-Editor.md)|Describes how to use the Model Editor to work with 3-D models.|  
|[Model Editor Examples](../vs140/Model-Editor-Examples.md)|Provides links to topics that demonstrate how to use the Model Editor to perform common 3-D modeling tasks.|