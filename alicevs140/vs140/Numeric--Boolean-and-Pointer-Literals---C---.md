...
## Pointer literal (C++11)  
 C++ introduces the [nullptr](../vs140/nullptr.md) literal to specify a zero-initialized pointer. In portable code, `nullptr` should be used instead of integral-type zero or macros such as NULL.  
