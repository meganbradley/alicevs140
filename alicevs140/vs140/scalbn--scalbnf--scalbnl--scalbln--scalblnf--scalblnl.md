...
## Remarks  
 `FLT_RADIX` is defined in <float.h> as the native floating-point radix; on binary systems, it has a value of 2, and `scalbn` is equivalent to [ldexp](../vs140/ldexp.md).  
