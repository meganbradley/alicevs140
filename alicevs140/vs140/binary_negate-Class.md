...
## Remarks  
 ...
 The constructor of `binary_negate` is rarely used directly. The helper function [not2](../vs140/-functional--functions.md#not2_function) is usually preferred to declare and use the **binary_negator** adaptor predicate.  
