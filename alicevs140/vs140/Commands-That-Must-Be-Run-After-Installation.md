...
> [!NOTE]
>  The information in this topic applies to finding DevEnv with Visual Studio 2008 and earlier. For information about how to discover DevEnv with later versions of Visual Studio, see [Detecting System Requirements](../vs140/Detecting-System-Requirements.md).  
  
## Finding devenv.exe  
 You can locate each version's devenv.exe from registry values that [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)] installers write, using the RegLocator Table and AppSearch Table to store the registry values as properties. For more information, see [Detecting System Requirements](../vs140/Detecting-System-Requirements.md).  
