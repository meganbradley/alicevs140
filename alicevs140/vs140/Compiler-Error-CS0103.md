...
The name 'identifier' does not exist in the current context  
 ...
 An attempt was made to use a name that does not exist in the class, [namespace](../vs140/namespace--C#-Reference-.md), or scope. Check the spelling of the name and check your using directives and assembly references to make sure that the name that you are trying to use is available.  
