...
### Parameters  
 ...
 `bAbort`  
 Specifies whether the file is to be released by using either `CFile::Close` or `CFile::Abort`. **FALSE** if the file is to be released using [CFile::Close](../vs140/CFile-Class.md#cfile__close); **TRUE** if the file is to be released using [CFile::Abort](../vs140/CFile-Class.md#cfile__abort).  
