...
## Remarks  
 This is an internal function that the CRT uses to retrieve the current value of the [MB_CUR_MAX](../vs140/MB_CUR_MAX.md) macro from thread local storage. We recommend that you use the `MB_CUR_MAX` macro in your code for portability.  
...
## See Also  
 [MB_CUR_MAX](../vs140/MB_CUR_MAX.md)