...
### Example  
  The following example demonstrates some uses for the `iota` function by filling a [list](../vs140/-list-.md) of integers and then filling a [vector](../vs140/-vector-.md) with the `list` so that the [random_shuffle](../vs140/-algorithm--functions.md#random_shuffle) function can be used.  
