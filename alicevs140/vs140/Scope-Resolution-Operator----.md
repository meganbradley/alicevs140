...
The scope resolution operator `::` is used to identify and disambiguate identifiers used in different scopes. For more information about scope, see [Scope](../vs140/Scope--Visual-C---.md).  
