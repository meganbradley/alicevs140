...
-   From the **Run this rule set** list, use one of the following methods:  
    ...
    -   For more information about how to create and implement a custom check-in policy rule set, see [Implementing Custom Code Analysis Check-in Policies for Managed Code](../vs140/Implementing-Custom-Code-Analysis-Check-in-Policies-for-Managed-Code.md).  
