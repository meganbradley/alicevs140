...
## Example  
 The following example illustrates the SuspendProfile method. This example assumes that a prior call to StartProfile has been made for the process or thread identified by [PROFILE_CURRENTID](../vs140/PROFILE_CURRENTID.md).  
