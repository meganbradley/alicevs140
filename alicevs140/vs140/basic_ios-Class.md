...
### Return Value  
 ...
 For more information on `badbit`, see [ios_base::iostate](../vs140/ios_base-Class.md#ios_base__iostate).  
...
### Remarks  
 ...
 If `state`**&**[exceptions](#basic_ios__exceptions) is nonzero, it then throws an object of class [failure](../vs140/ios_base-Class.md#ios_base__failure).  
...
### Remarks  
 The member function returns `true` if [rdstate](#basic_ios__rdstate) `& eofbit` is nonzero. For more information on `eofbit`, see [ios_base::iostate](../vs140/ios_base-Class.md#ios_base__iostate).  
...
### Return Value  
 ...
 For more information on `failbit`, see [ios_base::iostate](../vs140/ios_base-Class.md#ios_base__iostate).  
...
### Return Value  
 ...
 For more information on `goodbit`, see [ios_base::iostate](../vs140/ios_base-Class.md#ios_base__iostate).  
...
### Remarks  
 ...
 `rdbuf`->                        [pubimbue](../vs140/basic_streambuf-Class.md#basic_streambuf__pubimbue)(_ *Loc*)  
...
-   [rdstate](#basic_ios__rdstate) returns [goodbit](../vs140/ios_base-Class.md#ios_base__iostate) if `_Sb` is nonzero; otherwise, it returns [badbit](../vs140/ios_base-Class.md#ios_base__iostate).  
...
-   [getloc](../vs140/ios_base-Class.md#ios_base__getloc) returns `locale::classic`.  
...
### Remarks  
 The member function returns [use_facet](../vs140/basic_filebuf-Class.md#basic_filebuf__open)**<**Â **ctype**<                        **E**> >(                         [getloc](../vs140/ios_base-Class.md#ios_base__getloc)( ) ).                         `narrow`(                        `_Char`,                         `_Default`).  
...
### Remarks  
 The member function returns [use_facet](../vs140/basic_filebuf-Class.md#basic_filebuf__open)<                         **ctype**<                        **E**> >(                         [getloc](../vs140/ios_base-Class.md#ios_base__getloc)).                         `widen`(                        `_Char`).  
