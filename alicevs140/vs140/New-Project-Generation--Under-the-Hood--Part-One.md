...
## The New Project Dialog Box  
 ...
 ![New Project dialog box](../vs140/media/NewProject.gif "NewProject")  
...
##### DeveloperActivity  
 ...
 indicates that Visual C# will be a root node if Visual Studio is set for [!INCLUDE[vcprvc](../vs140/includes/vcprvc_md.md)] development. Otherwise, it will be a child node of **Other Languages**.  
...
#### Project Type Child Nodes and .vstdir Files  
 ...
 ![Project Types](../vs140/media/ProjectTypes.png "ProjectTypes")  
  
 The corresponding ProjectTemplates folder looks like this:  
  
 ![Project Templates](../vs140/media/ProjectTemplates.png "ProjectTemplates")  
  
 When the **New Project** dialog box opens, [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)] traverses the ProjectTemplates folder and recreates its structure in the **Project types** tree with some changes:  
...
1.  Open the **New Project** dialog box and expand the **Visual C#** project node.  
 ...
 ![MyProjectNode](../vs140/media/MyProjectNode.png "MyProjectNode")  
  
 **MyProjectNode** appears as a child node of Visual C# just under the Windows node.  
  
## See Also  
 [New Project Generation: Under the Hood, Part Two](../vs140/New-Project-Generation--Under-the-Hood--Part-Two.md)