...
## Example  
 The following example demonstrates how to construct a `CMFCRibbonEdit` object, show spin buttons next to the edit control, and set the text of the edit control. This code snippet is part of the [MS Office 2007 Demo sample](../vs140/Visual-C---Samples.md).  
...
### Remarks  
 The `src` parameter must be of type [CMFCRibbonEdit](../vs140/CMFCRibbonEdit-Class.md).  
...
### Parameters  
 [in] `bInFloatyMode`  
 `TRUE` if the [CMFCRibbonEdit](../vs140/CMFCRibbonEdit-Class.md) control is in floating mode; otherwise, `FALSE`.  
...
### Return Value  
 `TRUE` if the [CMFCRibbonEdit](../vs140/CMFCRibbonEdit-Class.md) control has the focus; otherwise `FALSE`.  
...
### Return Value  
 `TRUE` if the [CMFCRibbonEdit](../vs140/CMFCRibbonEdit-Class.md) control is highlighted; otherwise `FALSE`.  
