...
The *handle declarator* (`^`, pronounced "hat"), modifies the type [specifier](../vs140/Overview-of-Declarators.md) to mean that the declared object should be automatically deleted when the system determines that the object is no longer accessible.  
