...
## Example  
 The following code example illustrates a `Signature` element in a deployment manifest used in a [!INCLUDE[ndptecclick](../vs140/includes/ndptecclick_md.md)] deployment.  
