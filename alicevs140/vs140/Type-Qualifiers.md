...
```  
 ...
 Type qualifiers are relevant only when accessing identifiers as l-values in expressions. See [L-Value and R-Value Expressions](../vs140/L-Value-and-R-Value-Expressions.md) for information about l-values and expressions.  
