...
## Example  
 Use `_RTC_SetErrorFuncW` to install your custom function in place of `_CrtDbgReportW`. For more information, see [_RTC_SetErrorFuncW](../vs140/_RTC_SetErrorFuncW.md). The `_RTC_SetErrorFuncW` return value is the previous reporting function, which you can save and restore if necessary.  
