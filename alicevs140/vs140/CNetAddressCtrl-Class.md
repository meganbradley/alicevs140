...
## Remarks  
 ...
 The `CNetAddressCtrl` class is derived from the [CEdit](../vs140/CEdit-Class.md) class. Consequently, the network address control provides access to all Windows edit control messages.  
