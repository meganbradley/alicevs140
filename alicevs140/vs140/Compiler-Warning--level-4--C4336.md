...
import cross-referenced type library 'type_lib1' before importing 'type_lib2'  
 ...
 A type library was referenced with the [#import](../vs140/#import-Directive--C---.md) directive. However, the type library contained a reference to another type library that was not referenced with `#import`. This other .tlb file was found by the compiler.  
