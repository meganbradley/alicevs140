...
![Applies to Windows and Windows Phone](../vs140/media/windows_and_phone_content.png "windows_and_phone_content")  
 ...
 The list on the **Events** tab is dynamic. If you add an event listener while the app is running, the new event listener will appear there. For info on adding and removing event listeners, see [Tips on resolving issues with event listeners](#Tips) in this topic.  
...
2.  With the template open in Visual Studio, select **Emulator 8.1 WVGA 4in 512MB** in the drop-down list on the Debug toolbar in the debugger:  
     ...
     ![Selecting a debug target](../vs140/media/JS_DOM_Debug_Target_Emu.png "JS_DOM_Debug_Target_Emu")  
...
9. Choose the **Events** tab in the pane on the right side of DOM Explorer.  
     ...
     ![Events Tab of the DOM Explorer](../vs140/media/JS_DOM_Events.png "JS_DOM_Events")  
...
11. To quickly identify event listeners for parent elements in the DOM hierarchy, choose a parent element in the hierarchy list at the bottom of the DOM Explorer.  
     ...
     ![Selecting parent elements in the DOM hierarchy](../vs140/media/JS_DOM_Breadcrumbs.png "JS_DOM_Breadcrumbs")  
...
-   If `removeEventListener` fails to remove the specified listener, it might be getting called on a different instance of the object. You can use the [bind](assetId:///28946f47-b758-48cf-b508-610a0f2f6e19) method to resolve this issue when you add the listener.  
  
-   To remove an event listener that was added by using either [bind](assetId:///28946f47-b758-48cf-b508-610a0f2f6e19) or by using an anonymous function, store an instance of the function when you add the listener. Here's one way to safely use this pattern:  
...
-   Use the JavaScript memory analyzer to [analyze memory usage](../vs140/JavaScript-Memory.md) in your app. Event listeners that must be explicitly removed might appear as a memory leak.  
  
## See Also  
 [QuickStart: Debug HTML, CSS, and JavaScript](../vs140/Quickstart--Debug-HTML-and-CSS.md)   
 [Debug CSS Rules](../vs140/Debug-CSS-styles-using-DOM-Explorer.md)   
 [Debug layout](../vs140/Debug-layout-using-DOM-Explorer.md)