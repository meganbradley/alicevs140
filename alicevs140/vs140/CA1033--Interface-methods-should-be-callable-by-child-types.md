...
## Rule Description  
 ...
 This rule does not report a violation for an explicit implementation of <xref:System.IDisposable.Dispose?qualifyHint=True> when an externally visible `Close()` or `System.IDisposable.Dispose(Boolean)` method is provided.  
...
## See Also  
 [C# Language Specification: Interfaces](../Topic/Interfaces%20\(C%23%20Programming%20Guide\).md)