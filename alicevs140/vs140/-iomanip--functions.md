...
### Return Value  
 The manipulator returns an object that, when extracted from or inserted into the stream **str**, calls **str**. [setf](../vs140/ios_base-Class.md#ios_base__setf)( `ios_base::`[fmtflags](../vs140/ios_base-Class.md#ios_base__fmtflags), _                        *Mask*), and then returns **str**.  
  
### Example  
  See [setw](../vs140/-iomanip--functions.md#setw) for an example of using `resetiosflags`.  
...
### Return Value  
 The manipulator returns an object that, when extracted from or inserted into the stream **str**, calls **str**. `setf`( **mask**, [ios_base::basefield](../vs140/ios_base-Class.md#ios_base__fmtflags)), and then returns **str**. Here, **mask** is determined as follows:  
  
-   If _                                *Base* is 8, then **mask** is `ios_base::`[oct](../vs140/-ios--functions.md#oct).  
  
-   If _                                *Base* is 10, then mask is `ios_base::`[dec](../vs140/-ios--functions.md#dec).  
  
-   If _                                *Base* is 16, then **mask** is `ios_base::`[hex](../vs140/-ios--functions.md#hex).  
  
-   If _                                *Base* is any other value, then mask is `ios_base::`[fmtflags](../vs140/ios_base-Class.md#ios_base__fmtflags)(0).  
  
### Example  
  See [setw](../vs140/-iomanip--functions.md#setw) for an example of using `setbase`.  
...
### Return Value  
 The template manipulator returns an object that, when extracted from or inserted into the stream **str**, calls **str**. [fill](../vs140/basic_ios-Class.md#basic_ios__fill)( `_Ch`), and then returns **str**. The type **Elem** must be the same as the element type for the stream **str**.  
  
### Example  
  See [setw](../vs140/-iomanip--functions.md#setw) for an example of using `setfill`.  
...
### Example  
  See [setw](../vs140/-iomanip--functions.md#setw) for an example of using `setiosflags`.  
...
### Return Value  
 The manipulator returns an object that, when extracted from or inserted into the stream **str**, calls **str**. [precision](../vs140/ios_base-Class.md#ios_base__precision)( `_Prec`), and then returns **str**.  
  
### Example  
  See [setw](../vs140/-iomanip--functions.md#setw) for an example of using `setprecision`.  
