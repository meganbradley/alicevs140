...
-   Copy the names.csv and scores.csv files into your project folder, as described in [How to: Join Content from Dissimilar Files (LINQ) (C#)](../vs140/How-to--Join-Content-from-Dissimilar-Files--LINQ---C#-.md).  
...
```  
 ...
 In the [select](../vs140/select-clause--C#-Reference-.md) clause, an object initializer is used to instantiate each new `Student` object by using the data from the two sources.  
