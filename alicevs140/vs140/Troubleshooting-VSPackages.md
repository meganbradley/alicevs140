...
5.  Examine the activity log.  
     ...
     For more information, see [How To: Use the Activity Log (C#)](../Topic/How%20to:%20Use%20the%20Activity%20Log.md).  
...
2.  Use the activity log.  
     ...
     Trace VSPackage behavior by writing information to the activity log at key points. This technique is especially useful when you run a VSPackage in a retail environment. For more information, see [How To: Use the Activity Log (C#)](../Topic/How%20to:%20Use%20the%20Activity%20Log.md).  
