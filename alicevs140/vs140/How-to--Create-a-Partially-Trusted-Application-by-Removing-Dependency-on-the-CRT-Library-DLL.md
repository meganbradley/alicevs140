...
This topic discusses how to create a partially trusted Common Language Runtime application using [!INCLUDE[vcprvc](../vs140/includes/vcprvc_md.md)] by removing dependency on msvcm90.dll.  
...
## See Also  
 ...
 [/link (Pass Options to Linker)](../vs140/-link--Pass-Options-to-Linker-.md)   
