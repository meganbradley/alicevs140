...
## Using XML Snippets  
 ...
 The default colors for editable code snippet fields can be changed by modifying the Code Snippet Field setting in the **Fonts and Colors** pane of the **Option**s dialog box. For more information, see [How to: Change the Font Face, Size, and Colors Used in the Editor](../vs140/How-to--Change-Fonts-and-Colors-in-the-Editor.md).  
