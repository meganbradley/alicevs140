...
Reference required to module '<`modulename`>' containing the definition for event '<`eventname`>'. Add one to your project.  
 ...
 The event is defined in a module that is not directly referenced in your project. The [!INCLUDE[vbprvb](../vs140/includes/vbprvb_md.md)] compiler requires a reference to avoid ambiguity in case the event is defined in more than one module.  
