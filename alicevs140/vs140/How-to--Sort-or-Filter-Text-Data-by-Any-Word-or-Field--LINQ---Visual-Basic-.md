...
1.  Copy the scores.csv data from the topic [How to: Join Content from Dissimilar Files (LINQ) (Visual Basic)](../vs140/How-to--Join-Content-from-Dissimilar-Files--LINQ---Visual-Basic-.md) and save it to your solution folder.  
