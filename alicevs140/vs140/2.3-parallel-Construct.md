...
-   **private**, **firstprivate**, **default**, **shared**, **copyin**, and **reduction** clauses, see [Section 2.7.2](../vs140/2.7.2-Data-Sharing-Attribute-Clauses.md) on page 25.  
  
-   **OMP_NUM_THREADS** environment variable, [Section 4.2](../vs140/4.2-OMP_NUM_THREADS.md) on page 48.  
  
-   **omp_set_dynamic** library function, see [Section 3.1.7](../vs140/3.1.7-omp_set_dynamic-Function.md) on page 39.  
...
-   **omp_set_num_threads** library function, see [Section 3.1.1](../vs140/3.1.1-omp_set_num_threads-Function.md) on page 36.