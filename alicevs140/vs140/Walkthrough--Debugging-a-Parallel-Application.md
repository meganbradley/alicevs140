...
This walkthrough shows how to use the **Parallel Tasks** and **Parallel Stacks** windows to debug a parallel application. These windows help you understand and verify the runtime behavior of code that uses the [Task Parallel Library](assetId:///b8f99f43-9104-45fd-9bff-385a20488a23) or the [Concurrency Runtime](../vs140/Concurrency-Runtime.md). This walkthrough provides sample code that has built-in breakpoints. After the code breaks, the walkthrough shows how to use the **Parallel Tasks** and **Parallel Stacks** windows to examine it.  
...
2.  In the **Installed Templates** pane, select either Visual C#, Visual Basic, or Visual C++. For the managed languages, ensure that [!INCLUDE[net_v40_short](../vs140/includes/net_v40_short_md.md)] is displayed in the framework box.  
...
1.  On the **Debug** menu, point to **Windows** and then click **Parallel Stacks**. Make sure that **Threads** is selected in the box at the upper-left corner.  
     ...
     ![Threads view in Parallel Stacks window](../vs140/media/PDB_Walkthrough_1.png "PDB_Walkthrough_1")  
     ...
     ![Tooltip that shows thread IDs and names](../vs140/media/PDB_Walkthrough_1A.png "PDB_Walkthrough_1A")  
  
     The yellow arrow indicates the active stack frame of the current thread. To get more information, hover over it  
  
     ![Tooltip on active stack frame](../vs140/media/PDB_Walkthrough_1B.png "PDB_Walkthrough_1B")  
     ...
     ![Highlighted main thread in Parallel Stacks window](../vs140/media/PDB_Walkthrough_1C.png "PDB_Walkthrough_1C")  
...
1.  To resume execution until the second breakpoint is hit, on the **Debug** menu, click **Continue**. The following illustration shows the thread tree at the second breakpoint.  
     ...
     ![Parallel Stacks window that shows many branches](../vs140/media/PDB_Walkthrough_2.png "PDB_Walkthrough_2")  
     ...
     ![Parallel Stacks Path of Execution](../vs140/media/PDB_Walkthrough_2B.png "PDB_Walkthrough_2B")  
     ...
     ![Stacks menu with 2 options on C while J is current](../vs140/media/PDB_Walkthrough_3.png "PDB_Walkthrough_3")  
     ...
     ![Empty Parallel Stacks window and tooltip](../vs140/media/PDB_Walkthrough_3A.png "PDB_Walkthrough_3A")  
...
1.  To resume execution until the third breakpoint is hit, on the **Debug** menu, click **Continue**.  
     ...
     ![Execution path in Parallel Stacks window](../vs140/media/PDB_Walkthrough_3B.png "PDB_Walkthrough_3B")  
     ...
     ![Method view in Parallel Stacks window](../vs140/media/PDW_Walkthrough_4.png "PDW_Walkthrough_4")  
    ...
    -   **Show External Code** displays all the frames even if they are not in user code. Try it to see the diagram expand to accommodate the additional frames (which may be dimmed because you do not have symbols for them).  
     ...
     ![Autoscrolling in the Parallel Stacks window](../vs140/media/PDB_Walkthrough_4A.png "PDB_Walkthrough_4A")  
...
1.  To resume execution until the fourth breakpoint is hit, on the **Debug** menu, click **Continue**.  
     ...
     ![Bird's&#45;eye view in Parallel Stacks window](../vs140/media/PDB_Walkthrough_5.png "PDB_Walkthrough_5")  
     ...
     ![Zoomed stacks in Parallel Stacks window](../vs140/media/PDB_Walkthrough_5A.png "PDB_Walkthrough_5A")  
...
5.  On the **Debug** menu, point to **Windows** and then click **Parallel Tasks**. The following illustration shows the **Parallel Tasks** window.  
     ...
     ![Four running tasks in Parallel Tasks window](../vs140/media/PDW_Walkthrough_6.png "PDW_Walkthrough_6")  
...
1.  To resume execution until the second breakpoint is hit, on the **Debug** menu, click **Continue**.  
     ...
     ![Two waiting tasks in Parallel Tasks window](../vs140/media/PDB_Walkthrough_7.png "PDB_Walkthrough_7")  
  
     Task 4, in turn, is waiting on a monitor owned by the thread assigned to task 2.  
  
     ![Waiting task and tooltip in Tasks window](../vs140/media/PDB_Walkthrough_7A.png "PDB_Walkthrough_7A")  
     ...
     ![Threads view in Parallel Stacks window](../vs140/media/PDB_Walkthrough_8.png "PDB_Walkthrough_8")  
     ...
     ![Shortcut view menu in Parallel Tasks window](../vs140/media/PDB_Walkthrough_8A.png "PDB_Walkthrough_8A")  
...
1.  To resume execution until the third breakpoint is hit, on the **Debug** menu, click **Continue**.  
     ...
     ![Parent&#45;child view in Parallel Tasks window](../vs140/media/PDB_Walkthrough_9.png "PDB_Walkthrough_9")  
     ...
     ![Task view in Parallel Stacks window](../vs140/media/PDB_Walkthrough_9A.png "PDB_Walkthrough_9A")  
     ...
     ![Highlighted thread in threads view](../vs140/media/PDB_Walkthrough_9B.png "PDB_Walkthrough_9B")  
...
1.  To resume execution until the third breakpoint is hit, on the **Debug** menu, click **Continue**. Click the **ID** column header to sort by ID. You should see the following illustration.  
     ...
     ![Four task states in Parallel Stacks window](../vs140/media/PDB_Walkthrough_10.png "PDB_Walkthrough_10")  
     ...
     ![Header tooltip in Parallel Stacks window](../vs140/media/PDB_Walkthrough_11.png "PDB_Walkthrough_11")  
     ...
     ![Grouped tasks in Parallel Tasks window](../vs140/media/PDB_Walkthrough_12.png "PDB_Walkthrough_12")  
     ...
     ![Grouped stacks in Parallel Stacks window](../vs140/media/PDB_Walkthrough_12A.png "PDB_Walkthrough_12A")  
     ...
     ![Shortcut menu in Parallel Tasks window](../vs140/media/PDB_Walkthrough_12B.png "PDB_Walkthrough_12B")  
