...
### Remarks  
 The `CMFCCmdUsageCount` class maps each numeric Windows message identifier to a 32-bit unsigned integer counter. `CMFCToolBar` uses this class to display frequently-used toolbar items. For more information about `CMFCToolBar`, see [CMFCToolBar Class](../Topic/CMFCToolBar%20Class.md).  
...
-   The toolbar framework is in customization mode (the [CMFCToolBar::IsCustomizeMode](../Topic/CMFCToolBar%20Class.md#cmfctoolbar__iscustomizemode) method returns a nonzero value).  
...
### Remarks  
 ...
 [CMFCToolBar::IsCommandRarelyUsed](../Topic/CMFCToolBar%20Class.md#cmfctoolbar__iscommandrarelyused) uses this method to determine whether a command is rarely used.  
