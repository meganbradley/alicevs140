...
-   At entry to **single**  
 ...
 Note that because the **flush** directive does not have a C language statement as part of its syntax, there are some restrictions on its placement within a program. See [Appendix C](../vs140/C.-OpenMP-C-and-C---Grammar.md) for the formal grammar. The example below illustrates these restrictions.  
