...
## Remarks  
 The references to Primary, Secondary, and All above indicate how the information is returned by the `GetIndexInfo` member function in classes [CDaoTableDef](../vs140/CDaoTableDef--GetIndexInfo.md) and [CDaoRecordset](../vs140/CDaoRecordset--GetIndexInfo.md).  
