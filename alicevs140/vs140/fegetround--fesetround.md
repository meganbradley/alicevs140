...
-   The results of floating-point arithmetic operators in constant expressions, which always round to the nearest value.  
 ...
 To use these functions, you must turn off floating-point optimizations that could prevent access by using the `#pragma fenv_access(on)` directive prior to the call. For more information, see [fenv_access](../vs140/fenv_access.md).  
...
## See Also  
 ...
 [nearbyint](../vs140/nearbyint--nearbyintf--nearbyintl.md)   
 [rint](../vs140/rint--rintf--rintl.md)   
 [lrint, llrint](../vs140/lrint--lrintf--lrintl--llrint--llrintf--llrintl.md)