...
|[single_assignment::reserve_message Method](#single_assignment__reserve_message_method)|Reserves a message previously offered by this                                         `single_assignment` messaging block. (Overrides                                         [source_block::reserve_message](../vs140/source_block-Class.md#source_block__reserve_message_method).)|  
