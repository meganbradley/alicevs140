...
### Profile-Guided Optimization  
 ...
 For more information, see [/GL (Whole Program Optimization)](../Topic/-GL%20\(Whole%20Program%20Optimization\).md) and [/O1, /O2 (Minimize Size, Maximize Speed)](../Topic/-O1,%20-O2%20\(Minimize%20Size,%20Maximize%20Speed\).md).  
...
### Which Level of Optimization Should I Use?  
 ...
 For linking in 64-bit environments, it is recommended to use the **/OPT:REF,ICF** linker option, and in 32-bit environments, **/OPT:REF** is recommended. For more information, see [/OPT (Optimizations)](../Topic/-OPT%20\(Optimizations\).md).  
