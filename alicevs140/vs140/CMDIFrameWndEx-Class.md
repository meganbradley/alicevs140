...
|[CMDIFrameWndEx::OnDrawMenuLogo](#cmdiframewndex__ondrawmenulogo)|Called by the framework when a [CMFCPopupMenu](../vs140/CMFCPopupMenu-Class.md)processes a `WM_PAINT` message.|  
