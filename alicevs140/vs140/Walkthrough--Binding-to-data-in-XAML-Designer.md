...
4.  In the **Select Object** dialog box, make sure that **Show all assemblies** checkbox is cleared, choose **ShoppingCart** under the **BindingTest** namespace, and then choose the **OK** button.  
     ...
     ![The Select Object dialog box](../vs140/media/BlendSelectObject.PNG "BlendSelectObject")  
...
7.  In the Create Data Binding dialog box, in the **Path** box, choose the **ItemCount : (int32)** property and then choose the **OK** button.  
     ...
     ![Create Data Binding dialog box](../vs140/media/xaml_create_data_binding.png "xaml_create_data_binding")  
...
## See Also  
 [Creating a UI with XAML Designer](../vs140/Creating-a-UI-by-using-XAML-Designer-in-Visual-Studio.md)   
 [NIB: Add Value Converter dialog box](assetId:///c5f3d110-a541-4b55-8bca-928f77778af8)