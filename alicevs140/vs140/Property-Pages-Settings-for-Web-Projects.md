...
|**ASP.NET debugging**|Enables debugging of server pages written for the [!INCLUDE[vstecasp](../vs140/includes/vstecasp_md.md)] development platform. You must specify a URL in **Start URL**.|  
