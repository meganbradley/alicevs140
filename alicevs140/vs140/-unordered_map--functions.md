...
### Remarks  
 The template function executes `left.`[swap](../vs140/unordered_map-Class.md#unordered_map__swap)`(right)`.  
...
### Remarks  
 The template function executes `left.`[swap](../vs140/unordered_multimap-Class.md#unordered_multimap__swap)`(right)`.  
