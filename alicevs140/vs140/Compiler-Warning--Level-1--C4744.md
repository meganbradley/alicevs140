...
'var' has different type in 'file1' and 'file2': 'type1' and 'type2'  
 ...
 C4744 is emitted only when files are compiled with /GL.  For more information, see [/GL (Whole Program Optimization)](../Topic/-GL%20\(Whole%20Program%20Optimization\).md).  
