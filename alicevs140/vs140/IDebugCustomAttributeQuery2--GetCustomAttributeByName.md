...
## Remarks  
 ...
 If the `ppBlob` and `pdwLen` parameters are set to a null value, this method can be used to determine if the custom attribute merely exists. An easier alternative, however, is to call the [IDebugCustomAttributeQuery2::IsCustomAttributeDefined](../vs140/IDebugCustomAttributeQuery2--IsCustomAttributeDefined.md) method.  
