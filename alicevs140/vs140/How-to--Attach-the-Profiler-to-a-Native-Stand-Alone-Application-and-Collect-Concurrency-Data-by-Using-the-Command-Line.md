...
This topic describes how to use [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)] Profiling Tools command-line tools to attach the profiler to a running native (C/C++) stand-alone application and collect thread contention data.  
...
1.  At a command prompt, type the following command:  
     ...
     [VSPerfCmd](../vs140/VSPerfCmd.md) **/start:concurrency**  
...
2.  Attach the profiler to the target application by typing the following command:  
     ...
     **VSPerfCmd**  [/attach](../vs140/Attach.md) **:**{`PID`&#124;`ProcName`}  
