...
> [!NOTE]
>  For apps written in JavaScript and HTML see [Start a debugging session for Store Apps in Visual Studio (JavaScript)](../vs140/Start-a-debugging-session-for-Store-Apps-in-Visual-Studio--JavaScript-.md).  
...
2.  Do this to open the debug property page for the project :  
    ...
    -   For Visual C# and Visual Basic apps, choose **Debug**.  
         ...
         ![C&#35; &#47; VB project debug property page](../vs140/media/DBG_CsVb_DebugPropertyPage.png "DBG_CsVb_DebugPropertyPage")  
  
    -   For Visual C++ apps, expand the **Configuration Properties**  node and then choose **Debugging**.  
  
         ![C&#43;&#43; Windows Store app debugging property page](../vs140/media/DBG_CPP_DebugPropertyPage.png "DBG_CPP_DebugPropertyPage")  
...
###  <a name="BKMK_Attach_the_debugger_to_a_running_app_"></a> Attach the debugger to a running app  
 ...
 Attaching the debugger to an app is useful when you need to debug an already-installed app, such as an app that was installed from the [!INCLUDE[win8_appstore_long](../vs140/includes/win8_appstore_long_md.md)]. Attaching is required when you have the source files for the app, but you do not have a Visual Studio project for the app. For example, you might have a custom build system that does not use Visual Studio projects or solutions.  
...
## See Also  
 ...
 [Quick Start: Debugger navigation (Xaml and C#)](../vs140/Navigate-a-debugging-session-in-Visual-Studio--Xaml-and-C#-.md)