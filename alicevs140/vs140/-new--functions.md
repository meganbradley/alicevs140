...
### Remarks  
 The function stores `_Pnew` in a static [new handler](../vs140/-new--typedefs.md#new_handler) pointer that it maintains, then returns the value previously stored in the pointer. The new handler is used by [operator new](../vs140/-new--operators.md#operator_new)( **size_t**).  
