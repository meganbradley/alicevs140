...
###  <a name="_core_modifications_to_your_control_project"></a> Modifications to Your Control Project  
 ...
 To draw the picture properly, make a call to [CPictureHolder::Render](../vs140/CPictureHolder--Render.md) in the control `OnDraw` function. Modify your function to resemble the following example:  
