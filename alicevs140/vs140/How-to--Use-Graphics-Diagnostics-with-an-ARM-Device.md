...
## See Also  
 [Run Windows Store apps on a remote machine from Visual Studio](../vs140/Run-Windows-Store-apps-on-a-remote-machine.md)   
 [How to: Change the Graphics Diagnostics Playback Machine](../vs140/How-to--Change-the-Graphics-Diagnostics-Playback-Machine.md)