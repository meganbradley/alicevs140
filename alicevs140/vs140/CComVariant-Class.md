...
|Name|Description|  
|----------|-----------------|  
|[CComVariant::Attach](../vs140/CComVariant--Attach.md)|Attaches a **VARIANT** to the `CComVariant` object.|  
|[CComVariant::ChangeType](../vs140/CComVariant--ChangeType.md)|Converts the `CComVariant` object to a new type.|  
|[CComVariant::Clear](../vs140/CComVariant--Clear.md)|Clears the `CComVariant` object.|  
|[CComVariant::Copy](../vs140/CComVariant--Copy.md)|Copies a **VARIANT** to the `CComVariant` object.|  
|[CComVariant::CopyTo](../vs140/CComVariant--CopyTo.md)|Copies the contents of the `CComVariant` object.|  
|[CComVariant::Detach](../vs140/CComVariant--Detach.md)|Detaches the underlying **VARIANT** from the `CComVariant` object.|  
|[CComVariant::GetSize](../vs140/CComVariant--GetSize.md)|Returns the size in number of bytes of the contents of the `CComVariant` object.|  
|[CComVariant::ReadFromStream](../vs140/CComVariant--ReadFromStream.md)|Loads a **VARIANT** from a stream.|  
|[CComVariant::SetByRef](../vs140/CComVariant--SetByRef.md)|Initializes the `CComVariant` object and sets the **vt** member to **VT_BYREF**.|  
...
|||  
|-|-|  
|[CComVariant::operator <](../vs140/CComVariant--operator--.md)|Indicates whether the `CComVariant` object is less than the specified **VARIANT**.|  
|[CComVariant::operator >](../vs140/CComVariant--operator--.md)|Indicates whether the `CComVariant` object is greater than the specified **VARIANT**.|  
|[operator !=](../vs140/CComVariant--operator-!=.md)|Indicates whether the `CComVariant` object does not equal the specified **VARIANT**.|  
|[operator =](../vs140/CComVariant--operator-=.md)|Assigns a value to the `CComVariant` object.|  
|[operator ==](../vs140/CComVariant--operator-==.md)|Indicates whether the `CComVariant` object equals the specified **VARIANT**.|  
