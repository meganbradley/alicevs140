...
#### Parameters  
 `pCallback`  
 [in] An [IDebugEventCallback2](../Topic/IDebugEventCallback2.md) object that represents the callback function that the attached debug engine sends events to.  
  
 `dwReason`  
 [in] A value from the [ATTACH_REASON](../vs140/ATTACH_REASON.md) enumeration that describes the reason for the attach operation.  
