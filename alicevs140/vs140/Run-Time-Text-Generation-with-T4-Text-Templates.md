...
```  
 ...
 Notice that statements are inserted between `<# ... #>` and expressions are inserted between `<#= ... #>`. For more information, see [Writing a Text Template](../vs140/Writing-a-T4-Text-Template.md).  
