...
The [abstract](../vs140/abstract--C#-Reference-.md) keyword enables you to create classes and [class](../vs140/class--C#-Reference-.md) members that are incomplete and must be implemented in a derived class.  
  
 The [sealed](../vs140/sealed--C#-Reference-.md) keyword enables you to prevent the inheritance of a class or certain class members that were previously marked [virtual](../vs140/virtual--C#-Reference-.md).  
...
## Sealed Classes and Class Members  
 Classes can be declared as [sealed](../vs140/sealed--C#-Reference-.md) by putting the keyword `sealed` before the class definition. For example:  
 ...
 A method, indexer, property, or event, on a derived class that is overriding a virtual member of the base class can declare that member as sealed. This negates the virtual aspect of the member for any further derived class. This is accomplished by putting the `sealed` keyword before the [override](../vs140/override--C#-Reference-.md) keyword in the class member declaration. For example:  
...
## See Also  
 ...
 [Class Methods (Visual C#)](../Topic/Methods%20\(C%23%20Programming%20Guide\).md)   
 [Properties and Fields (Visual C#)](../vs140/Fields--C#-Programming-Guide-.md)   
 [How to: Define Abstract Properties (C#)](../vs140/How-to--Define-Abstract-Properties--C#-Programming-Guide-.md)