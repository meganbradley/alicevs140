...
1.  Open a new text file in Notepad.Copy the XML Schema sample code from [Purchase Order Schema](../vs140/Sample-XSD-File--Simple-Schema.md) and paste it in to the file.  
