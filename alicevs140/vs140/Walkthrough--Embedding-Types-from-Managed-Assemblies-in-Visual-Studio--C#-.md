...
-   The <xref:System.Collections.Generic.Dictionary`2?qualifyHint=True> class does not support an embedded type as a key. You can implement your own dictionary type to support an embedded type as a key.  
