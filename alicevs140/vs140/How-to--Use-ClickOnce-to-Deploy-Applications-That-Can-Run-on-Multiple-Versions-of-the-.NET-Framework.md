...
3.  Update the version number of the `<assemblyIdentity>` element for Microsoft.Windows.CommonLanguageRuntime to the version number for the .NET Framework that is the lowest common denominator. For example, if the application targets .NET Framework 3.5 and [!INCLUDE[net_v40_short](../vs140/includes/net_v40_short_md.md)], use the 2.0.50727.0 version number and the XML should look like the following:  
...
-   Update and re-sign the application and deployment manifests. For more information, see [How to: Re-sign Application and Deployment Manifests](../vs140/How-to--Re-sign-Application-and-Deployment-Manifests.md).  
  
## See Also  
 [Publishing ClickOnce Applications](../vs140/Publishing-ClickOnce-Applications.md)   
 [<compatibleFrameworks\> Element](../vs140/-compatibleFrameworks--Element--ClickOnce-Deployment-.md)   
 [<dependency\> Element](../vs140/-dependency--Element--ClickOnce-Application-.md)   
 [ClickOnce Deployment Manifest](../vs140/ClickOnce-Deployment-Manifest.md)   
 [Application Configuration Files](assetId:///69003d39-dc8a-460c-a6be-e6d93e690b38)