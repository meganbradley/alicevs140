...
---
# Shader Designer
This document describes how to work with the [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)] Shader Designer to create, modify, and export custom visual effects that are known as *shaders*.  
...
## Getting Started  
 This section describes how to add a DGSL shader to your [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)] project and provides basic information to help you get started.  
...
### Shader Designer toolbars  
 ...
 Commands that affect the state of the Shader Designer are located on the **Shader Designer Mode** toolbar in the main [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)] window. Design tools and commands are located on the **Shader Designer** toolbar on the Shader Designer design surface.  
  
 Here's the **Shader Designer Mode** toolbar:  
  
 ![The Shader Designer modal toolbar.](../vs140/media/Digit-DSD-Modal-Toolbar.png "Digit-DSD-Modal-Toolbar")  
...
### Exporting shaders  
 ...
 For more information about how to export shaders, see [How to: Export a Shader](../vs140/How-to--Export-a-Shader.md).  
...
|Title|Description|  
|-----------|-----------------|  
|[Working with 3-D Assets for Games and Apps](../vs140/Working-with-3-D-Assets-for-Games-and-Apps.md)|Provides an overview of the [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)] tools that you can use to work with textures and images, 3-D models, and shader effects.|  
