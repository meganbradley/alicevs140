...
-   Add bookmark support.  
 ...
 The `IRowsetLocate` interface inherits from the `IRowset` interface. To add the `IRowsetLocate` interface, inherit `CMyProviderRowset` from [IRowsetLocateImpl](../vs140/IRowsetLocateImpl-Class.md).  
