...
Custom project systems must use <xref:Microsoft.VisualStudio.Shell.Interop.IVsBuildManagerAccessor?qualifyHint=False> to start builds. This topic describes the reasons for this and outlines the procedure.  
