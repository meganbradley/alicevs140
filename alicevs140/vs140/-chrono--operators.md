...
### Return Value  
 ...
 Unless `is_convertible<Rep2, common_type<Rep1, Rep2>>`*holds true*, the first function does not participate in overload resolution. For more information, sssee [<type_traits>](../vs140/-type_traits-.md).  
  
 Unless `is_convertible<Rep1, common_type<Rep1, Rep2>>`*holds true*, the second function does not participate in overload resolution. For more information, see [<type_traits>](../vs140/-type_traits-.md).  
...
##  <a name="operator_lt__eq"></a>  operator&lt;=  
 Determines whether one [duration](../vs140/duration-Class.md) or [time_point](../vs140/time_point-Class.md) object is less than or equal to another `duration` or `time_point` object.  
...
##  <a name="operator_gt_"></a>  operator&gt;  
 Determines whether one [duration](../vs140/duration-Class.md) or [time_point](../vs140/time_point-Class.md) object is greater than another `duration` or `time_point` object.  
