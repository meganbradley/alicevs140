...
|CommandFlag|Required. See [CommandFlag Element](../vs140/Command-Flag-Element.md). The valid CommandFlag values for a Button are as follows.<br /><br /> - CaseSensitive<br /><br /> - CommandWellOnly<br /><br /> - DefaultDisabled<br /><br /> - DefaultInvisible<br /><br /> - DynamicVisibility<br /><br /> - FilterKeys<br /><br /> - IconAndText<br /><br /> - NoAutoComplete<br /><br /> - NoButtonCustomize<br /><br /> - NoCustomize<br /><br /> - NoKeyCustomize<br /><br /> - StretchHorizontally|  
|Strings|Required. See [Strings Element](../vs140/Strings-Element.md). The child ButtonText element must be defined.|  
