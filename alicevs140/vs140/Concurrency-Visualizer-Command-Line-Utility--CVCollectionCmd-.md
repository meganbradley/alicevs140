...
> [!NOTE]
>  When you use Visual Studio to collect traces, don't directly modify the configuration file.  Instead, use the [Advanced Settings](../Topic/Advanced%20Settings%20Dialog%20Box%20\(Concurrency%20Visualizer\).md) dialog box to modify settings.  
