...
This error message means that Visual Studio could not find the correct instance of the Visual Studio Remote Debugging Monitor on the remote computer. The Visual Studio Remote Debugging Monitor must be installed for remote debugging to work. For information about downloading and setting up the remote debugger, see [Set Up the Remote Tools on the Device](../vs140/Set-Up-the-Remote-Tools-on-the-Device.md).  
  
> [!IMPORTANT]
>  If you believe you have received this message because of a product bug, please report this issue to Visual Studio [Send a Smile](../vs140/Visual-Studio-Send-a-Smile-Instructions.md). If you need more help, see [Talk to Us](../vs140/Talk-to-Us.md) for ways to contact Microsoft.  
