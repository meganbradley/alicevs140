...
2.  Do the equivalent of "delete old" followed by "add new". The following algorithm is one way to accomplish this.  
    ...
    1.  Call the [SccQueryChanges Function](../vs140/SccQueryChanges-Function.md) function to learn about the renaming of a.txt to b.txt in the source control database.  
