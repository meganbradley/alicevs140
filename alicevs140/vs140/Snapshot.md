...
> [!NOTE]
>  This topic applies to the MFC ODBC classes. If you are using the MFC DAO classes instead of the MFC ODBC classes, see [CDaoRecordset::Open](../vs140/CDaoRecordset--Open.md) for a description of snapshot-type recordsets.  
...
>  If you want to use both snapshots and dynasets, you must base them on two different `CDatabase` objects (two different connections).  
 ...
 For more information about the properties snapshots share with all recordsets, see [Recordset (ODBC)](../vs140/Recordset--ODBC-.md). For more information about ODBC and snapshots*,* including the ODBC Cursor Library, see [ODBC](../vs140/ODBC-Basics.md).  
