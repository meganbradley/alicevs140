...
---
# JScript File
The [Custom Wizard](../vs140/Custom-Wizard.md) accesses the script engine and creates a JScript file called Default.js for each project. It also includes [Common.js](../vs140/Customizing-C---Wizards-with-Common-JScript-Functions.md). These files contain JScript functions that give you access to the Visual Studio and Visual C++ object models to customize a wizard. (See [Designing a Wizard](../Topic/Designing%20a%20Wizard.md) for a list of these models.) You can add your own functions to the wizard project's Default.js file. To access properties and methods in the wizard object model or the environment model from a JScript file, prepend the object model item with "wizard." and "dte.", respectively.  
...
```  
 ...
 When you click **Finish** in the [Custom Wizard](../vs140/Custom-Wizard.md), the wizard loads the file Default.js in the Script Files folder in Solution Explorer. This JScript file creates projects and renders templates and then adds them to the solution when a user clicks **Finish** in your wizard.  
...
|**CreateCustomInfFile**|Creates the project's [Templates.inf file](../vs140/Templates.inf-File.md).|  
...
|**PchSettings**|Sets the precompiled header settings. See [SetCommonPchSettings](../vs140/SetCommonPchSettings.md) in the Common.js reference for more information.|  
 ...
 Visual C++ also includes [Common.js](../vs140/Customizing-C---Wizards-with-Common-JScript-Functions.md), a file shared among all wizards and included in your wizard project. You can use the functions in Common.js.  
  
> [!NOTE]
>  Common.js contains descriptions of each function and its parameters. See the comments in Common.js for more information.  
  
 If you have functions that you want to share between your wizard projects, you can add them to Common.js. Create your own version of Common.js and save it in a common path, and then set the SCRIPT_COMMON_PATH to this path in your [.vsz file](../Topic/.Vsz%20File%20\(Project%20Control\).md).  
