...
|---------------------|-----------------|  
|[range_adapter](../vs140/range_adapter--range_adapter--STL-CLR-.md)|Constructs an adapter object.|  
  
|Operator|Description|  
|--------------|-----------------|  
|[operator=](../vs140/range_adapter--operator=--STL-CLR-.md)|Replaces the stored iterator pair.|  
