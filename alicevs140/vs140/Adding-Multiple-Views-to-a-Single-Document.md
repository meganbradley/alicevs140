...
> [!TIP]
>  For additional procedures on implementing multiple views for a single document, see [CDocument::AddView](../vs140/CDocument--AddView.md) and the [COLLECT](../vs140/Visual-C---Samples.md) MFC sample.  
...
##  <a name="vcconswitchingtheviewa5"></a> Add Support for Switching the View  
 ...
 For more information on adding new menu items and command handler functions, see [Handlers for Commands and Control Notifications](../vs140/Handlers-for-Commands-and-Control-Notifications.md).  
