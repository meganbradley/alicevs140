...
The [!INCLUDE[vcprvc](../vs140/includes/vcprvc_md.md)] programming language and development tools help you develop native Universal Windows apps, native desktop and server applications, cross-platform libraries that run on Android and iOS as well as Windows, and managed apps that run on the .NET Framework.  
...
## General Information about Visual C++  
 [What's New for Visual C++ in Visual Studio](../vs140/What-s-New-for-Visual-C---in-Visual-Studio-2015.md)  
 ...
 [How to Report a Problem with the Visual C++ Toolset](../vs140/How-to-Report-a-Problem-with-the-Visual-C---Toolset.md)  
 ...
 Guidance for porting code and upgrading projects to Visual C++ in [!INCLUDE[vs_dev14](../vs140/includes/vs_dev14_md.md)], including porting C++ code to Windows 10 and the Universal Windows Platform.  
  
 [Support For C++11 Features (Modern C++)](../vs140/Support-For-C--11-14-17-Features--Modern-C---.md)  
 Learn about support for C++11 and C++14 features in Visual C++.  
  
 [Visual C++ Team Blog](http://blogs.msdn.com/b/vcblog/)  
 Learn more about new features and the latest information from the developers of [!INCLUDE[vcprvc](../vs140/includes/vcprvc_md.md)].  
  
 [Visual Studio Downloads](http://go.microsoft.com/fwlink/?LinkId=235233)  
 Download Visual C++.  
  
 [Visual C++ Editions](../vs140/Visual-C---Tools-and-Templates-in-Visual-Studio-Editions.md)  
 Find out about different Visual Studio editions.  
  
 [Supported Platforms (Visual C++)](../vs140/Supported-Platforms--Visual-C---.md)  
...
## Writing Applications in C++  
 [Windows Store Apps](../vs140/Universal-Windows-Apps--C---.md)  
 ...
 [Win32 Desktop Applications](../vs140/Desktop-Applications--Visual-C---.md)  
 ...
 [Parallel Programming in Visual C++](../vs140/Parallel-Programming-in-Visual-C--.md)  
 ...
 [Cloud and Web Programming](../vs140/Cloud-and-Web-Programming-in-Visual-C--.md)  
...
## C++ Development Tools  
 To find out about how to create projects, work with source code files, link to libraries, compile, debug, profile, deploy, and more, see [Visual C++ Development Tools](../vs140/IDE-and-Tools-for-Visual-C---Development.md).  
  
## C++ Language Reference  
 For information about the C++ language, see [C++ Language Reference](../vs140/C---Language-Reference.md).  
  
 For information about the C++ preprocessor, see [C/C++ Preprocessor Reference](../vs140/C-C---Preprocessor-Reference.md).  
...
## C++ Libraries in Visual Studio  
 ...
 [C Runtime Library (CRT)](../vs140/C-Run-Time-Library-Reference.md)  
 ...
 [Active Template Library (ATL)](../vs140/ATL-COM-Desktop-Components.md)  
 Support for  COM components and apps.  
  
 [Microsoft Foundation Class (MFC) libraries](../vs140/MFC-Desktop-Applications.md)  
 ...
 [!INCLUDE[win8_appname_long](../vs140/includes/win8_appname_long_md.md)] apps and components.  
  
 [.NET Programming in Visual C++](../vs140/.NET-Programming-with-C---CLI--Visual-C---.md)  
 Programming for the common language runtime (CLR).  
  
 See also the documentation for [STL/CLR](../vs140/STL-CLR-Library-Reference.md) and the [C++ Support Library](../vs140/C---Support-Library.md).  
