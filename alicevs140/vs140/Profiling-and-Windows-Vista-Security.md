...
-   Some users may deny access to profiling to all other users.  
 ...
 For more information, see the ADMIN options in [VSPerfCmd](../vs140/VSPerfCmd.md).  
