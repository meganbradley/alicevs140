...
-   the base class property is not declared as [virtual](../vs140/virtual--C#-Reference-.md).  
  
-   the base class property does not declare the [get](../vs140/get--C#-Reference-.md) or [set](../vs140/set--C#-Reference-.md) accessor you are trying to override.  
  
 If you do not want to override the base class property, you can use the [new](../vs140/new--C#-Reference-.md) keyword before the property in derived class.  
