...
## Remarks  
 ...
 In the preceding syntax, the `type-name` is any valid identifier. The `type-params` describes optional generic type parameters. It consists of type parameter names and constraints enclosed in angle brackets (< and >). For more information, see [Generics](../vs140/Generics--F#-.md) and [Constraints](../vs140/Constraints--F#-.md). The `parameter-list` describes constructor parameters. The first access modifier pertains to the type; the second pertains to the primary constructor. In both cases, the default is `public`.  
 ...
 The `member-list` consists of additional constructors, instance and static method declarations, interface declarations, abstract bindings, and property and event declarations. These are described in [Members (F#)](../vs140/Members--F#-.md).  
...
## Constructors  
 ...
 [!CODE [FsLangRef1#2401](../CodeSnippet/VS_Snippets_Fsharp/fslangref1#2401)]  
...
## Generic Type Parameters  
 ...
 [!CODE [FsLangRef1#2403](../CodeSnippet/VS_Snippets_Fsharp/fslangref1#2403)]  
  
 Type arguments are inferred when the type is used. In the following code, the inferred type is a sequence of tuples.  
  
 [!CODE [FsLangRef1#24031](../CodeSnippet/VS_Snippets_Fsharp/fslangref1#24031)]  
  
## Specifying Inheritance  
 The `inherit` clause identifies the direct base class, if there is one. In F#, only one direct base class is allowed. Interfaces that a class implements are not considered base classes. Interfaces are discussed in the [Interfaces (F#)](../vs140/Interfaces--F#-.md) topic.  
...
## Mutually Recursive Types  
 ...
 [!CODE [FsLangRef1#2404](../CodeSnippet/VS_Snippets_Fsharp/fslangref1#2404)]  
