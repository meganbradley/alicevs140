...
The Graphics Pipeline Stages window helps you understand how an individual draw call is transformed by each stage of the Direct3D graphics pipeline.  
 ...
 ![A 3&#45;D object goes through the pipeline stages.](../vs140/media/gfx_diag_demo_pipeline_stages_orientation.png "gfx_diag_demo_pipeline_stages_orientation")  
...
### Vertex shader preview  
 ...
 ![The vertex shader stage input buffer viewer](../vs140/media/gfx_diag_vertex_shader_inbuffers.png "gfx_diag_vertex_shader_inbuffers")  
 ...
 ![The vertex shader stage result preview](../vs140/media/gfx_diag_vertex_shader_preview.png "gfx_diag_vertex_shader_preview")  
