...
-   Save files locally, and then publish to a server or use another approach to saving project items when the item represents a data connection to a remote object.  
 ...
 For more information about persistence, see [Project Persistence](../Topic/Project%20Persistence.md) and [Opening and Saving Project Items](../vs140/Opening-and-Saving-Project-Items.md).  
