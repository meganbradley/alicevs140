...
## Remarks  
 You can place a **pointers_to_members** pragma in your source file as an alternative to using the [/vmx](../vs140/-vmb---vmg--Representation-Method-.md) compiler options or the [inheritance keywords](../vs140/Inheritance-Keywords.md).  
