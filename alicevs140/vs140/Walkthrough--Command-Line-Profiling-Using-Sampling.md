...
-   [!INCLUDE[vsPreLong](../vs140/includes/vsPreLong_md.md)], [!INCLUDE[vsUltLong](../vs140/includes/vsUltLong_md.md)], or [!INCLUDE[vsPro](../vs140/includes/vsPro_md.md)]  
  
-   Intermediate understanding of [!INCLUDE[csharp_current_short](../vs140/includes/csharp_current_short_md.md)]  
...
> [!NOTE]
>  Command-line tools of the Profiling Tools are located in the \Team Tools\Performance Tools subdirectory of the Visual Studio installation directory. On 64 bit computers, both 64 bit and 32 bit versions of the tools are available. To use the profiler command-line tools, you must add the path to the PATH environment variable of the command prompt window or add it to the command itself. For more information, see [Specifying the Path to Profiling Tools Command Line Tools](../vs140/Specifying-the-Path-to-Profiling-Tools-Command-Line-Tools.md). PeopleTrax is a 32-bit application.  
...
11. Profiling data is stored in the.vsp file Analyze the results by using one of the following methods:  
    ...
    -   Generate a comma-separated value (.csv) file by using the command-line tool VSPerfReport.exe. To generate reports for use outside the [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)] IDE use the following command:  
