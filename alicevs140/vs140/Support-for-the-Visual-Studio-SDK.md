...
### Codeplex  
 [CodePlex](http://go.microsoft.com/fwlink/?LinkId=76627) is the Microsoft open source project-hosting Web site. You can use CodePlex to create and share new projects, contribute to existing projects, or use the applications on the site and provide feedback. All PowerToys (and their documentation) that were included with earlier versions of the [!INCLUDE[vsipsdk](../vs140/includes/vsipsdk_md.md)] are now available on CodePlex.  
  
## Included Support  
  
### Visual Studio Product Support  
 Some support is included with the purchase of [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)] products. For more information, see [Visual Studio Support](http://msdn.microsoft.com/vstudio/cc136615.aspx). Microsoft maintains a dedicated support team to answer questions about [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)] extensibility.  
