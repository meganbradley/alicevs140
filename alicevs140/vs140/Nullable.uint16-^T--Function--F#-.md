...
Converts the argument to unsigned 16-bit integer ([uint16](../vs140/Core.uint16-Type-Abbreviation--F#-.md)). This is a direct conversion for all primitive numeric types. The operation requires an appropriate static conversion method on the input type.  
...
## See Also  
 ...
 [Operators.uint16<^T> Function (F#)](../vs140/Operators.uint16-^T--Function--F#-.md)