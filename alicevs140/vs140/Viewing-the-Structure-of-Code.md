...
You can examine the objects and members in Visual Studio projects, and the objects and members in .NET Framework components, COM components, dynamic-link libraries (DLL), and type libraries (TLB).  
 ...
 If you have Visual Studio Enterprise you can use code maps to visualize the structure of your code and its dependencies across the entire solution, and drill down to parts of the code that interest you. For more information, see [HYPERLINK "https://msdn.microsoft.com/en-us/library/dd409453(v=vs.140).aspx" Map dependencies across your solutions](../vs140/Map-dependencies-across-your-solutions.md).  
