...
### Remarks  
 The template function executes `left.`[swap](../vs140/unordered_set-Class.md#unordered_set__swap)`(right)`.  
...
### Remarks  
 The template function executes `left.`[swap](../vs140/unordered_multiset-Class.md#unordered_multiset__swap)`(right)`.  
