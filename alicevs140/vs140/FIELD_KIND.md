...
## Remarks  
 ...
 Depending on the kind of field, [QueryInterface](../vs140/QueryInterface.md) can be called on the [IDebugField](../vs140/IDebugField.md) interface for a more specific form of interface. For example, if [GetKind](../vs140/IDebugField--GetKind.md) returns `FIELD_TYPE_METHOD`, you can then call `QueryInterface` on I`DebugField` to obtain the [IDebugMethodField](../vs140/IDebugMethodField.md) interface.  
