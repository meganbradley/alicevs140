...
---
# fopen, _wfopen
Opens a file. More-secure versions of these functions that perform additional parameter validation and return error codes are available; see [fopen_s, _wfopen_s](../Topic/fopen_s,%20_wfopen_s.md).  
...
|`_tfopen`|`fopen`|`fopen`|`_wfopen`|  
 ...
 Valid characters for the `mode` string that is used in `fopen` and `_fdopen` correspond to `oflag` arguments that are used in [_open](../Topic/_open,%20_wopen.md) and [_sopen](../vs140/_sopen--_wsopen.md), as follows.  
