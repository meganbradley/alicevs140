...
### Command Line  
 Using the [VSPerfCmd](../vs140/VSPerfCmd.md) command line tool, you can list the CPU counters that are available on a computer from the command line.  
...
## See Also  
 ...
 [How to: Collect CPU Counter Data](../vs140/How-to--Collect-CPU-Counter-Data.md)   
