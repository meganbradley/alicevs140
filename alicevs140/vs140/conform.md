...
**C++ Specific**  
 ...
 Specifies the run-time behavior of the [/Zc:forScope](../Topic/-Zc:forScope%20\(Force%20Conformance%20in%20for%20Loop%20Scope\).md) compiler option.  
 ...
 **on, off**(optional)  
 Setting *name* to **on** enables the [/Zc:forScope](../Topic/-Zc:forScope%20\(Force%20Conformance%20in%20for%20Loop%20Scope\).md) compiler option. The default is **off**.  
