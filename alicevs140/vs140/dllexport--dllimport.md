...
## Remarks  
 ...
 When you declare `dllexport` or **dllimport**, you must use [extended attribute syntax](../vs140/__declspec.md) and the `__declspec` keyword.  
