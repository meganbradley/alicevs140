...
Use the **Windows** tab to set the scope of the messages listed in [Messages View](../vs140/Messages-View.md). To display the [Message Options Dialog Box](../vs140/Message-Options-Dialog-Box.md), choose **Log Messages** from the **Spy** menu.  
