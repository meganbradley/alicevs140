...
-   Use [concurrency::task_continuation_context::use_current](../vs140/task_continuation_context--use_current-Method.md) to specify that the continuation runs on the thread that called `task::then`.  
