...
The code in this topic is the sample file for the [Quick Start: Debugger navigation (JavaScript)](../vs140/Control-execution-of-a-Store-app-in-a-Visual-Studio-debug-session-for-Windows-Store-apps--JavaScript-.md) topic.  
