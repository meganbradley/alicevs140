...
You can use the graph-based Shader Designer in [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)] to design custom shader effects. You can use these shaders in your DirectX-based game or app.  
...
|[Shader Designer Nodes](../vs140/Shader-Designer-Nodes.md)|Discusses the kinds of Shader Designer nodes that you can use to achieve graphics effects.|  
|[Shader Designer Examples](../vs140/Shader-Designer-Examples.md)|Provides links to topics that demonstrate how to use the Shader Designer to achieve common graphics effects.|