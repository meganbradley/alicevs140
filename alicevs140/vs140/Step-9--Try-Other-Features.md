...
-   To return to the previous tutorial step, see [Step 8: Add a Method to Verify Whether the Player Won](../vs140/Step-8--Add-a-Method-to-Verify-Whether-the-Player-Won.md).