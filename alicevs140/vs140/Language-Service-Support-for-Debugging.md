...
A language service can provide features that support a debugger through the <xref:Microsoft.VisualStudio.TextManager.Interop.IVsLanguageDebugInfo?qualifyHint=False> interface. These features include validating breakpoints and supplying a list of expressions to the **Autos** window.  
...
## Compiler Output  
 ...
 For more information on implementing debugging for your language, see [Getting Started](../vs140/Getting-Started-with-Debugger-Extensibility.md) in the Visual Studio Debugging SDK.