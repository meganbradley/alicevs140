...
This topic describes how to explore your nodes using the [Contnet Model View](../vs140/Content-Model-View.md).  
...
3.  Copy the XML Schema sample code from [Sample XML Schema: Purchase Order Schema](../vs140/Sample-XSD-File--Purchase-Order-Schema.md) and paste it to replace the code that was added to the new XSD file by default.  
