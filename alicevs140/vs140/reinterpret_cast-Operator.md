...
## Remarks  
 ...
 The `reinterpret_cast` operator cannot cast away the **const**, `volatile`, or **__unaligned** attributes. See [const_cast Operator](../vs140/const_cast-Operator.md) for information on removing these attributes.  
