...
### Rules  
 ...
 Rules are defined on a per-class basis, so that you do not have to have code that registers the rule for each object. For more information, see [How to create custom rules](../Topic/Rules%20Propagate%20Changes%20Within%20the%20Model.md).  
...
### .NET Events  
 ...
 Some events are generated on ShapeFields, which are used to draw decorators on a shape. For an example, see [How to Intercept a Click on a Decorator](../vs140/How-to--Intercept-a-Click-on-a-Shape-or-Decorator.md).  
