...
## Objects in the Automation Model  
 ...
 ![Visual Studio Automation Object Chart](../vs140/media/vsVisualStudioAutomationObjectChart.gif "vsVisualStudioAutomationObjectChart")  
Visual Studio automation objects  
  
 For more information, see [Extending the Visual Studio Environment](assetId:///4173a963-7ac7-4966-9bb7-e28a9d9f6792).  
  
 The environment provides a model for different functional areas. For instance, there is a code model for various elements that you might find in code. There is a document model for various document elements. One area, the project area, is of particular interest to VSPackage providers. You will likely want your new project types to contribute to the automation model in much the same way as [!INCLUDE[vcprvc](../vs140/includes/vcprvc_md.md)] and [!INCLUDE[vbprvb](../vs140/includes/vbprvb_md.md)] contribute to the automation model. That process is outlined in [Providing Automation for VSPackages](../vs140/Providing-Automation-for-VSPackages.md).  
...
-   Build  
 ...
 For more information on automation, see [Automation and Extensibility for Visual Studio](assetId:///f71a2253-3e68-4e5e-9a18-edbba816caf6). This document and the documents it provides links to, help you make decisions regarding how you should provide automation for your VSPackage.  
