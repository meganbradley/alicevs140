...
---
# XML Editor
The XML Editor is based on the [!INCLUDE[msCoName](../vs140/includes/msCoName_md.md)] Visual Studio Text Editor and includes additional support for the XML languages. The XML Editor includes the following features:  
...
-   Integration with the [XML Schema Explorer](../vs140/XML-Schema-Explorer.md). This provides a hierarchal view of XML Schemas.  
...
## In This Section  
 [XML Document Validation](../vs140/XML-Document-Validation.md)  
 Describes the syntax checking and validation features.  
  
 [XML Editor Intellisense Features](../vs140/XML-Editor-IntelliSense-Features.md)  
 ...
 [Schema Cache](../Topic/Schema%20Cache.md)  
 Lists the schemas that are installed by the XML Editor.  
  
 [XML Editor Components](../vs140/XML-Editor-Components.md)  
