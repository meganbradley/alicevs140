...
## Remarks  
 ...
 initializes the controlled sequence with the sequence `[``right``.`[begin](../vs140/hash_map--begin--STL-CLR-.md)`(),` `right``.`[end](../vs140/hash_map--end--STL-CLR-.md)`())`, with the default ordering predicate, and with the default hash function. You use it to specify an initial controlled sequence that is a copy of the sequence controlled by the hash_map object `right`, with the default ordering predicate and hash function.  
