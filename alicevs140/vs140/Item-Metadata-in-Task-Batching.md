...
-   Filtering item lists  
 ...
 For more information on batching with [!INCLUDE[vstecmsbuild](../vs140/includes/vstecmsbuild_md.md)], see [MSBuild Batching](../Topic/MSBuild%20Batching.md).  
...
```  
 ...
 The [Message](../Topic/Message%20Task.md) task displays the following information:  
