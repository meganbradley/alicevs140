...
-   Validate the user input for both type and content before you build the command string.  
 ...
 The following [!INCLUDE[dnprdnshort](../vs140/includes/dnprdnshort_md.md)] types implement the <xref:System.Data.IDbCommand.CommandText?qualifyHint=False> property or provide constructors that set the property by using a string argument.  
...
## See Also  
 [Secure ADO.NET Coding Guidelines](assetId:///33e09965-61d5-48cc-9e8c-3b047cc4f194)