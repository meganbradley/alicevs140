...
|[Compiler Warning (level 4) C4001](../vs140/Compiler-Warning--level-4--C4001.md)|nonstandard extension 'single line comment' was used|  
|Compiler warning (level 1) C4002|too many actual parameters for macro 'identifier'|  
|[Compiler Warning (level 1) C4003](../vs140/Compiler-Warning--level-1--C4003.md)|not enough actual parameters for macro 'identifier'|  
|[Compiler Warning (level 1) C4005](../vs140/Compiler-Warning--level-1--C4005.md)|'identifier': macro redefinition|  
|Compiler warning (level 1) C4006|#undef expected an identifier|  
|[Compiler Warning (level 3) C4007](../vs140/Compiler-Warning--level-2--C4007.md)|'function': must be 'attribute'|  
|Compiler warning (level 3) C4008|'function': 'atribute' attribute ignored|  
|[Compiler Warning (level 1) C4010](../vs140/Compiler-Warning--level-1--C4010.md)|single-line comment contains line-continuation character|  
|[Compiler Warning (level 3) C4013](../vs140/Compiler-Warning--level-3--C4013.md)|'function' undefined; assuming extern returning int|  
|[Compiler Warning (level 1) C4015](../vs140/Compiler-Warning--level-1--C4015.md)|'identifer': type of bit field must be integral|  
|[Compiler Warning (level 3) C4018](../vs140/Compiler-Warning--level-3--C4018.md)|'expression': signed/unsigned mismatch|  
|Compiler warning (level 4) C4019|empty statement at global scope|  
|[Compiler Warning (level 1) C4020](../vs140/Compiler-Warning--level-1--C4020.md)|'function': too many actual parameters|  
|[Compiler Warning (level 1) C4022](../vs140/Compiler-Warning--level-1--C4022.md)|'function': pointer mismatch for actual parameter 'parameter number'|  
|Compiler warning (level 1) C4023|'function': based pointer passed to unprototyped function: parameter 'parameter_number'|  
|[Compiler Warning (level 1) C4024](../vs140/Compiler-Warning--level-1--C4024.md)|'function': different types for formal and actual parameter 'parameter_number'|  
...
|[Compiler Warning (level 1) C4028](../vs140/Compiler-Warning--level-1--C4028.md)8|formal parameter 'parameter_number' different from declaration|  
|[Compiler Warning (level 1) C4029](../vs140/Compiler-Warning--level-1--C4029.md)|declared formal parameter list different from definition|  
|Compiler warning (level 1) C4030|first formal parameter list longer than the second list|  
|[Compiler Warning (level 1) C4031](../vs140/Compiler-Warning--level-1--C4031.md)|second formal parameter list longer than the first list|  
|[Compiler Warning (level 4) C4032](../vs140/Compiler-Warning--level-4--C4032.md)|formal parameter 'parameter_number' has different type when promoted|  
|Compiler warning (level 1) C4033|'function' must return a value|  
|[Compiler Warning (level 1) C4034](../vs140/Compiler-Warning--level-1--C4034.md)|sizeof returns 0|  
...
|[Compiler Warning (level 1) C4042](../vs140/Compiler-Warning--level-1--C4042.md)|'identifier': has bad storage class|  
|Compiler warning (level 1) C4045|'array': array bounds overflow|  
|[Compiler Warning (level 1) C4047](../vs140/Compiler-Warning--level-1--C4047.md)|'operator': 'identifier1' differs in levels of indirection from 'identifier2'|  
|[Compiler Warning (level 1) C4048](../vs140/Compiler-Warning--level-1--C4048.md)|different array subscripts: 'identifier1' and 'identifier2'|  
...
|[Compiler Warning (level 1) C4096](../vs140/Compiler-Warning--level-1--C4096.md)|'identifier': interface is not a COM interface; will not be emitted to IDL|  
