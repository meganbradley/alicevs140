...
You can specify which DLLs to delay load with the [/delayload](../vs140/-DELAYLOAD--Delay-Load-Import-.md):`dllname` linker option. If you do not plan to use your own version of a helper function, you must also link your program with delayimp.lib (for desktop applications) or dloadhelper.lib (for store apps).  
