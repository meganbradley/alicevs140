...
6.  Add your custom directive processor class to the project.  
     ...
     This is a public class that should implement <xref:Microsoft.VisualStudio.TextTemplating.DirectiveProcessor?qualifyHint=False> or <xref:Microsoft.VisualStudio.TextTemplating.RequiresProvidesDirectiveProcessor?qualifyHint=False>.  
...
## See Also  
 [Creating Custom Directive Processors](../Topic/Creating%20Custom%20T4%20Text%20Template%20Directive%20Processors.md)