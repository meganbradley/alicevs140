...
|Param|These parts are optional. You can add as many as needed.|  
 ...
 The parameters enable the .vsz file to pass additional custom parameters to the wizard. Each value is passed as a string element in an array of variants to the wizard. For more information, see [Custom Parameters](../Topic/Custom%20Parameters.md). For information about how to use a .vsz file in the development of custom wizards, see [.Vsz File (Project Control)](../Topic/.Vsz%20File%20\(Project%20Control\).md)  
