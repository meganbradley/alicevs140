...
In COM event handling, you set up an event source and event receiver using the [event_source](../vs140/event_source.md) and [event_receiver](../vs140/event_receiver.md) attributes, respectively, specifying `type`=**com**. These attributes inject the appropriate code for custom, dispatch, and dual interfaces to allow the classes to which they are applied to fire events and handle events through COM connection points.  
