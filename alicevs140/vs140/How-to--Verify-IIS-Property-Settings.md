...
6.  For an [!INCLUDE[vstecasp](../vs140/includes/vstecasp_md.md)] application, make sure the virtual folder for the application has an Application Name set in **Internet Information Services (IIS) Manager**, **Internet Services Manager** or **Internet Information Services**.  
...
7.  For an [!INCLUDE[vstecasp](../vs140/includes/vstecasp_md.md)] application, click the **ASP.NET** tab and verify that the correct version of [!INCLUDE[vstecasp](../vs140/includes/vstecasp_md.md)] is specified.  
...
## See Also  
 [Debugging Web Applications: Troubleshooting](../vs140/Debugging-Web-Applications--Troubleshooting.md)