...
#### Parameters  
 `dwFields`  
 [in] A combination of flags from the [THREADPROPERTY_FIELDS](../vs140/THREADPROPERTY_FIELDS.md) enumeration that determines which fields of `ptp` are to be filled in.  
