...
## Remarks  
 See [How to: Instantiate WRL Components Directly](../vs140/How-to--Instantiate-WRL-Components-Directly.md) to learn the differences between this function and [Microsoft::WRL::Details::MakeAndInitialize](../vs140/MakeAndInitialize-Function.md), and for an example.  
