...
ms.tgt_pltfrm: na
ms.topic: article
H1: Test Area 1: Add To/Open From Source Control
...
-   For [!INCLUDE[vsvss](../vs140/includes/vsvss_md.md)], open from source control: **File**, **Open**, **Project**/**Solution**; look in the [!INCLUDE[vsvss](../vs140/includes/vsvss_md.md)] location.  
...
-   For [!INCLUDE[vsvss](../vs140/includes/vsvss_md.md)], add from source control is also available from **File**, **Add**, **Existing Project**; look in the [!INCLUDE[vsvss](../vs140/includes/vsvss_md.md)] location.  
