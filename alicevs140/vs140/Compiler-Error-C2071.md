...
'identifier' : illegal storage class  
 ...
 `identifier` was declared with an invalid [storage class](../vs140/C-Storage-Classes.md). This error can be caused when more than one storage class is specified for an identifier, or when the definition is incompatible with the storage class declaration.  
