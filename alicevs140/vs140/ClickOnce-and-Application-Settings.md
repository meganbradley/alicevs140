...
## Application Settings Files  
 ...
 In a ClickOnce application, the size of the configuration files used by application settings is constrained by the size of the ClickOnce cache. For more information, see [Architecture of the ClickOnce Cache](../vs140/ClickOnce-Cache-Overview.md).  
...
|Setting's default changed; setting set to non-default in user.config|The setting is merged into the current version's user.config with the non-default value retained|  
 ...
 If you have created your own application settings wrapper class and wish to customize the update logic, you can override the <xref:System.Configuration.ApplicationSettingsBase.Upgrade?qualifyHint=False> method.  
...
## See Also  
 ...
 [Application Settings Overview](assetId:///0dd8bca5-a6bf-4ac4-8eec-5725d08b38dc)   
 [Architecture of the ClickOnce Cache](../vs140/ClickOnce-Cache-Overview.md)   
