...
-   In the Graph View and the XML Schema Explorer, double-click a node, or right-click a node and select **View Code**. In the Content Model View, right-click a node and select **View Code**.  
 ...
 ![XSDDesignerWithXMLEditor](../vs140/media/XSDDesignerWithXMLEditor.gif "XSDDesignerWithXMLEditor")  
 ...
 ![XSDDesignerWithXMLEditorAndCMV](../vs140/media/XSDDesignerWithXMLEditorAndCMV.gif "XSDDesignerWithXMLEditorAndCMV")  
