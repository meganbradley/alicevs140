...
## Properties not visible to the user  
 If you just want your code to attach values to any element in a layer diagram, you don’t need to define a MEF component. There is a dictionary named `Properties` in <xref:Microsoft.VisualStudio.ArchitectureTools.Extensibility.Layer.ILayerElement?qualifyHint=False>. Simply add marshalable values to the dictionary of any layer element. They will be saved as part of the layer diagram. For more information, see [Navigating and Updating Layer Models](../Topic/Navigate%20and%20update%20layer%20models%20in%20program%20code.md).  
...
```  
 ...
 You can define properties on <xref:Microsoft.VisualStudio.ArchitectureTools.Extensibility.Layer.ILayerElement?qualifyHint=False> or any of its derived classes, which include:  
