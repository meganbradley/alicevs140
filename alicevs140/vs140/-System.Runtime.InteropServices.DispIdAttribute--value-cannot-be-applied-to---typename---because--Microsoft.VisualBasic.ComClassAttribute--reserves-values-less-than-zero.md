...
A <xref:System.Runtime.InteropServices.DispIdAttribute?qualifyHint=False> attribute block specifies a DISPID value less than 0, which is reserved by `COMClassAttribute` for special functions on the class to which it is applied.  
