...
> [!NOTE]
>  This function uses the same command flags as the [SccDiff Function](../vs140/SccDiff-Function.md). However, a source control plug-in may choose to not support the "quick-diff" operation for directories.  
