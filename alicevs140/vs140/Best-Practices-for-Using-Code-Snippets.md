...
## Handling Exceptions  
 Typically, code snippet Try…Catch blocks catch and rethrow all exceptions. That may not be the right choice for your project. For each exception, there are several ways to respond. For examples, see [How to: Handle an Exception Using try/catch](../Topic/How%20to:%20Handle%20an%20Exception%20Using%20try-catch%20\(C%23%20Programming%20Guide\).md) and [Try...Catch...Finally Statement (Visual Basic)](../vs140/Try...Catch...Finally-Statement--Visual-Basic-.md).  
...
-   Passing data to scripting technologies  
 ...
 For more information, see [Securing Applications](../vs140/Securing-Applications.md).  
...
## See Also  
 ...
 [Securing Applications](../vs140/Securing-Applications.md)   
