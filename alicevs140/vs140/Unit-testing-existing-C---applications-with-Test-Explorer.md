...
## Deciding how to test your code  
 Open the existing C++ project, and inspect it to decide how you want to add the unit tests. You might want to use some modeling tools, which help you see dependencies in the code, and help you understand how the parts interact. For more information, see [Visualizing Existing Code](../vs140/Visualize-code.md).  
...
2.  Add test classes and methods to the unit test code files. For example:  
 ...
 For more information, see [Unit testing native code with Test Explorer](assetId:///8a09d6d8-3613-49d8-9ffe-11375ac4736c).  
...
2.  In Test Explorer, choose **Run All**.  
 ...
 For more information, see [Test Driven Development with Test Explorer](../vs140/Quick-Start--Test-Driven-Development-with-Test-Explorer.md).