...
## Remarks  
 ...
 For more information on using `COleIPFrameWnd`, see the article [Activation](../vs140/Activation--C---.md).  
...
```  
virtual BOOL OnCreateControlBars(    CWnd* pWndFrame ,    CWnd* pWndDoc ); virtual BOOL OnCreateControlBars(    CFrameWnd* pWndFrame ,    CFrameWnd* pWndDoc );  
