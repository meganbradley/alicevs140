...
7.  Select the **Record actions, edit UI map or add assertions** option and choose **OK**.  
     ...
     For more information about the options in the dialog box, see [Creating Coded UI Tests](../Topic/Use%20UI%20Automation%20To%20Test%20Your%20Code.md#VerifyingCodeUsingCUITCreate).  
  
8.  Choose **Start Recording** on the UIMap – Coded UI Test Builder.  
  
     ![Start recording](../vs140/media/CUIT_Builder_Record.png "CUIT_Builder_Record")  
  
     You can pause the recording if needed, for example if you have to deal with incoming mail.  
  
     ![Pause the recording](../vs140/media/CUIT_.png "CUIT_")  
...
9. On the [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)] toolbar, choose **Save**.  
...
### Videos  
 ![link to video](../vs140/media/PlayVideo.gif "PlayVideo") [Coded UI Tests-DeepDive-Episode1-GettingStarted](http://go.microsoft.com/fwlink/?LinkID=230573)  
  
 ![link to video](../vs140/media/PlayVideo.gif "PlayVideo") [Coded UI Tests-DeepDive-Episode2-MaintainenceAndDebugging](http://go.microsoft.com/fwlink/?LinkID=230574)  
  
 ![link to video](../vs140/media/PlayVideo.gif "PlayVideo") [Coded UI Tests-DeepDive-Episode3-HandCoding](http://go.microsoft.com/fwlink/?LinkID=230575)  
...
## See Also  
 ...
 [Editing Coded UI Tests Using the Coded UI Test Editor](../vs140/Editing-Coded-UI-Tests-Using-the-Coded-UI-Test-Editor.md)