...
Use this dialog box to configure the character font used in a [Spy++ Views](../vs140/Spy---Views.md) window. To display this dialog box, expand the **View** menu and choose **Font**.  
