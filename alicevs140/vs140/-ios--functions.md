...
### Remarks  
 ...
 `boolalpha` effectively calls `_Str.`[setf](../vs140/ios_base-Class.md#ios_base__setf)( `ios_base::boolalpha`), and then returns `_Str.`  
  
 [noboolalpha](../vs140/-ios--functions.md#noboolalpha) reverses the effect of `boolalpha`.  
 ...
 **dec** effectively calls `_Str``.`[setf](../vs140/ios_base-Class.md#ios_base__setf)( `ios_base::dec`**, ios_base::basefield**), and then returns `_Str`.  
...
### Remarks  
 The manipulator effectively calls _I `osbase.`[unsetf](../vs140/ios_base-Class.md#ios_base__unsetf)`(ios_base::floatfield)`, then returns _I `osbase`.  
 ...
 **fixed** is the default display notation for floating-point numbers. [scientific](../vs140/-ios--functions.md#scientific) causes floating-point numbers to be displayed using scientific notation.  
 ...
 The manipulator effectively calls  *_Str.*[setf](../vs140/ios_base-Class.md#ios_base__setf)( `ios_base::fixed`,  **ios_base::floatfield**), and then returns `_Str`.  
...
### Remarks  
 ...
 The manipulator effectively calls `_Str`**.**[setf](../vs140/ios_base-Class.md#ios_base__setf)( `ios_base::hex`,  **ios_base::basefield**), and then returns `_Str`.  
...
### Remarks  
 ...
 The manipulator effectively calls `_Str`. [setf](../vs140/ios_base-Class.md#ios_base__setf)( [ios_base::internal](../vs140/ios_base-Class.md#ios_base__fmtflags), [ios_base::adjustfield](../vs140/ios_base-Class.md#ios_base__fmtflags)), and then returns `_Str`.  
...
### Remarks  
 The manipulator effectively calls `_Str.`[setf](../vs140/ios_base-Class.md#ios_base__setf)( `ios_base::left`,  **ios_base::adjustfield**), and then returns `_Str`.  
...
### Remarks  
 ...
 `noboolalpha` effectively calls `_Str.`[unsetf](../vs140/ios_base-Class.md#ios_base__unsetf)( `ios_base::boolalpha`), and then returns `_Str`.  
  
 [boolalpha](../vs140/-ios--functions.md#boolalpha) reverses the effect of `noboolalpha`.  
  
### Example  
  See [boolalpha](../vs140/-ios--functions.md#boolalpha) for an example of using `noboolalpha`.  
...
### Remarks  
 `noshowbase` is on by default. Use [showbase](../vs140/-ios--functions.md#showbase) to indicate the notational base of numbers.  
  
 The manipulator effectively calls `_Str.`[unsetf](../vs140/ios_base-Class.md#ios_base__unsetf)( `ios_base::showbase`), and then returns `_Str`.  
  
### Example  
  See [showbase](../vs140/-ios--functions.md#showbase) for an example of how to use `noshowbase`.  
...
### Remarks  
 `noshowpoint` is on by default; use [showpoint](../vs140/-ios--functions.md#showpoint) and [precision](../vs140/ios_base-Class.md#ios_base__precision) to display zeros after the decimal point.  
  
 The manipulator effectively calls `_Str.`[unsetf](../vs140/ios_base-Class.md#ios_base__unsetf)( `ios_base::showpoint`), and then returns `_Str`.  
...
### Remarks  
 ...
 The manipulator effectively calls `_Str.`[unsetf](../vs140/ios_base-Class.md#ios_base__unsetf)( `ios_base::showps`), then returns `_Str`.  
  
### Example  
  See [showpos](../vs140/-ios--functions.md#showpos) for an example of using `noshowpos`.  
...
### Remarks  
 ...
 The manipulator effectively calls `_Str.`[unsetf](../vs140/ios_base-Class.md#ios_base__unsetf)( `ios_base::skipws`), and then returns `_Str`.  
...
### Remarks  
 ...
 The manipulator effectively calls `_Str.`[unsetf](../vs140/ios_base-Class.md#ios_base__unsetf)( `ios_base::unitbuf`), and then returns `_Str`.  
...
### Remarks  
 The manipulator effectively calls `_Str.`[unsetf](../vs140/ios_base-Class.md#ios_base__unsetf)( `ios_base::uppercase`), and then returns `_Str`.  
  
### Example  
  See [uppercase](../vs140/-ios--functions.md#uppercase) for an example of using `nouppercase`.  
...
### Remarks  
 ...
 The manipulator effectively calls `_Str.`[setf](../vs140/ios_base-Class.md#ios_base__setf)( `ios_base::oct`, `ios_base::basefield`), and then returns `_Str`.  
...
### Remarks  
 ...
 The manipulator effectively calls `_Str.`[setf](../vs140/ios_base-Class.md#ios_base__setf)( `ios_base::right`, `ios_base::adjustfield`), and then returns `_Str`.  
...
### Remarks  
 ...
 The manipulator effectively calls `_Str.`[setf](../vs140/ios_base-Class.md#ios_base__setf)( `ios_base::scientific`, `ios_base::floatfield`), and then returns `_Str`.  
...
### Remarks  
 ...
 The manipulator effectively calls `_Str.`[setf](../vs140/ios_base-Class.md#ios_base__setf)( `ios_base::showbase`), and then returns `_Str`.  
...
### Remarks  
 ...
 The manipulator effectively calls `_Str.`[setf](../vs140/ios_base-Class.md#ios_base__setf)( `ios_base::showpoint`), and then returns `_Str`.  
  
### Example  
  See [noshowpoint](../vs140/-ios--functions.md#noshowpoint) for an example of using `showpoint`.  
...
### Remarks  
 ...
 The manipulator effectively calls `_Str.`[setf](../vs140/ios_base-Class.md#ios_base__setf)( `ios_base::showpos`), and then returns `_Str`.  
...
### Remarks  
 By default, `skipws` is in effect. [noskipws](../vs140/-ios--functions.md#noskipws) will cause spaces to be read from the input stream.  
  
 The manipulator effectively calls `_Str.`[setf](../vs140/ios_base-Class.md#ios_base__setf)( `ios_base::skipws`), and then returns `_Str`.  
...
### Remarks  
 ...
 The manipulator effectively calls `_Str.`[setf](../vs140/ios_base-Class.md#ios_base__setf)( [ios_base::unitbuf](../vs140/ios_base-Class.md#ios_base__fmtflags)), and then returns `_Str`.  
...
### Remarks  
 ...
 The manipulator effectively calls `_Str.`[setf](../vs140/ios_base-Class.md#ios_base__setf)( [ios_base::uppercase](../vs140/ios_base-Class.md#ios_base__fmtflags)), and then returns `_Str`.  
