 ...
 **Sign the ClickOnce manifests** check box  
 Select this check box to sign the application and deployment manifests with a public/private key pair. For more information about how to do this, see [How to: Sign Application and Deployment Manifests](../vs140/How-to--Sign-Application-and-Deployment-Manifests.md).  
 ...
 **Sign the assembly** check box  
 ...
 This option uses the Al.exe tool provided by the [!INCLUDE[winsdklong](../vs140/includes/winsdklong_md.md)] to sign the assembly. For more information about Al.exe, see [How to: Sign an Assembly with a Strong Name](assetId:///2c30799a-a826-46b4-a25d-c584027a6c67).  
 ...
 **Delay sign only** check box  
 ...
 Note that a delay signed project will not run and cannot be debugged. You can, however, use the [Strong Name Tool (Sn.exe)](assetId:///c1d2b532-1b8e-4c7a-8ac5-53b801135ec6) with the `-Vr` option to skip verification during development.  
...
## See Also  
 ...
 [How to: Sign Application and Deployment Manifests](../vs140/How-to--Sign-Application-and-Deployment-Manifests.md)   
