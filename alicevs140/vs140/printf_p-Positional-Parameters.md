...
Positional parameters provide the ability to specify by number which of the arguments is to be substituted into a field in a format string. The following positional parameter `printf` functions are available:  
 ...
 [vprintf, vwprintf](../vs140/vprintf--_vprintf_l--vwprintf--_vwprintf_l.md)  
 [_vprintf_p, _vwprintf_p](../vs140/_vprintf_p--_vprintf_p_l--_vwprintf_p--_vwprintf_p_l.md)  
...
## See Also  
 ...
 [printf Width Specification](../vs140/printf-Width-Specification.md)   
