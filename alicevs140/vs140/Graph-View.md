...
The Graph View provides a graphic representation of global schema nodes and the relationships between the nodes. Note that the Graph View does not allow you to alter the layout of the schema set on the design surface. The Graph View also includes the XML Schema Designer toolbar and the breadcrumb bar.  
 ...
 ![XML Schema Designer Graph View](../vs140/media/XSDDesigner_GraphView.gif "XSDDesigner_GraphView")  
  
## Design Surface  
 The design surface of the Graph View displays the contents of the [XML Schema Designer Workspace](../vs140/XML-Schema-Designer-Workspace.md). If the workspace contains any global nodes from the schema set, the nodes are shown on the Graph View design surface and arrows are drawn between the nodes that have relationships.  
 ...
 ![XSD Designer; Graph View](../vs140/media/XSDGraphViewWatermark.gif "XSDGraphViewWatermark")  
...
## XSD Toolbar  
 ...
 ![XML Schema Designer Toolbar](../vs140/media/XSDGraphViewToolbar.gif "XSDGraphViewToolbar")  
...
## XML Editor Integration  
 ...
 If you make changes to the schema set in the XML Editor, the changes will be synchronized in the Graph View. For more information, see [Integration with XML Editor](../vs140/Integration-with-XML-Editor.md).  
  
## See Also  
 [Design Surface](../vs140/XML-Schema-Designer-Workspace.md)