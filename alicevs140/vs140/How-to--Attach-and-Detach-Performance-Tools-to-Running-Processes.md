...
> [!NOTE]
>  The following steps apply to attaching and detaching processes from within the [!INCLUDE[vs_current_short](../vs140/includes/vs_current_short_md.md)] integrated development environmnent (IDE). For information about how to use command line tools, see [Command-line Tools](../vs140/Using-the-Profiling-Tools-From-the-Command-Line.md). For information about how to profile services, see [Command-Line Profiling of Services](../vs140/Command-Line-Profiling-of-Services.md).  
...
-   Deny access to profiling to everybody.  
 ...
 For more information, see [Profiling and Windows Vista Security](../vs140/Profiling-and-Windows-Vista-Security.md) and the ADMIN options in [VSPerfCmd](../vs140/VSPerfCmd.md).  
...
## See Also  
 ...
 [How to: Start and End Performance Sessions](../vs140/How-to--Start-and-End-Performance-Data-Collection.md)   
