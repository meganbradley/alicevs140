...
##  <a name="BKMK_Nested"></a> Nested Property Functions  
 ...
 This example returns the value of the <xref:System.IO.FileAttributes?qualifyHint=False>`Archive` bit (32 or 0) of the file given by the path `tempFile`. Notice that enumerated data values cannot appear by name within property functions. The numeric value (32) must be used instead.  
  
 Metadata may also appear in nested property functions. For more information, see [Batching](../Topic/MSBuild%20Batching.md).  
