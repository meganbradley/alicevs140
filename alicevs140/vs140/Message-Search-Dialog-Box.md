...
Use this dialog box to find and select the node for a specific message in [Messages View](../vs140/Messages-View.md). To display this dialog box, move the focus to a Messages view window. Then choose **Find Message** from the **Search** menu.  
