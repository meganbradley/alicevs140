...
```  
 ...
 For a more detailed example these customizations, see [Walkthrough: A Simple Isolated Shell Custom tool](../vs140/Walkthrough--Creating-a-Basic-Isolated-Shell-Application.md).  
...
|VsDbgCmdUsed.vsct|Command table for the debugger.|  
 ...
 For more information, see [Designing XML Command Table (.Vsct) Files](../Topic/Designing%20XML%20Command%20Table%20\(.Vsct\)%20Files.md) and the [VSCT XML Schema Reference](../vs140/VSCT-XML-Schema-Reference.md).  
