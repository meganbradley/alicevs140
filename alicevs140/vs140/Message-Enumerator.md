...
---
# Message Enumerator
The following flags are used for the `TEXTOUTPROC` function, which is a callback function that the IDE provides when it calls the [SccOpenProject Function](../vs140/SccOpenProject-Function.md) (see [Displaying Output by Using the LPTEXTOUTPROC Function](../vs140/LPTEXTOUTPROC.md) for details on the callback function).  
