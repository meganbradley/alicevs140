...
## Rule Description  
 ...
 If a method must return a different instance, use the return value of the method to accomplish this. See the <xref:System.String?qualifyHint=True> class for a variety of methods that operate on strings and return a new instance of a string. By using this model, it is left to the caller to decide whether the original object is preserved.  
...
**12345 ABCDE**   
## Related Rules  
 [Avoid out parameters](../Topic/CA1021:%20Avoid%20out%20parameters.md)