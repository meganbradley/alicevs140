...
|[CWinAppEx::ExitInstance](#cwinappex__exitinstance)|Called by the framework from within the `Run` member function to exit this instance of the application. (Overrides [CWinApp::ExitInstance](../vs140/CWinApp-Class.md#cwinapp__exitinstance).)|  
