...
'module': cannot specify different module attributes in a project  
 ...
 [module](../vs140/module--C---.md) attributes with different parameter lists were found in two of the files in a compilation. Only one unique `module` attribute can be specified per compilation.  
