...
[!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)] includes built-in accessibility features so you can easily work from the keyboard and use screen readers or other assistive technology devices. The topic includes some suggestions for optimizing [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)] for accessibility as well as some useful shortcut key combinations.  
...
## Common Windows Shortcut Key Combinations  
 You can use many of the standard Windows shortcut key combinations to perform tasks within [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)]. Some of these shortcut key combinations include:  
...
## See Also  
 [Visual Studio Accessibility Features and Options](../vs140/Accessibility-Features-of-Visual-Studio.md)