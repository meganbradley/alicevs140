...
### DllMain  
 ...
 If DllMain attempts to execute MSIL directly, [Compiler Warning (level 1) C4747](../vs140/Compiler-Warning--level-1--C4747.md) will result. However, the compiler cannot detect cases where DllMain calls a function in another module that in turn attempts to execute MSIL.  
