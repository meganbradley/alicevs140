...
> [!NOTE]
>  If you want to create your own menu commands, see [How to Add a Command](../Topic/How%20to:%20Add%20a%20Command%20to%20the%20Shortcut%20Menu.md).  
...
```  
 ...
 If your code makes changes to the Store, such as creating, deleting or updating elements or links, you must do so inside a transaction. For more information, see [How to Create and Update model elements](../vs140/How-to--Modify-a-Standard-Menu-Command-in-a-Domain-Specific-Language.md).  
...
-   `shape.ModelElement as MyLanguageElement` - the model element represented by a shape.  
 ...
 For more information about how to navigate from element to element and about how to create objects and links, see [How to Navigate and Update the Model](../Topic/Navigating%20and%20Updating%20a%20Model%20in%20Program%20Code.md).  
  
## See Also  
 <xref:System.ComponentModel.Design.MenuCommand?qualifyHint=False>   
 [Programming Domain-Specific Languages](../vs140/Writing-Code-to-Customise-a-Domain-Specific-Language.md)   
 [Walkthrough: Adding a Command to the Shortcut Menu](../Topic/How%20to:%20Add%20a%20Command%20to%20the%20Shortcut%20Menu.md)   
 [Walkthrough: Getting Information from a Selected Link](../vs140/Walkthrough--Getting-Information-from-a-Selected-Link.md)   
 [How VSPackages Add User Interface Elements to the IDE](../Topic/How%20VSPackages%20Add%20User%20Interface%20Elements.md)   
