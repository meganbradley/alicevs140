...
|`!=`|First operand not equal to second operand|  
 ...
 The first four operators in the list above have a higher precedence than the equality operators (`==` and `!=`). See the precedence information in the table [Precedence and Associativity of C Operators](../vs140/Precedence-and-Order-of-Evaluation.md).  
...
## See Also  
 [Relational Operators: <, >, <=, and >=](../vs140/Relational-Operators---------=--and--=.md)   
 [Equality Operators: == and !=](../vs140/Equality-Operators--==-and-!=.md)