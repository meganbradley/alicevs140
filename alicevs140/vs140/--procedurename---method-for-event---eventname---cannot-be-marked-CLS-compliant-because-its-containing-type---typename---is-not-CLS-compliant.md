...
-   If you require that the event remain within its containing type, remove <xref:System.CLSCompliantAttribute?qualifyHint=False> from its definition or mark it as `<CLSCompliant(False)>`.  
