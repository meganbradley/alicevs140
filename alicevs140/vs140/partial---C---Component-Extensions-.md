...
## All Runtimes  
 (This language feature applies only to the [!INCLUDE[wrt](../vs140/includes/wrt_md.md)].)  
...
### Parameters  
 *class-key*  
 A keyword that declares a class or struct that is supported by the [!INCLUDE[wrt](../vs140/includes/wrt_md.md)]. Either `ref class`, `value class`, `ref struct`, or `value struct`.  
