...
|[<Package\> Element (ClickOnce Bootstrapper)](../vs140/-Package--Element--Bootstrapper-.md)|Required top-level element for package files.|`Culture`<br /><br /> `Name`<br /><br /> `EULA`|  
...
|[<Commands\> Element (ClickOnce Bootstrapper)](../vs140/-Commands--Element--Bootstrapper-.md)|Required element.  Executes one or more installation checks as described by `InstallChecks`, and denotes which package to install should the check fail.|None|  
