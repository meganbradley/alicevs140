...
|`SCC_OPT_USERDATA`|Arbitrary value|Specifies a user value to be passed to the [OPTNAMECHANGEPFN](../vs140/OPTNAMECHANGEPFN.md) callback function.|  
...
|`SCC_OPT_NAMECHANGEPFN`|Pointer to the [OPTNAMECHANGEPFN](../vs140/OPTNAMECHANGEPFN.md) callback function|Sets a pointer to a name-change callback function.|  
