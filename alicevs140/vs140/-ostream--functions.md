...
### Remarks  
 The manipulator calls `_Ostr`**.**[put](../vs140/basic_ostream-Class.md#basic_ostream__put)( `_Ostr`**.** [widen](../vs140/basic_ios-Class.md#basic_ios__widen)( **'\n'**)), and then calls `_Ostr`**.**[flush](../vs140/basic_ostream-Class.md#basic_ostream__flush). It returns `_Ostr`.  
...
### Remarks  
 The manipulator calls `_Ostr`**.**[put](../vs140/basic_ostream-Class.md#basic_ostream__put)( `_Elem`( **'\0'**)). It returns `_Ostr.`  
...
### Remarks  
 The manipulator calls `_Ostr`**.**[flush](../vs140/basic_ostream-Class.md#basic_ostream__flush). It returns `_Ostr`.  
