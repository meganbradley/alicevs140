...
[!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)] provides many default shortcut key combinations to make it easy to navigate and code within the integrated development environment (IDE). For a full listing of shortcut keys used in Visual Studio, see [Pre-defined Keyboard Shortcuts](../vs140/Default-Keyboard-Shortcuts-in-Visual-Studio.md). For information on keyboard shortcuts available for other Microsoft products, see [http://www.microsoft.com/enable/products/keyboard.aspx](http://go.microsoft.com/fwlink/?LinkID=40400).  
...
## See Also  
 ...
 [Shortcut Keys](../vs140/Default-Keyboard-Shortcuts-in-Visual-Studio.md)