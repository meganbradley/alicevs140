...
## Using Test Explorer  
 ![Unit Test Explorer showing Run All button](../vs140/media/UnitTestExplorer-beta-.png "UnitTestExplorer(beta)")  
...
2.  Create a Test project.  
    ...
    -   In the **New Project** dialog, choose **Visual C#**, **Test** and then choose **Unit Test Project**.  
         ...
         ![New code and test projects](../vs140/media/UnitTestExplorerWalk1.png "UnitTestExplorerWalk1")  
...
7.  Select the items under **Stack Trace** to see where the test failed.  
 ...
 ![Unit Test Explorer showing failed test.](../vs140/media/UnitTestExplorerWalkthrough2.png "UnitTestExplorerWalkthrough2")  
...
2.  In Test Explorer, choose **Run All**.  
     ...
     ![Unit Test Explorer showing a passing test.](../vs140/media/UnitTestExplorerWalkthrough3.png "UnitTestExplorerWalkthrough3")  
...
2.  Choose **Run All**.  
     ...
     ![Unit Test Explorer showing 3 passed tests.](../vs140/media/UnitTestExplorerWalkthrough4.png "UnitTestExplorerWalkthrough4")