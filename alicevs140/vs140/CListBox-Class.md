...
|1|Item 1 sorts after item 2.|  
 ...
 See [CWnd::OnCompareItem](../vs140/CWnd-Class.md#cwnd__oncompareitem) for a description of the `COMPAREITEMSTRUCT` structure.  
...
### Remarks  
 ...
 See [CWnd::OnDeleteItem](../vs140/CWnd-Class.md#cwnd__ondeleteitem) for a description of the `DELETEITEMSTRUCT` structure.  
...
### Parameters  
 `attr`  
 Can be any combination of the `enum` values described in **CFile::GetStatu**[s](../vs140/CFile-Class.md#cfile__getstatus), or any combination of the following values:  
...
### Remarks  
 ...
 See [CWnd::OnDrawItem](../vs140/CWnd-Class.md#cwnd__ondrawitem) for a description of the `DRAWITEMSTRUCT` structure.  
...
### Remarks  
 Unlike the [AddString](#clistbox__addstring) member function, `InsertString` does not cause a list with the [LBS_SORT](../vs140/List-Box-Styles.md) style to be sorted.  
