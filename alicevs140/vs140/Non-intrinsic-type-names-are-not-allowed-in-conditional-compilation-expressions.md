...
The conditional compilation expression refers to a non-intrinsic type, but only intrinsic types are allowed.  
 ...
 For more information about the intrinsic type in [!INCLUDE[vbprvb](../vs140/includes/vbprvb_md.md)], see [Data Types Summary](../Topic/Data%20Types%20Summary%20\(Visual%20Basic\).md).  
