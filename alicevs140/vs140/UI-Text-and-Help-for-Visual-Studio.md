...
#### Supplemental instructions  
 ...
 ![Supplemental text in Visual Studio](../vs140/media/0601-b_SupplementalText1.png "0601-b_SupplementalText1")  
  
 **Supplemental text in Visual Studio**  
  
 ![Supplemental text in Visual Studio](../vs140/media/0601-c_SupplementalText2.png "0601-c_SupplementalText2")  
...
#### InfoTips  
 ...
 ![InfoTip in Visual Studio](../vs140/media/0601-d_InfoTip.png "0601-d_InfoTip")  
...
#### Control labels  
 ...
 For more information about control label format and placement within the UI, refer to [Layout for Visual Studio](../vs140/Layout-for-Visual-Studio.md).  
...
-   When launching dialogs, maintain the standards for ellipses: no ellipsis for navigation, ellipses if the task requires additional UI.  
     ...
     ![Help link in Visual Studio](../vs140/media/0601-e_HelpLink.png "0601-e_HelpLink")  
...
-   In place of the control label:  
     ...
     ![Hint text in Visual Studio](../vs140/media/0601-f_HintText1.png "0601-f_HintText1")  
  
-   With a verb, giving instructions:  
  
     ![Hint text in Visual Studio](../vs140/media/0601-g_HintText2.png "0601-g_HintText2")  
  
-   With text indicating a required entry:  
  
     ![Hint text in Visual Studio](../vs140/media/0601-h_HintText3.png "0601-h_HintText3")  
...
#### Watermark text  
 ...
 ![Watermark text in Visual Studio](../vs140/media/0601-i_WatermarkText.png "0601-i_WatermarkText")  
...
|Good|Bad|  
|----------|---------|  
|“The number you dialed is no longer in service. Please check the number and dial again or dial 0 for the operator.”|-   “Error (449): Illegal number”<br />-   “This unhandled exception error indicates that the operation completed successfully.”<br /><br /> ![Bad error message in Visual Studio](../vs140/media/0602-a_ErrorDialog.png "0602-a_ErrorDialog")|  
...
#### Instructional and supplemental text in dialogs  
 In dialogs that support complex tasks, there might be a need to give instructional text within the UI, often at the top of the dialog or near complex controls. See [UI text and terminology](../vs140/UI-Text-and-Help-for-Visual-Studio.md#BKMK_UITextAndTerminology) for details on writing style.  
...
#### Hyperlinks to Help topics  
 Hyperlinks can be used to perform an action, navigate within the IDE, or launch Help in a browser. See [UI text and terminology](../vs140/UI-Text-and-Help-for-Visual-Studio.md#BKMK_UITextAndTerminology) for details on language and 07.10.01 Buttons and hyperlinks for visual and layout guidelines.  
...
## See Also  
 [Fonts and Formatting for Visual Studio](../vs140/Fonts-and-Formatting-for-Visual-Studio.md)   
 [Layout for Visual Studio](../vs140/Layout-for-Visual-Studio.md)   
 [Notifications and Progress for Visual Studio](../vs140/Notifications-and-Progress-for-Visual-Studio.md)