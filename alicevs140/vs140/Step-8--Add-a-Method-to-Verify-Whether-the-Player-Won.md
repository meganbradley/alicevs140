...
3.  Save and run the program. Play the game and match all of the icons. When you win, the program displays a congratulatory MessageBox (as shown in the following picture), and then closes the box.  
     ...
     ![Matching game with MessageBox](../vs140/media/Express_Tut4Step8.png "Express_Tut4Step8")  
Matching game with MessageBox  
  
### To continue or review  
  
-   To go to the next tutorial step, see [Step 9: Try Other Features](../vs140/Step-9--Try-Other-Features.md).  
  
-   To return to the previous tutorial step, see [Step 7: Keep Pairs Visible](../vs140/Step-7--Keep-Pairs-Visible.md).