...
5.  In the **Command Arguments** box, specify any necessary arguments for the executable.  
 ...
 If you do not specify the executable in the *Project***Property Pages** dialog box, the [Executable for Debugging Session Dialog Box](../vs140/Executable-for-Debugging-Session-Dialog-Box.md) appears when you start debugging.  
