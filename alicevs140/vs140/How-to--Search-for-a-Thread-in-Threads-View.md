...
1.  Arrange your windows so that Spy++ and an active [Threads View](../vs140/Threads-View.md) window are visible.  
  
2.  From the **Search** menu, choose **Find Thread**.  
  
     The [Thread Search Dialog Box](../vs140/Thread-Search-Dialog-Box.md) opens.  
