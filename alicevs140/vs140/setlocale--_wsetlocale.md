...
|`_tsetlocale`|`setlocale`|`setlocale`|`_wsetlocale`|  
 ...
 The function [_configthreadlocale](../vs140/_configthreadlocale.md) is used to control whether `setlocale` affects the locale of all threads in a program or only the locale of the calling thread.  
