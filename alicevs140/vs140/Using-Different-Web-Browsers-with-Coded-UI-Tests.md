...
3.  Highlight the extension and choose **Download**.  
 ...
 For more information about creating and using coded UI tests, see [Creating Coded UI Tests](../Topic/Use%20UI%20Automation%20To%20Test%20Your%20Code.md#VerifyingCodeUsingCUITCreate).  
...
-   ![Tip](../vs140/media/Tip.png "Tip") You can configure the output to include screenshots in the coded UI logs. To do so, you need to set some configuration settings in the QTAgent32.exe.config file. By default, this file is installed in the following location:  
    ...
    -   `<add name="EqtTraceLevel" value="4" />`  
     ...
     For more information, see [Analyzing Coded UI Tests Using Coded UI Test Logs](../Topic/Analyzing%20Coded%20UI%20Tests%20Using%20Coded%20UI%20Test%20Logs.md).  
...
## See Also  
 ...
 [Analyzing Coded UI Tests Using Coded UI Test Logs](../Topic/Analyzing%20Coded%20UI%20Tests%20Using%20Coded%20UI%20Test%20Logs.md)