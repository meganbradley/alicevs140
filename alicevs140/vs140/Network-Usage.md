...
4.  Choose **Stop** to close the app.  
 ...
 ![The Network window](../vs140/media/NETWORK_FullWindow.png "NETWORK_FullWindow")  
...
## Analyzing data  
 ...
 ![Network tool details pane](../vs140/media/NETWORK_DetailsViewPane.png "NETWORK_DetailsViewPane")  
...
## See Also  
 [Run Visual Studio diagnostic tools without debugging](../vs140/Run-profiling-tools-without-debugging.md)   
