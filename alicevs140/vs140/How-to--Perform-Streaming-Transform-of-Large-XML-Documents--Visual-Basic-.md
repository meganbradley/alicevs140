...
## Example  
 The following example builds on the example in [How to: Stream XML Fragments with Access to Header Information (Visual Basic)](../vs140/How-to--Stream-XML-Fragments-with-Access-to-Header-Information--Visual-Basic-.md).  
...
## Example  
 The following example also builds on the example in [How to: Stream XML Fragments with Access to Header Information (Visual Basic)](../vs140/How-to--Stream-XML-Fragments-with-Access-to-Header-Information--Visual-Basic-.md).  
