...
2.  When processing the `WM_CREATE` message, call the `Create` method. You can use the regular [CControlBar](../vs140/CControlBar-Class.md) styles. For more information, see `CControlBar::Create`.  
