...
This example reads object data that was previously written to an XML file using the <xref:System.Xml.Serialization.XmlSerializer?qualifyHint=False> class.  
...
## Compiling the Code  
 Replace the file name "c:\temp\SerializationOverview.xml" with the name of the file containing the serialized data. For more information about serializing data, see [How to: Write Object Data to an XML File (C#)](../vs140/How-to--Write-Object-Data-to-an-XML-File--C#-.md).  
...
-   The file does not exist (<xref:System.IO.IOException?qualifyHint=False>).  
