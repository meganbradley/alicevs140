...
|**NoWarn** `[:[Message Number[;Message Number]]]`|Suppress all or specific warnings.<br /><br /> `Message Number` - the warning number. If `Message Number` is omitted, all warnings are suppressed.<br /><br /> For more information, see [VSInstr Warnings](../vs140/VSInstr-Warnings.md).|  
