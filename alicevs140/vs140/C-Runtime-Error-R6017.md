 ...
 **Information for Programmers**  
 ...
 To fix this issue, check for heap corruption bugs in your code. For more information and examples, see [CRT Debug Heap Details](../vs140/CRT-Debug-Heap-Details.md). Next, check that you are using the latest redistributables for your app deployment. For information, see [Deployment in Visual C++](../vs140/Deployment-in-Visual-C--.md).