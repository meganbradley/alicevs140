...
## Remarks  
 ...
 For more information about servers, see the article [Servers: Implementing a Server](../vs140/Servers--Implementing-a-Server.md).  
...
### Remarks  
 The registration information is loaded by means of a call to [CDocTemplate::GetDocString](../vs140/CDocTemplate-Class.md#cdoctemplate__getdocstring). The substrings retrieved are those identified by the indexes **regFileTypeId**, **regFileTypeName**, and **fileNewName**, as described in the `GetDocString` reference pages.  
...
## See Also  
 ...
 [Base Class](../vs140/COleObjectFactory-Class.md)   
