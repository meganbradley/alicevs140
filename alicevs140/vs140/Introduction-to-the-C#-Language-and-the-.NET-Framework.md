...
-   For a good general introduction to the language, see Chapter 1 of the [C# Language Specification](../vs140/C#-Language-Specification.md).  
  
-   For detailed information about specific aspects of the C# language, see the [C# Programmer's Reference](../vs140/C#-Reference.md).  
