...
Visual Studio*Graphics Diagnostics* is a set of tools for recording and then analyzing rendering and performance problems in Direct3D apps. Graphics Diagnostics can be used on apps that are running locally on your Windows PC, in a Windows device emulator, or on a remote PC or device.  
 ...
 Continue to [Overview of Visual Studio Graphics Diagnostics](../vs140/Overview-of-Visual-Studio-Graphics-Diagnostics.md) to learn more about what Visual Studio Graphics Diagnostics offers.  
  
## In This Section  
 [Overview of Visual Studio Graphics Diagnostics](../vs140/Overview-of-Visual-Studio-Graphics-Diagnostics.md)  
 Introduces the Graphics Diagnostics workflow and tools.  
  
 [Getting Started with Visual Studio Graphics diagnostics](../vs140/Getting-Started-with-Visual-Studio-Graphics-Diagnostics.md)  
 ...
 [Graphics Log Document](../vs140/Graphics-Log-Document.md)  
 ...
 [Graphics Frame Analysis](../vs140/Graphics-Frame-Analysis.md)  
 After you select a frame, you use Graphics Frame Analysis to examine and tune your rendering performance.  
  
 [Graphics Event List](../vs140/Graphics-Event-List.md)  
 ...
 [Graphics Event Call Stack](../vs140/Graphics-Event-Call-Stack.md)  
 ...
 [Graphics Pixel History](../vs140/Graphics-Pixel-History.md)  
 ...
 [Graphics Object Table](../vs140/Graphics-Object-Table.md)  
 ...
 [Graphics Diagnostics Examples](../vs140/Graphics-Diagnostics-Examples.md)  
...
|Title|Description|  
|-----------|-----------------|  
|[Debugging in Visual Studio](../vs140/Debugging-in-Visual-Studio.md)|Introduces the debugging functionality in [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)].|  
