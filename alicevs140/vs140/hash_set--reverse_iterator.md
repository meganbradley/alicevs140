---
title: "hash_set::reverse_iterator"
ms.custom: na
ms.date: 09/19/2016
ms.devlang: 
  - C++
...
ms.tgt_pltfrm: na
ms.topic: article
ms.assetid: 5df29ccf-4591-4f1a-aa69-1dbe9003225f
...
## Example  
 See the example for [rbegin](../vs140/hash_set--rbegin.md) for an example of how to declare and use `reverse_iterator`.  
