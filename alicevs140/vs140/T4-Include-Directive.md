...
-   The name of an included file does not have to use the extension `".tt"`.  
     ...
     You might want to use another extension such as `".t4"` for included files. This is because, when you add a `.tt` file to a project, [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)] automatically sets its **Custom Tool** property to `TextTemplatingFileGenerator`. You do not usually want included files to be transformed individually.  
