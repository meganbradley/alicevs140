...
1.  Arrange your windows so that Spy++, the [Windows View](../vs140/Windows-View.md) window, and the target window are visible.  
  
2.  From the **Search** menu, choose **Find Window**.  
  
     The [Window Search Dialog Box](../vs140/Window-Search-Dialog-Box.md) opens.  
...
5.  Click **OK**.  
     ...
     If a matching window is found, it is highlighted in the [Windows View](../vs140/Windows-View.md) window.