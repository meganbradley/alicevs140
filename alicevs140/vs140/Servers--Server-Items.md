...
3.  Implement an override of `OnGetEmbeddedItem` for your server-document class. For further information, see the article [Servers: Implementing Server Documents](../vs140/Servers--Implementing-Server-Documents.md) and the MFC OLE sample [HIERSVR](../vs140/Visual-C---Samples.md).  
...
##  <a name="_core_a_tip_for_server.2d.item_architecture"></a> A Tip for Server-Item Architecture  
 ...
 For more information, see [CView::OnDraw](../vs140/CView--OnDraw.md), [COleServerItem](../vs140/COleServerItem-Class.md), [COleServerItem::OnDraw](../vs140/COleServerItem--OnDraw.md), and [COleServerDoc::OnGetEmbeddedItem](../vs140/COleServerDoc--OnGetEmbeddedItem.md) in the *Class Library Reference*.  
