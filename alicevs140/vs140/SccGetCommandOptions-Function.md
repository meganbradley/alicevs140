...
## Remarks  
 ...
 Finally, when the user clicks **OK** in the IDE's **Get** dialog box, the IDE calls the [SccGet Function](../vs140/SccGet-Function.md), passing the structure returned in `ppvOptions` that contains the advanced options.  
