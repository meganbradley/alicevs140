...
-   #### To use a listing to view decorated names  
    ...
    1.  Generate a listing by compiling the source file that contains the data, object, or function definition or prototype with the [Listing File Type](../Topic/-FA,%20-Fa%20\(Listing%20File\).md) compiler option set to Assembly with Source Code (**/FAs**).  
