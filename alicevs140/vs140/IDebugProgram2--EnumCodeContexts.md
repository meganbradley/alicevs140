...
#### Parameters  
 `pDocPos`  
 [in] An [IDebugDocumentPosition2](../vs140/IDebugDocumentPosition2.md) object representing an abstract position in a source file known to the IDE.  
  
 `ppEnum`  
 [out] Returns an [IEnumDebugCodeContexts2](../vs140/IEnumDebugCodeContexts2.md) object that contains a list of the code contexts.  
