...
## Remarks  
 The template class describes various regular expression traits for type `Elem`. The template class [basic_regex](../vs140/basic_regex-Class.md) uses this information to manipulate elements of type `Elem`.  
