...
With the release of [!INCLUDE[net_v40_long](../vs140/includes/net_v40_long_md.md)], applications can be composed of modules that were built by using different versions of the [!INCLUDE[dnprdnshort](../vs140/includes/dnprdnshort_md.md)] run-time. By default, [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)] Profiling Tools profile the first runtime that is loaded by the application. You can specify the run-time to profile when you start an application with the profiler and when you attach the profiler to an already running application.  
...
1.  In **Performance Explorer**, right-click the performance session, click **Properties**, and then click **Advanced**.  
     ...
     The **Target CLR Version** list box displays **Automatic** and the versions of the [!INCLUDE[dnprdnshort](../vs140/includes/dnprdnshort_md.md)] runtime that are installed on the computer.  
...
2.  On the Attach Profiler to Process dialog box, click the process that you want to profile.  
     ...
     The **Target CLR Version** list box s **Automatic** and the versions of the [!INCLUDE[dnprdnshort](../vs140/includes/dnprdnshort_md.md)] runtime that are installed on the computer.  
