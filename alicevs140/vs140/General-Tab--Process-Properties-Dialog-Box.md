---
title: "General Tab, Process Properties Dialog Box"
ms.custom: na
ms.date: 09/19/2016
...
Use the **General** tab to find out more about a specific process. To display the [Process Properties Dialog Box](../vs140/Process-Properties-Dialog-Box.md), move the focus to a [Processes View](../vs140/Processes-View.md) window. Select any process node in the tree, then choose **Properties** from the **View** menu.  
