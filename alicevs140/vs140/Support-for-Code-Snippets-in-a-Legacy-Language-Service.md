...
A code snippet is a piece of code that is inserted into the source file. The snippet itself is an XML-based template with a set of fields. These fields are highlighted after the snippet is inserted and can have different values depending on the context in which the snippet is inserted. Immediately after the snippet is inserted, the language service can format the snippet.  
 ...
 Legacy language services are implemented as part of a VSPackage, but the newer way to implement language service features is to use MEF extensions. To find out more, see [Walkthrough: Implementing Code Snippets](../Topic/Walkthrough:%20Implementing%20Code%20Snippets.md).  
  
> [!NOTE]
>  We recommend that you begin to use the new editor API as soon as possible. This will improve the performance of your language service and let you take advantage of new editor features.  
  
## Managed Package Framework Support for Code Snippets  
 The managed package framework (MPF) supports most snippet functionality, from reading the template to inserting the snippet and enabling the special edit mode. Support is managed through the <xref:Microsoft.VisualStudio.Package.ExpansionProvider?qualifyHint=False> class.  
  
 When the <xref:Microsoft.VisualStudio.Package.Source?qualifyHint=False> class is instantiated, the <xref:Microsoft.VisualStudio.Package.LanguageService.CreateExpansionProvider?qualifyHint=False> method in the <xref:Microsoft.VisualStudio.Package.LanguageService?qualifyHint=False> class is called to obtain an <xref:Microsoft.VisualStudio.Package.ExpansionProvider?qualifyHint=False> object (note that the base <xref:Microsoft.VisualStudio.Package.LanguageService?qualifyHint=False> class always returns a new <xref:Microsoft.VisualStudio.Package.ExpansionProvider?qualifyHint=False> object for each <xref:Microsoft.VisualStudio.Package.Source?qualifyHint=False> object).  
  
 The MPF does not support expansion functions. An expansion function is a named function that is embedded in a snippet template and returns one or more values to be placed in a field. The values are returned by the language service itself through an <xref:Microsoft.VisualStudio.Package.ExpansionFunction?qualifyHint=False> object. The <xref:Microsoft.VisualStudio.Package.ExpansionFunction?qualifyHint=False> object must be implemented by the language service to support expansion functions.  
...
3.  Invoking the <xref:Microsoft.VisualStudio.Package.ExpansionProvider?qualifyHint=False> object.  
...
### Inserting a Code Snippet by using a Menu Command  
 To use a menu command to display the snippet browser, you add a menu command and then call the [M:Microsoft.VisualStudio.Package.ExpansionProvider.DisplayExpansionBrowser(Microsoft.VisualStudio.TextManager.Interop.IVsTextView,System.String,System.String\[\],System.Boolean,System.String\[\],System.Boolean)](assetId:///M:Microsoft.VisualStudio.Package.ExpansionProvider.DisplayExpansionBrowser(Microsoft.VisualStudio.TextManager.Interop.IVsTextView,System.String,System.String[],System.Boolean,System.String[],System.Boolean)?qualifyHint=False&autoUpgrade=True) method in the <xref:Microsoft.VisualStudio.Package.ExpansionProvider?qualifyHint=False> interface in response to that menu command.  
  
1.  Add a command and a button to your .vsct file. You can find instructions for doing so in [Walkthrough: Creating a Menu Command By Using the Visual Studio Package Template](../vs140/Walkthrough--Creating-a-Menu-Command-By-Using-the-Visual-Studio-Package-Template.md).  
  
2.  Derive a class from the <xref:Microsoft.VisualStudio.Package.ViewFilter?qualifyHint=False> class and override the <xref:Microsoft.VisualStudio.Package.ViewFilter.QueryCommandStatus?qualifyHint=False> method to indicate support for the new menu command. This example always enables the menu command.  
...
3.  Override the <xref:Microsoft.VisualStudio.Package.ViewFilter.HandlePreExec?qualifyHint=False> method in the <xref:Microsoft.VisualStudio.Package.ViewFilter?qualifyHint=False> class to obtain the <xref:Microsoft.VisualStudio.Package.ExpansionProvider?qualifyHint=False> object and call the [M:Microsoft.VisualStudio.Package.ExpansionProvider.DisplayExpansionBrowser(Microsoft.VisualStudio.TextManager.Interop.IVsTextView,System.String,System.String\[\],System.Boolean,System.String\[\],System.Boolean)](assetId:///M:Microsoft.VisualStudio.Package.ExpansionProvider.DisplayExpansionBrowser(Microsoft.VisualStudio.TextManager.Interop.IVsTextView,System.String,System.String[],System.Boolean,System.String[],System.Boolean)?qualifyHint=False&autoUpgrade=True) method on that object.  
    ...
    ```  
     ...
     The following methods in the <xref:Microsoft.VisualStudio.Package.ExpansionProvider?qualifyHint=False> class are called by Visual Studio in the given order during the process of inserting the snippet:  
  
4.  <xref:Microsoft.VisualStudio.Package.ExpansionProvider.OnItemChosen?qualifyHint=False>  
...
6.  <xref:Microsoft.VisualStudio.Package.ExpansionProvider.OnBeforeInsertion?qualifyHint=False>  
...
8.  <xref:Microsoft.VisualStudio.Package.ExpansionProvider.OnAfterInsertion?qualifyHint=False>  
  
     After the <xref:Microsoft.VisualStudio.Package.ExpansionProvider.OnAfterInsertion?qualifyHint=False> method is called, the snippet has been inserted and the <xref:Microsoft.VisualStudio.Package.ExpansionProvider?qualifyHint=False> object is in a special edit mode used for modifying a snippet that has just been inserted.  
  
### Inserting a code snippet by using a shortcut  
 Implementation of a shortcut from a completion list is much more involved than implementing a menu command. You must first add snippet shortcuts to the IntelliSense word completion list. Then you must detect when a snippet shortcut name has been inserted as a result of completion. Finally, you must obtain the snippet title and path using the shortcut name and pass that information to the <xref:Microsoft.VisualStudio.Package.ExpansionProvider.InsertNamedExpansion?qualifyHint=False> method on the <xref:Microsoft.VisualStudio.Package.ExpansionProvider?qualifyHint=False> method.  
  
 To add snippet shortcuts to the word completion list, add them to the <xref:Microsoft.VisualStudio.Package.Declarations?qualifyHint=False> object in your <xref:Microsoft.VisualStudio.Package.AuthoringScope?qualifyHint=False> class. You must make sure you can identify the shortcut as a snippet name. For an example, see [How to: Get a List of Installed Code Snippets](../Topic/Walkthrough:%20Getting%20a%20List%20of%20Installed%20Code%20Snippets%20\(Legacy%20Implementation\).md).  
  
 You can detect the insertion of the code snippet shortcut in the <xref:Microsoft.VisualStudio.Package.Declarations.OnAutoComplete?qualifyHint=False> method of the <xref:Microsoft.VisualStudio.Package.Declarations?qualifyHint=False> class. Because the snippet name has already been inserted into the source file, it must be removed when the expansion is inserted. The <xref:Microsoft.VisualStudio.Package.ExpansionProvider.InsertNamedExpansion?qualifyHint=False> method takes a span that describes the point of insertion for the snippet; if the span includes the entire snippet name in the source file, that name is replaced by the snippet.  
  
 Here is a version of a <xref:Microsoft.VisualStudio.Package.Declarations?qualifyHint=False> class that handles snippet insertion given a shortcut name. Other methods in the <xref:Microsoft.VisualStudio.Package.Declarations?qualifyHint=False> class have been omitted for clarity. Note that the constructor of this class takes a <xref:Microsoft.VisualStudio.Package.LanguageService?qualifyHint=False> object. This can be passed in from your version of the <xref:Microsoft.VisualStudio.Package.AuthoringScope?qualifyHint=False> object (for example, your implementation of the <xref:Microsoft.VisualStudio.Package.AuthoringScope?qualifyHint=False> class might take the <xref:Microsoft.VisualStudio.Package.LanguageService?qualifyHint=False> object in its constructor and pass that object on to your `TestDeclarations` class constructor).  
...
```  
 ...
 When the language service gets the shortcut name, it calls the <xref:Microsoft.VisualStudio.Package.ExpansionProvider.FindExpansionByShortcut?qualifyHint=False> method to obtain the filename and code snippet title. The language service then calls the <xref:Microsoft.VisualStudio.Package.ExpansionProvider.InsertNamedExpansion?qualifyHint=False> method in the <xref:Microsoft.VisualStudio.Package.ExpansionProvider?qualifyHint=False> class to insert the code snippet. The following methods are called by Visual Studio in the given order in the <xref:Microsoft.VisualStudio.Package.ExpansionProvider?qualifyHint=False> class during the process of inserting the snippet:  
  
1.  [M:Microsoft.VisualStudio.Package.ExpansionProvider.IsValidKind(Microsoft.VisualStudio.TextManager.Interop.IVsTextLines,Microsoft.VisualStudio.TextManager.Interop.TextSpan\[\],System.String,System.Int32@)](assetId:///M:Microsoft.VisualStudio.Package.ExpansionProvider.IsValidKind(Microsoft.VisualStudio.TextManager.Interop.IVsTextLines,Microsoft.VisualStudio.TextManager.Interop.TextSpan[],System.String,System.Int32@)?qualifyHint=False&autoUpgrade=True)  
  
2.  <xref:Microsoft.VisualStudio.Package.ExpansionProvider.OnBeforeInsertion?qualifyHint=False>  
  
3.  [M:Microsoft.VisualStudio.Package.ExpansionProvider.FormatSpan(Microsoft.VisualStudio.TextManager.Interop.IVsTextLines,Microsoft.VisualStudio.TextManager.Interop.TextSpan\[\])](assetId:///M:Microsoft.VisualStudio.Package.ExpansionProvider.FormatSpan(Microsoft.VisualStudio.TextManager.Interop.IVsTextLines,Microsoft.VisualStudio.TextManager.Interop.TextSpan[])?qualifyHint=False&autoUpgrade=True)  
  
4.  <xref:Microsoft.VisualStudio.Package.ExpansionProvider.OnAfterInsertion?qualifyHint=False>  
  
 For more information on getting a list of installed code snippets for your language service, see [How to: Get a List of Installed Code Snippets](../Topic/Walkthrough:%20Getting%20a%20List%20of%20Installed%20Code%20Snippets%20\(Legacy%20Implementation\).md).  
  
## Implementing the ExpansionFunction Class  
 An expansion function is a named function that is embedded in a snippet template and returns one or more values to be placed in a field. In order to support expansion functions in your language service, you must derive a class from the <xref:Microsoft.VisualStudio.Package.ExpansionFunction?qualifyHint=False> class and implement the <xref:Microsoft.VisualStudio.Package.ExpansionFunction.GetCurrentValue?qualifyHint=False> method. You must then override the <xref:Microsoft.VisualStudio.Package.LanguageService.CreateExpansionFunction?qualifyHint=False> method in the <xref:Microsoft.VisualStudio.Package.LanguageService?qualifyHint=False> class to return a new instantiation of your version of the <xref:Microsoft.VisualStudio.Package.ExpansionFunction?qualifyHint=False> class for each expansion function you support. If you support a list of possible values from an expansion function, you must also override the <xref:Microsoft.VisualStudio.Package.ExpansionFunction.GetIntellisenseList?qualifyHint=False> method in the <xref:Microsoft.VisualStudio.Package.ExpansionFunction?qualifyHint=False> class to return a list of those values.  
