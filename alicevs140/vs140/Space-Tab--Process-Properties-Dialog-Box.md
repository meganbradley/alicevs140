...
Use the **Space** tab to examine the address space of a process. To display the [Process Properties Dialog Box](../vs140/Process-Properties-Dialog-Box.md), move the focus to a [Processes View](../vs140/Processes-View.md) window. Select any process node in the tree, then choose **Properties** from the **View** menu.  
