...
> [!NOTE]
>  This topic is about fragments in sequence diagrams. For more information about how to read UML sequence diagrams, see [UML Sequence Diagrams: Overview](../vs140/UML-Sequence-Diagrams--Reference.md). For more information about how to draw UML sequence diagrams, see [UML Sequence Diagrams: Guidelines](../vs140/UML-Sequence-Diagrams--Guidelines.md).  
  
 ![Combined Fragment with two Interaction Operands](../vs140/media/UML_SeqFragments.png "UML_SeqFragments")  
