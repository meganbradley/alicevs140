...
The following terms are used in this document:  
 ...
 construct  
 A construct is a statement. It consists of a directive and the subsequent structured block. Note that some directives are not part of a construct. (See *openmp-directive* in [Appendix C](../vs140/C.-OpenMP-C-and-C---Grammar.md)).  
