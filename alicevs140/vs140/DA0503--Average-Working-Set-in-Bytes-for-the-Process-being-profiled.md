...
## How to Use Rule Data  
 ...
 Double-click the message in the Errors List window to navigate to the [Marks View](../vs140/Marks-View.md) view of the profiling data. Find the **Process\Working Set** and the **Memory\Pages/sec** columns. Compare the two columns and determine if there are specific phases of program execution that appear to be associated with increased paging IO activity.