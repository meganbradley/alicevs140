...
#### Parameters  
 `dwFields`  
 [in] A combination of flags from the [BPREQI_FIELDS](../vs140/BPREQI_FIELDS.md) enumeration that determines which fields in the `pBPRequestInfo` parameter are to be filled out.  
