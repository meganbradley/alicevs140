...
5.  If you want tool tips for a toolbar button in an owner window that is not a `CFrameWnd`, you need to handle the **TTN_NEEDTEXT** messages in the toolbar's owner window as described in [Handling Tool Tip Notifications](../vs140/Handling-Tool-Tip-Notifications.md). If the parent window of the toolbar is derived from `CFrameWnd`, tool tips are displayed without any extra effort from you because `CFrameWnd` provides a default handler.  
...
## Support for Internet Explorer Version 4.0 and Later  
 ...
 For more information on using `CToolBarCtrl`, see [Controls](../vs140/Controls--MFC-.md) and [Using CToolBarCtrl](../vs140/Using-CToolBarCtrl.md).  
...
### Return Value  
 A `DWORD` containing a combination of                         [toolbar control styles](http://msdn.microsoft.com/library/windows/desktop/bb760439), as described in the [!INCLUDE[winSDK](../vs140/includes/winSDK_md.md)].  
