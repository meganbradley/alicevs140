...
```  
 ...
 According to the conversion rules for the addition operator (given in [Additive Operators](../vs140/C-Additive-Operators.md)), the integral value is converted to an address offset by multiplying it by the length of the type addressed by the pointer.  
