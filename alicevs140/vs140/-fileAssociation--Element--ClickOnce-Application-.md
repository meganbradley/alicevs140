...
|`defaultIcon`|Required. Specifies the icon to use for files with this extension. The icon file must be specified by using the [<file\> element](../Topic/%3Cfile%3E%20Element%20\(ClickOnce%20Application\).md) within the [<assembly\> element](../vs140/-assembly--Element--ClickOnce-Application-.md) that contains this element.|  
