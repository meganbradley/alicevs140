 ...
 **Available ActiveX controls**  
 Specifies the ActiveX controls currently registered in the system. Select an ActiveX control from this list to display its interfaces in the **Interfaces** list. See [MFC ActiveX Controls: Distributing ActiveX Controls](../vs140/MFC-ActiveX-Controls--Distributing-ActiveX-Controls.md) for more information about registering ActiveX controls.  
...
## See Also  
 [Adding a Class from an ActiveX Control](../vs140/Adding-a-Class-from-an-ActiveX-Control--Visual-C---.md)   
