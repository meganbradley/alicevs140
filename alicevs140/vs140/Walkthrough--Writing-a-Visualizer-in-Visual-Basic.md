...
2.  Change the name from Class1.vb to something meaningful, such as DebuggerSide.vb.  
    ...
    > [!NOTE]
    >  [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)] automatically changes the class declaration in DebuggerSide.vb to match the new file name.  
...
2.  Edit the name from Module1.vb to something appropriate, such as **TestConsole.vb**.  
     ...
     Notice that [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)] automatically changes the class declaration in TestConsole.vb to match the new file name.  
...
## See Also  
 [Visualizer Architecture](../Topic/Visualizer%20Architecture.md)   
