...
-   [Build an app for Android, iOS, and Windows (.NET Framework)](#NET)  
    ...
    -   [Target Android, iOS, and Windows from a single code base](../vs140/Cross-Platform-Mobile-Development-in-Visual-Studio.md#AndroidHTML)  
  
    -   [Target Windows 10 devices](../vs140/Cross-Platform-Mobile-Development-in-Visual-Studio.md#WindowsHTML)  
  
-   [Build an app for Android, iOS, and Windows (HTML/JavaScript)](#HTML)  
  
-   [Build an app for Android and Windows (C++)](#CPP)  
  
-   [Build a game for Android, iOS, and Windows by using Visual Studio Tools for Unity](#Unity)  
  
##  <a name="NET"></a> Build an app for Android, iOS, and Windows (.NET Framework)  
 ![Devices](../vs140/media/HomeDevices.png "HomeDevices")  
...
|[Get started with Xamarin in Visual Studio](../vs140/Visual-Studio-and-Xamarin.md) (MSDN Library)|  
|[Learn about Visual Studio Application Lifecycle Management (ALM) with Xamarin Apps](../vs140/Application-Lifecycle-Management--ALM--with-Xamarin-apps.md) (MSDN Library)|  
...
####  <a name="ShareHTML"></a> Share code between Android, iOS, and Windows apps  
 ...
 ![Share code between Windows, iOs, and Android UI's](../vs140/media/ShareCode.png "ShareCode")  
...
###  <a name="WindowsHTML"></a> Target Windows 10 devices  
 ![Windows Devices](../vs140/media/WindowsDevices.png "WindowsDevices")  
...
|[Migrate apps to the Universal Windows Platform (UWP)](../vs140/Migrate-apps-to-the-Universal-Windows-Platform--UWP-.md)|  
...
##  <a name="HTML"></a> Build an app for Android, iOS, and Windows (HTML/JavaScript)  
 ...
 ![Multi&#45;Device Hybrid Apps](../vs140/media/MultiDeviceHybridApps.png "MultiDeviceHybridApps")  
...
##  <a name="CPP"></a> Build an app for Android and Windows (C++)  
 ![Use C&#43;&#43; to build for Android, iOS, and Windows](../vs140/media/Cross_Plat_CPP_Intro_Image.png "Cross_Plat_CPP_Intro_Image")  
 ...
 ![Native activity project template](../vs140/media/Cross-Plat_CPP_Native.png "Cross-Plat_CPP_Native")  
 ...
 You can also build an app that targets the full breadth of Windows 10 devices by using C++ and a universal Windows app project template. Read more about this in the [Target Windows devices](#WindowsHTML) section that appears earlier in this topic.  
  
 You can share C++ code between Android and Windows by creating a static or dynamic shared library.  
  
 ![Static and dynamic shared libraries](../vs140/media/Cross_Plat_CPP_Libraries.png "Cross_Plat_CPP_Libraries")  
...
##  <a name="Unity"></a> Build a cross-platform game for Android, iOS, and Windows by using Visual Studio tools for Unity  
 ...
 ![VSTU development environment](../vs140/media/VSTU_Overview.png "VSTU_Overview")  
...
|[Read more about Visual Studio Tools for Unity](../vs140/Visual-Studio-Tools-for-Unity.md) (MSDN Library)|  
|[Start using Visual Studio Tools for Unity](../vs140/Getting-Started-with-Visual-Studio-Tools-for-Unity.md) (MSDN Library)|  
...
## See Also  
 ...
 [Application Insights](../vs140/Application-Insights-for-Visual-Studio-Online.md)