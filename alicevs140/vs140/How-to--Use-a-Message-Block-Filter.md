...
This document demonstrates how to use a filter function to enable an asynchronous message block to accept or reject a message on the basis of the payload of that message.  
 ...
 When you create a message block object such as a [concurrency::unbounded_buffer](../vs140/unbounded_buffer-Class.md), a [concurrency::call](../vs140/call-Class.md), or a [concurrency::transformer](../vs140/transformer-Class.md), you can supply a *filter function* that determines whether the message block accepts or rejects a message. A filter function is a useful way to guarantee that a message block receives only certain values.  
