...
#### Example: Manifest Designer declarations  
 ...
 ![Manifest Designer error declaration anti&#45;pattern](../vs140/media/ManifestDesignererrordeclarationsanti-pattern.png "ManifestDesignererrordeclarationsanti-pattern")  
...
#### Anti-pattern  
 ...
 ![Explanatory text anti&#45;pattern &#45; incorrect](../vs140/media/Incorrectuseofmultipleclicks.png "Incorrectuseofmultipleclicks")  
...
#### Alternatives  
 ...
 ![Explanatory text anti&#45;pattern &#45; correct](../vs140/media/Explanatorytextanti-pattern-correct.png "Explanatorytextanti-pattern-correct")  
...
### Using command bars for settings  
 ![Command bar anti&#45;pattern &#45; Figure A](../vs140/media/Commandbaranti-pattern-FigureA.png "Commandbaranti-pattern-FigureA")  
 ...
 **Figure A** represents this anti-pattern: putting a setting underneath a command button that applies to more than just the command. In this sketch, there are commands besides Start Debugging — like View in Browser, Start Without Debugging, and Step Into — that will respect the selected setting.  
 ...
 ![Command bar anti&#45;pattern &#45; Figure B](../vs140/media/Commandbaranti-pattern-FigureB.png "Commandbaranti-pattern-FigureB")  
 ...
 **Figure B: Better, but still a command bar anti-pattern**  
 ...
 ![Command bar anti&#45;pattern &#45; Figure C](../vs140/media/Commandbaranti-pattern-FigureC.png "Commandbaranti-pattern-FigureC")  
 ...
 **Bad:**  
 ...
 ![Underlining anti&#45;pattern in group labels](../vs140/media/0102-g_GroupLabelIncorrect.png "0102-g_GroupLabelIncorrect")  
  
 **Underlined text that is not a hyperlink is a Visual Studio anti-pattern.**  
  
 **Good:**  
  
 ![Underlining anti&#45;pattern in group labels &#40;correct&#41;](../vs140/media/0102-h_GroupLabelCorrect.png "0102-h_GroupLabelCorrect")  
...
#### Clicking on a check box results in a pop-up dialog  
 ...
 ![Checkbox pop&#45;up anti&#45;pattern](../vs140/media/0102-i_CheckboxPopup.png "0102-i_CheckboxPopup")  
...
2.  "Learn more" is not the appropriate text for a link to a conceptual topic. The user's goal is not to learn more, it is to understand the ramifications of their choice.  
 ...
 ![Hyperlink anti&#45;patterns](../vs140/media/0102-j_HyperlinkIncorrect.png "0102-j_HyperlinkIncorrect")  
