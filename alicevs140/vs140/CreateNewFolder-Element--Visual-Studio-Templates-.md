...
## Remarks  
 ...
 The value specified in the `CreateNewFolder` element is only honored by [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)] if the underlying project system supports it.  
