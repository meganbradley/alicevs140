...
ms.tgt_pltfrm: na
ms.topic: article
H1: Quick Start: Code Analysis for C/C++
...
-   [Configure rule sets for a project](../vs140/Quick-Start--Code-Analysis-for-C-C--.md#BKMK_ConfigureRuleSets)  
  
-   [Run code analysis](../vs140/Quick-Start--Code-Analysis-for-C-C--.md#BKMK_Run)  
  
-   [Analyze and resolve code analysis warnings](../vs140/Quick-Start--Code-Analysis-for-C-C--.md#BKMK_Analyze)  
  
-   [Suppressing code analysis warnings](../vs140/Quick-Start--Code-Analysis-for-C-C--.md#BKMK_Suppress)  
  
-   [Creating work items for code analysis warnings](../vs140/Quick-Start--Code-Analysis-for-C-C--.md#BKMK_Creating_work_items_for_code_analysis_warnings)  
  
-   [Searching and filtering code analysis results](../vs140/Quick-Start--Code-Analysis-for-C-C--.md#BKMK_Search)  
