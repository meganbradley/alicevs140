...
---
# MASM Macros
In order to simplify the use of the [Raw Pseudo Operations](../vs140/Raw-Pseudo-Operations.md), there are a set of macros, defined in ksamd64.inc, which can be used to create typical procedure prologues and epilogues.  
