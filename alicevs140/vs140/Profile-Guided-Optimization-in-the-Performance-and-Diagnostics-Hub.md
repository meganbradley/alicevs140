...
2.  In the **Configuration Manager** dialog box, choose the **Active Solution Configuration** drop-down button and select **Release**. Choose the **Close** button.  
 ...
 ![PGO in the Performance and Diagnostics Hub](../vs140/media/PGOFig0Hub.png "PGOFig0Hub")  
  
 In **Available Tools**, select the **Profile Guided Optimization** check box. Choose the **Start** button to start the PGO plug-in.  
  
 ![PGO introduction page](../vs140/media/PGOFig1Start.png "PGOFig1Start")  
 ...
 ![PGO instrumentation page](../vs140/media/PGOFig2Instrument.png "PGOFig2Instrument")  
 ...
 ![PGO instrumented build page](../vs140/media/PGOFig3Build.PNG "PGOFig3Build")  
 ...
 ![PGO training page](../vs140/media/PGOFig4Training.PNG "PGOFig4Training")  
 ...
 ![PGO analysis page](../vs140/media/PGOFig5Analyze.png "PGOFig5Analyze")  
 ...
 ![PGO data file in Solution Explorer](../vs140/media/PGOFig6Data.png "PGOFig6Data")  
 ...
 ![PGO output diagnostics](../vs140/media/PGOFig7Diagnostics.png "PGOFig7Diagnostics")  
