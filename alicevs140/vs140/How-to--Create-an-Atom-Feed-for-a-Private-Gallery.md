...
You can create an Atom (RSS) feed to an intranet location that contains extensions and add the feed to **Extensions and Updates** as a private gallery. For more information, see [Private Galleries](../vs140/Private-Galleries.md).  
...
-   An atom.xml file that makes the extensions available as a private gallery. For information about how to connect the atom.xml file to **Extensions and Updates**, see [Private Galleries](../vs140/Private-Galleries.md).  
