...
##  <a name="_core_enabling_docking_for_a_toolbar"></a> Enabling Docking for a Toolbar  
 ...
 If the effect you want is a permanently floating toolbar, call `EnableDocking` with a parameter of 0. Then call [CFrameWnd::FloatControlBar](../vs140/CFrameWnd--FloatControlBar.md). The toolbar remains floating, permanently unable to dock anywhere.  
