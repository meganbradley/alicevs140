...
```  
 ...
 In the [Select Clause (Visual Basic)](../Topic/Select%20Clause%20\(Visual%20Basic\).md) clause, an object initializer is used to instantiate each new `Student` object by using the data from the two sources.  
