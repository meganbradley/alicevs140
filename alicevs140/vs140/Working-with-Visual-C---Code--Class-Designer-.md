...
> [!NOTE]
>  This is not the same as the UML class diagram, which you can create in a Modeling Project. For more information, see [UML Class Diagram](../vs140/UML-Class-Diagrams--Reference.md).  
...
## See Also  
 ...
 [Working with Classes in Class Designer (Visual C++)](../vs140/Visual-C---Classes-in-Class-Designer.md)   
 [Working with Structures in Class Designer (Visual C++)](../vs140/Visual-C---Structures-in-Class-Designer.md)   
 [Working with Enumerations in Class Designer (Visual C++)](../vs140/Visual-C---Enumerations-in-Class-Designer.md)   
 [Working with Typedefs in Class Designer (Visual C++)](../vs140/Visual-C---Typedefs-in-Class-Designer.md)