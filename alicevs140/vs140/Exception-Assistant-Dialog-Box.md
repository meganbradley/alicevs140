...
## Task List  
 ...
 For information about how to enable or disable the Exception Assistant, see [General, Debugging, Options Dialog Box](../vs140/General--Debugging--Options-Dialog-Box.md).  
