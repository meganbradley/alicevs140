...
-   [Optimizations](#_core_optimizations)  
 ...
 See the [/GZ (Catch Release-Build Errors in Debug Build)](../Topic/-GZ%20\(Enable%20Stack%20Frame%20Run-Time%20Error%20Checking\).md) compiler option for information on how to catch release build errors in debug builds.  
...
##  <a name="_core_heap_layout"></a> Heap Layout  
 ...
 For more information, see [Check for Memory Overwrite](../vs140/Checking-for-Memory-Overwrites.md) and [Use the Debug Build To Check for Memory Overwrite](../vs140/Using-the-Debug-Build-to-Check-for-Memory-Overwrite.md).  
  
##  <a name="_core_compilation"></a> Compilation  
 Many of the MFC macros and much of the MFC implementation changes when you build for release. In particular, the ASSERT macro evaluates to nothing in a release build, so none of the code found in ASSERTs will be executed. For more information, see [Examine ASSERT Statements](../vs140/Using-VERIFY-Instead-of-ASSERT.md).  
...
##  <a name="_core_optimizations"></a> Optimizations  
 Depending on the nature of certain segments of code, the optimizing compiler might generate unexpected code. This is the least likely cause of release build problems, but it does arise on occasion. For a solution, see [Optimizing Your Code](../vs140/Optimizing-Your-Code.md).  
