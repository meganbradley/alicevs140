...
> [!NOTE]
>  To use VSIX projects, you must install the Visual Studio SDK. For more information about the Visual Studio SDK, see [Visual Studio SDK](../vs140/Visual-Studio-SDK.md).  
...
## Packaging an Extension in an Empty VSIX Project  
 You can package an existing extension, or an extension that does not already have VSIX support, by wrapping it in an empty VSIX project. The extension to be wrapped must be of a type that is supported by the [VSIX schema](../Topic/VSIX%20Extension%20Schema%202.0%20Reference.md).  
...
8.  Build the solution.  
     ...
     [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)] builds a .vsix file that contains a VSIX manifest file, a [Content_Types].xml file, and all of the extension assets that you added to the project.  
  
## See Also  
 [VSX Schema for Extensions](../Topic/VSIX%20Extension%20Schema%202.0%20Reference.md)   
 [Managing Visual Studio Extensions](../vs140/Finding-and-Using-Visual-Studio-Extensions.md)