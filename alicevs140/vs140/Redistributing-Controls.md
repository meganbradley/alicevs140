...
Visual C++ .NET supplies ActiveX controls that you can use in applications. You can then redistribute the controls along with the applications. In the **Insert ActiveX Control** dialog box, highlighting a control will display its .ocx or .dll file.  
 ...
 [MFC ActiveX Controls: Distributing ActiveX Controls](../vs140/MFC-ActiveX-Controls--Distributing-ActiveX-Controls.md) explains how to install and register redistributable ActiveX controls.  
 ...
 [Redistributing Database Support Files](../vs140/Redistributing-Database-Support-Files.md) discusses how to redistribute support files for the database technologies found in the Microsoft Data Access SDK.  
...
## See Also  
 ...
 [MFC ActiveX Controls: Distributing ActiveX Controls](../vs140/MFC-ActiveX-Controls--Distributing-ActiveX-Controls.md)