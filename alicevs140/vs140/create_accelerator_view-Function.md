...
#### Parameters  
 ...
 `_Qmode`  
 The [queuing_mode](../vs140/queuing_mode-Enumeration.md) to be used for the newly created accelerator_view. This parameter has a default value of `queuing_mode_automatic`.  
