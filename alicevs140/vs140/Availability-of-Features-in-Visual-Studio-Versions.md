...
||Visual Studio 2010<br /><br /> and<br /><br /> Visual Studio 2010 SP1|[!INCLUDE[vs_dev11_long](../vs140/includes/vs_dev11_long_md.md)]|[!INCLUDE[vs_dev12](../vs140/includes/vs_dev12_md.md)]|  
|-|-----------------------------------------------------------|-------------------------------------------------------------------|--------------------------------------------------------------|  
...
4.  Visual Studio Tools for Office (VSTO) compatibility and Add-in functionality:  
    ...
    ||Visual Studio 2010|[!INCLUDE[vs_dev11_long](../vs140/includes/vs_dev11_long_md.md)]|[!INCLUDE[vs_dev12](../vs140/includes/vs_dev12_md.md)]|  
    |-|------------------------|-------------------------------------------------------------------|--------------------------------------------------------------|  
