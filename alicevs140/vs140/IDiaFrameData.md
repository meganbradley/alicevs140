...
## Example  
 This example prints out the properties of an `IDiaFrameData` object. See the [IDiaEnumFrameData](../vs140/IDiaEnumFrameData.md) interface for an example of how the `IDiaFrameData` interface is obtained.  
