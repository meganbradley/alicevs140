...
The Concurrency Visualizer can display EventSource events as markers, and you can control how the markers are displayed. To view the EventSource markers, register the ETW provider GUID by using the [Advanced Settings](../Topic/Advanced%20Settings%20Dialog%20Box%20\(Concurrency%20Visualizer\).md) dialog box. The Concurrency Visualizer has default conventions to represent EventSource events as [Flag Markers](../vs140/Flag-Markers.md), [Span Markers](../vs140/Span-Markers.md), and [Message Markers](../vs140/Message-Markers.md). You can customize how EventSource events are displayed by adding custom fields to the events. For more information about markers, see [Concurrency Visualizer Markers](../vs140/Concurrency-Visualizer-Markers.md). For more information about EventSource events, see <xref:System.Diagnostics.Tracing?qualifyHint=False>.  
