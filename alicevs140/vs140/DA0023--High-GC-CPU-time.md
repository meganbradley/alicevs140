...
> [!NOTE]
>  When the proportion of time that is spent in garbage collection is excessive compared with the total application processing time, the [DA0024: Excessive GC CPU Time](../vs140/DA0024--Excessive-GC-CPU-Time.md) warning fires instead of this rule.  
