...
## Remarks  
 The member function returns `(float)`[size](../vs140/hash_map--size--STL-CLR-.md)`() /` [bucket_count](../vs140/hash_map--bucket_count--STL-CLR-.md)`()`. You use it to determine the average bucket size.  
