...
|Name|Description|  
|----------|-----------------|  
|[CComSafeArray::Add](../vs140/CComSafeArray--Add.md)|Adds one or more elements, or a **SAFEARRAY** structure, to a `CComSafeArray`.|  
|[CComSafeArray::Attach](../vs140/CComSafeArray--Attach.md)|Attaches a **SAFEARRAY** structure to a `CComSafeArray` object.|  
|[CComSafeArray::CopyFrom](../vs140/CComSafeArray--CopyFrom.md)|Copies the contents of a **SAFEARRAY** structure into the `CComSafeArray` object.|  
|[CComSafeArray::CopyTo](../vs140/CComSafeArray--CopyTo.md)|Creates a copy of the `CComSafeArray` object.|  
|[CComSafeArray::Create](../vs140/CComSafeArray--Create.md)|Creates a `CComSafeArray` object.|  
|[CComSafeArray::Destroy](../vs140/CComSafeArray--Destroy.md)|Destroys a `CComSafeArray` object.|  
|[CComSafeArray::Detach](../vs140/CComSafeArray--Detach.md)|Detaches a **SAFEARRAY** from a `CComSafeArray` object.|  
...
|[CComSafeArray::GetSafeArrayPtr](../vs140/CComSafeArray--GetSafeArrayPtr.md)|Returns the address of the `m_psa` data member.|  
...
|[CComSafeArray::IsSizable](../vs140/CComSafeArray--IsSizable.md)|Tests if a `CComSafeArray` object can be resized.|  
...
|[CComSafeArray::Resize](../vs140/CComSafeArray--Resize.md)|Resizes a `CComSafeArray` object.|  
...
## Remarks  
 ...
 Use [CComSafeArray::Create](../vs140/CComSafeArray--Create.md) to create a `CComSafeArray` object, and [CComSafeArray::Destroy](../vs140/CComSafeArray--Destroy.md) to delete it.  
