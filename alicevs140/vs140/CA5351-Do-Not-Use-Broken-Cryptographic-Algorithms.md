...
-   <xref:System.Security.Cryptography.DES?qualifyHint=False> encryption contains a small key size, which could be brute-forced in less than a day.  
  
-   <xref:System.Security.Cryptography.RC2?qualifyHint=False> encryption is susceptible to a related-key attack, where the attacker finds mathematical relationships between all key values.  
...
-   For MD5, use hashes in the [SHA-2](https://msdn.microsoft.com/en-us/library/windows/desktop/aa382459.aspx) family (e.g. <xref:System.Security.Cryptography.SHA512?qualifyHint=False>, <xref:System.Security.Cryptography.SHA384?qualifyHint=False>, <xref:System.Security.Cryptography.SHA256?qualifyHint=False>).  
  
-   For DES and RC2, use <xref:System.Security.Cryptography.Aes?qualifyHint=False> encryption.  
