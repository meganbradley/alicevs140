...
##  <a name="custom"></a> Default vs. Custom Setup  
 ...
 ![Visual Studio 2015 Setup Dialog](../vs140/media/VS2015_Setup_screen.png "VS2015_Setup_screen")  
...
> [!IMPORTANT]
>  You need administrator credentials to install [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)]. However, you don't need them to use [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)] after you install it.  
