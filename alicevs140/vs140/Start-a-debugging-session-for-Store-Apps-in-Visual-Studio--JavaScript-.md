...
> [!NOTE]
>  For apps written in XAML and Visual C#, Visual C++, or Visual Basic, see [Start a debugging session for a Store app in Visual Studio (VB, C#, C++ and XAML)](../vs140/Start-a-debugging-session-for-a-Store-app-in-Visual-Studio--VB--C#--C---and-XAML-.md)  
