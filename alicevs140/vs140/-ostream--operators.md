...
### Remarks  
 The `basic_ostream` class also defines several insertion operators. For more information, see [basic_ostream::operator<<](../vs140/basic_ostream-Class.md#basic_ostream__operator_lt__lt_).  
...
```  
 ...
 determines the length N = `traits_type::`[length](../vs140/char_traits-Struct.md#char_traits__length)( `_Str`) of the sequence beginning at `_Str`, and inserts the sequence. If N < `_Ostr.`[width](../vs140/ios_base-Class.md#ios_base__width), then the function also inserts a repetition of `_Ostr.``width` - N fill characters. The repetition precedes the sequence if ( `_Ostr`. [flags](../vs140/ios_base-Class.md#ios_base__flags) & `adjustfield` != [left](../vs140/-ios--functions.md#left). Otherwise, the repetition follows the sequence. The function returns `_Ostr`.  
...
```  
 ...
 except that each element `_Ch` of the sequence beginning at `_Str` is converted to an object of type `Elem` by calling `_Ostr.`[put](../vs140/basic_ostream-Class.md#basic_ostream__put)( `_Ostr.`[widen](../vs140/basic_ios-Class.md#basic_ios__widen)( `_Ch`)).  
...
### Example  
  See [flush](../vs140/-ostream--functions.md#flush) for an example using `operator<<`.  
