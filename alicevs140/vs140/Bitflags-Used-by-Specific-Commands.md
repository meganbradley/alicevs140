...
## PopulateList Flag  
 This flag is used by the [SccPopulateList Function](../vs140/SccPopulateList-Function.md) in the `fOptions` parameter.  
...
## PopulateDirList Flags  
 These flags are used by the [SccPopulateDirList Function](../vs140/SccPopulateDirList-Function.md) in the `fOptions` parameter.  
...
## OpenProject Flags  
 These flags are used by the [SccOpenProject Function](../vs140/SccOpenProject-Function.md) in the `dwFlags` parameter.  
...
## nOption Values  
 These flags are used by the [SccSetOption Function](../vs140/SccSetOption-Function.md) in the `nOption` parameter.  
...
## dwVal Bitflags  
 These flags are used by the [SccSetOption Function](../vs140/SccSetOption-Function.md) in the `dwVal` parameter.  
