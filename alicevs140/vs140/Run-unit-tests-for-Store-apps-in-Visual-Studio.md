...
>   
>  For more information, see [Verifying Code by Using Unit Tests](../Topic/Unit%20Test%20Your%20Code.md) in the MSDN Library.  
...
|||  
|-|-|  
|![Test Explorer group button](../vs140/media/UTE_GroupBy_btn.png "UTE_GroupBy_btn")|To group your tests by the time it takes to execute them, open the **Group By** list and choose **Duration**. Choose **Test Outcome** to switch to the original grouping.|  
...
2.  In Test Explorer, select the test methods and then choose **Debug Selected Tests** on the shortcut menu.  
 ...
 For more information, about the debugger, see [Debugging in Visual Studio](../vs140/Debugging-in-Visual-Studio.md).