...
## Example  
 The following example shows how to implement this method for a simple `CProgram` object that exposes the [IDebugProgramNode2](../vs140/IDebugProgramNode2.md) interface. This example ignores the `dwHostNameType` parameter and returns only the name of the program as taken from the base name of the module's file path.  
