...
## Remarks  
 ...
 initializes the controlled sequence with the sequence `[``right``.`[begin](../vs140/map--begin--STL-CLR-.md)`(),` `right``.`[end](../vs140/map--end--STL-CLR-.md)`())`, with the default ordering predicate. You use it to specify an initial controlled sequence that is a copy of the sequence controlled by the map object `right`, with the default ordering predicate.  
...
## See Also  
 ...
 [generic_container](../vs140/map--generic_container--STL-CLR-.md)   
