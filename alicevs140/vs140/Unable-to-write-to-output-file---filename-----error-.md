...
2.  If the error continues, save your work and restart [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)].  
  
3.  If the error continues, restart the computer.  
  
4.  If the error recurs, reinstall [!INCLUDE[vbprvb](../vs140/includes/vbprvb_md.md)].  
