...
-   **Widening.** The `Decimal` data type widens to `Single` or `Double`. This means you can convert `Decimal` to either of these types without encountering a <xref:System.OverflowException?qualifyHint=True> error.  
...
-   **Framework Type.** The corresponding type in the .NET Framework is the <xref:System.Decimal?qualifyHint=True> structure.  
...
## See Also  
 <xref:System.Decimal?qualifyHint=True>   
 <xref:System.Decimal.#ctor?qualifyHint=True>   
 <xref:System.Math.Round?qualifyHint=True>   
 [Data Types](../Topic/Data%20Type%20Summary%20\(Visual%20Basic\).md)   
 [Single Data Type (Visual Basic)](../Topic/Single%20Data%20Type%20\(Visual%20Basic\).md)   
 [Double Data Type (Visual Basic)](../Topic/Double%20Data%20Type%20\(Visual%20Basic\).md)   
