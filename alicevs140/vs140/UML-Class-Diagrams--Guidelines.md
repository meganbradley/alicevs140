...
-   To clarify the glossary of terms used for communication between the application and its users, and in descriptions of the users' needs. See [Clarifying User Requirements](../vs140/Model-user-requirements.md).  
...
### Relationship to Other Diagrams  
 ...
 See [UML Activity Diagrams: Guidelines](../vs140/UML-Activity-Diagrams--Guidelines.md).  
 ...
 See [UML Sequence Diagrams: Guidelines](../vs140/UML-Sequence-Diagrams--Guidelines.md).  
  
 Component diagram  
  
 Component interfaces, listing their operations.  
  
 See [UML Component Diagrams: Guidelines](../vs140/UML-Component-Diagrams--Guidelines.md).  
  
 Use case diagram  
  
 Types mentioned in descriptions of the goals and steps of a use case.  
  
 See [UML Use Case Diagrams: Guidelines](../vs140/UML-Use-Case-Diagrams--Guidelines.md).  
  
##  <a name="BasicSteps"></a> Basic Steps for Drawing Class Diagrams  
 For reference information about the elements on UML class diagrams, see [UML Class Diagrams: Overview](../vs140/UML-Class-Diagrams--Reference.md).  
...
##  <a name="UsingTypes"></a> Using Classes, Interfaces, and Enumerations  
 ...
 ![A class, an enumeration, and an interface](../vs140/media/UML_ClassGuideTypes.png "UML_ClassGuideTypes")  
...
### Getting Types from Other Diagrams  
 ...
 See [Component Diagram: Guidelines](../vs140/UML-Component-Diagrams--Guidelines.md).  
 ...
 To create a class from a lifeline, open the shortcut menu for the lifeline, and then choose **Create Class** or **Create Interface**. See [UML Sequence Diagram: Guidelines](../vs140/UML-Sequence-Diagrams--Guidelines.md).  
...
-   **Is Navigable**. If true for only one role, an arrow appears in the navigable direction. You can use this to indicate navigability of links and database relations in the software.  
 ...
 For the full details of these and other properties, see [Properties of Associations in UML Class Diagrams](../vs140/Properties-of-associations-on-UML-class-diagrams.md).  
...
### Attributes and Associations  
 ...
 ![Equivalent association and attributes](../vs140/media/UML_ClassGuideAttrib.png "UML_ClassGuideAttrib")  
...
### Realization  
 ...
 ![Realization shown with conector and lollipop](../vs140/media/UML_ClassGuideRealize.png "UML_ClassGuideRealize")  
...
##  <a name="Templates"></a> Template Types  
 ...
 ![Template class with two parameters](../vs140/media/UML_ClassGuideTemplate1.png "UML_ClassGuideTemplate1")  
...
9. Add attributes and operations to the template type as you would do for other classes.  
 ...
 ![A  class bound from the Dictionary template](../vs140/media/UML_ClassGuideTemplate2.png "UML_ClassGuideTemplate2")  
...
##  <a name="Packages"></a> Packages  
 ...
 See [Defining Namespaces with Packages](../vs140/Define-packages-and-namespaces.md).  
...
-   Open the shortcut menu for the diagram or an element, choose **Generate Code**, and then set the necessary properties.  
     ...
     For more information about how to set these properties and customize the provided templates, see [How to: Generate Code from UML Class Diagrams](../Topic/Generate%20code%20from%20UML%20class%20diagrams.md).  
