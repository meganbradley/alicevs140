...
The [TryCast](../Topic/TryCast%20Operator%20\(Visual%20Basic\).md) operator is used with a type parameter operand that is not guaranteed to be a reference type.  
