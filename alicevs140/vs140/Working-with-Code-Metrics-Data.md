...
The **Code Metrics Results** window displays the data that is generated by the code metrics analysis. For more information about code metrics data values, see [Code Metrics Values](../vs140/Code-Metrics-Values.md).  
  
 This topic contains the following sections:  
  
-   [Code Metrics Result Window](../vs140/Working-with-Code-Metrics-Data.md#BKMK_CodeMetricsResultsWindow)  
  
-   [Displaying Code Metric Results](../vs140/Working-with-Code-Metrics-Data.md#BKMK_DisplayingCodeMetricsResults)  
  
-   [Filtering Code Metric Results](../vs140/Working-with-Code-Metrics-Data.md#BKMK_FilteringCodeMetricsResults)  
  
-   [Adding, Removing, and Rearranging Data Columns](../vs140/Working-with-Code-Metrics-Data.md#BKMK_AddingRemovingandRearrangingDataColumns)  
  
-   [Copying Data to the Clipboard or Excel](../vs140/Working-with-Code-Metrics-Data.md#BKMK_Copying_Data_to_the_Clipboard_or_Excel)  
  
-   [Creating a Work Item Based on Code Metric Results](../vs140/Working-with-Code-Metrics-Data.md#BKMK_Creating_a_Work_Item_Based_on_Code_Metric_Results)  
...
##  <a name="BKMK_Creating_a_Work_Item_Based_on_Code_Metric_Results"></a> Creating a Work Item Based on Code Metric Results  
 You can create a [!INCLUDE[esprfound](../vs140/includes/esprfound_md.md)] work item that is based on results in the **Code Metric Results** window. When the work item is created, [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)] automatically enters a title in the **Title** field and code metrics data under the **History** tab.  
  
 For more information about how to create work items, see [Create a work item &#91;redirected&#93;](assetId:///24b2e064-16ac-4bf0-8de4-98a1f48b8c4b).  
...
## See Also  
 ...
 [How to: Generate Code Metrics Result Data](../vs140/How-to--Generate-Code-Metrics-Data.md)