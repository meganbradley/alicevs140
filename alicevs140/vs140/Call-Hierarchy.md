...
## Using Call Hierarchy  
 ...
 ![Call Hierarchy with one node open](../vs140/media/OneNode.png "OneNode")  
...
-   If you expand the **Calls From** node, all members that are called by the selected member are displayed.  
 ...
 ![Call Hierarchy Multiple Nodes Open](../vs140/media/MultipleNodes.png "MultipleNodes")  
Call Hierarchy window  
...
-   The **Code Definition Window**, if open, displays the code for the selected member. This window is available in C# and C++. For more information about this window, see [Viewing the Structure of Code](../vs140/Viewing-the-Structure-of-Code.md).  
