...
-   Registering control object factories with the OLE system registry.  
 ...
 For more information about object creation, see the articles [Data Objects and Data Sources (OLE)](../vs140/Data-Objects-and-Data-Sources--OLE-.md) and [Data Objects and Data Sources: Creation and Destruction](../vs140/Data-Objects-and-Data-Sources--Creation-and-Destruction.md). For more about registration, see the article [Registration](../vs140/Registration.md).  
...
### Remarks  
 This function is usually called by [CWinApp::InitInstance](../vs140/CWinApp-Class.md#cwinapp__initinstance) when the application is launched.  
...
### Remarks  
 The framework calls this function automatically before the application terminates. If necessary, call it from an override of [CWinApp::ExitInstance](../vs140/CWinApp-Class.md#cwinapp__exitinstance).  
...
```  
void UpdateRegistry(    LPCTSTR lpszProgID = NULL ); virtual BOOL UpdateRegistry(    BOOL  bRegister );  
...
-   **UpdateRegistry(**  `lpszProgID`  **)** Registers this object factory with the OLE system registry. This function is usually called by [CWinApp::InitInstance](../vs140/CWinApp-Class.md#cwinapp__initinstance) when the application is launched.  
