 ...
 **Min value**  
 Available only when the variable type is **BOOL**, `int`, **UINT**, **long**, `DWORD`, **float**, **double**, **BYTE**, **short**, [COLECurrency](../vs140/COleCurrency-Class.md) or [CTime](../Topic/CTime%20Class.md). Indicates the lowest value acceptable for a scale or date range.  
