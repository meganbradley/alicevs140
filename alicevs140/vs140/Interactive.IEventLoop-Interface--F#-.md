...
|Member|Description|  
|------------|-----------------|  
|[Invoke](../vs140/IEventLoop.Invoke--T--Method--F#-.md)|Requests that the given operation be run synchronously on the event loop.|  
|[Run](../vs140/IEventLoop.Run-Method--F#-.md)|Runs the event loop. A return of `true` indicates that the event loop was restarted.|  
|[ScheduleRestart](../vs140/IEventLoop.ScheduleRestart-Method--F#-.md)|Schedule a restart for the event loop.|  
