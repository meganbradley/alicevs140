...
> [!NOTE]
>  For a list of decimal language values, see [Wizard Support for Other Languages](../vs140/Wizard-Support-for-Other-Languages.md).  
  
 The language ID is specified as a custom parameter in the .[vsz file](assetId:///3af817d8-8179-416f-bf54-0b70a007ca77) in the paths where the [HTML files](../vs140/HTML-Files.md) and the [Template files](../vs140/Template-Files.md) reside.  
...
## See Also  
 ...
 [Custom Parameters in the Wizard .Vsz File](../vs140/Custom-Parameters-in-the-Wizard-.Vsz-File.md)