...
|||  
|-|-|  
|**Debug my application with IntelliTrace:**<br /><br /> -   Show me past events.<br />-   Show me call information with past events.<br />-   Save my IntelliTrace session.<br />-   Control the data that IntelliTrace collects.|-   [Walkthrough: Using IntelliTrace](../Topic/Walkthrough:%20Using%20IntelliTrace.md)<br />     [Record Execution History to Debug Your Application with IntelliTrace in Visual Studio](../vs140/IntelliTrace-Features.md)<br />-   [Configure IntelliTrace](assetId:///7657ecab-e07e-4b1b-872d-f05d966be37e)<br />-   [Historical Debugging](../vs140/Historical-Debugging.md)|  
|**Collect IntelliTrace data during a test session in Test Manager**|-   [Collect more diagnostic data in manual tests](assetId:///bb5a2cc0-84f5-4dfe-9560-ca3d313aefd2)|  
|**Collect IntelliTrace data from deployed applications**|-   [Collect IntelliTrace Data in Production](../vs140/Using-the-IntelliTrace-stand-alone-collector.md)|  
|**Start debugging from an IntelliTrace log file (.iTrace file).**|-   [Start Debugging from IntelliTrace Recordings](../vs140/Using-saved-IntelliTrace-data.md)|  
  
##  <a name="IntelliTraceSupport"></a> What apps can I debug with IntelliTrace?  
  
|||  
|-|-|  
|**Supported**|-   Visual Basic and Visual C# applications that use .NET Framework 2.0 or higher versions.<br />     You can debug most applications, including ASP.NET, Microsoft Azure, Windows Forms, WCF, WPF, Windows Workflow, SharePoint 2010, SharePoint 2013, and 64-bit apps.<br />     To debug SharePoint applications with IntelliTrace, see [Walkthrough: Debug a SharePoint Application Using IntelliTrace](assetId:///4bd80d2f-f680-4bf4-81c3-f14e8185f6a4).<br />     To debug Microsoft Azure apps with IntelliTrace, see [Debugging a Published Cloud Service with IntelliTrace and Visual Studio](http://go.microsoft.com/fwlink/?LinkID=262248).|  
|**Limited support**|-   F# apps on an experimental basis<br />-   Windows Store apps supported for events only|  
|**Not supported**|-   C++, other languages, and script<br />-   Windows Services, Silverlight, Xbox, or [!INCLUDE[winmobile](../vs140/includes/winmobile_md.md)] apps|  
...
-   ASP.NET web apps hosted on IIS, or SharePoint 2010 and SharePoint 2013 applications running in deployment when you use Microsoft Monitoring Agent, either alone or with System Center 2012. See [Monitor apps in deployment](../vs140/Using-the-IntelliTrace-stand-alone-collector.md) and [Monitoring with Microsoft Monitoring Agent](http://technet.microsoft.com/library/dn465153.aspx).  
...
-   Your application crashes on a test computer but runs successfully on a development computer.  
     ...
     You can collect IntelliTrace data from Microsoft Test Manager, save the data to an .iTrace file, and attach this file to a Team Foundation Server work item for later investigation. See [Collect more diagnostic data in manual tests](assetId:///bb5a2cc0-84f5-4dfe-9560-ca3d313aefd2) and [Start Debugging from IntelliTrace Recording Files](../vs140/Using-saved-IntelliTrace-data.md).  
...
-   A bug or crash happens in a deployed application.  
     ...
     This is useful when you want to diagnose problems with apps in deployment. See [Monitor apps in deployment](../vs140/Using-the-IntelliTrace-stand-alone-collector.md).  
...
-   **SharePoint 2010 and SharePoint 2013 application events**  
    ...
    -   [Monitor apps in deployment](../vs140/Using-the-IntelliTrace-stand-alone-collector.md)  
  
    -   [Start Debugging from IntelliTrace Recordings](../vs140/Using-saved-IntelliTrace-data.md)  
  
    -   [Walkthrough: Debug a SharePoint Application Using IntelliTrace](assetId:///4bd80d2f-f680-4bf4-81c3-f14e8185f6a4)  
...
## In this section  
 [Record Execution History to Debug Your Application with IntelliTrace in Visual Studio](../vs140/IntelliTrace-Features.md)  
  
 [Configure IntelliTrace](assetId:///7657ecab-e07e-4b1b-872d-f05d966be37e)  
  
 [Including Diagnostic Trace Data with Bugs that are Difficult to Reproduce](assetId:///944ae9af-5a55-4c58-b520-0108c03b3564)  
  
 [Diagnose problems in deployment](../vs140/Diagnose-problems-after-deployment.md)  
  
 [Start Debugging from IntelliTrace Recording Files](../vs140/Using-saved-IntelliTrace-data.md)  
