 ...
 **To give a unique name to existing controls**  
 ...
 ![Choose Name Interactive Elements from Tools menu](../vs140/media/CUIT_WindowsStoreProperty_Blend_1.png "CUIT_WindowsStoreProperty_Blend_1")  
 ...
 **To automatically give a unique name to controls that you create**  
 ...
 ![Set project to name interactive elements](../vs140/media/CUIT_WindowsStoreProeprty_Blend_2.png "CUIT_WindowsStoreProeprty_Blend_2")  
...
## See Also  
 [Testing Windows Store Applications with Coded UI Tests](../vs140/Test-Windows-Store-8.1-Apps-with-Coded-UI-Tests.md)