...
The walkthrough uses a C# application to demonstrate how to use the [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)] Profiling Tools APIs. You will use the profiler APIs to limit the amount of data that is collected during instrumentation profiling.  
 ...
 However, a greater level of detail means that more data is collected. You might find that instrumentation profiling creates large data files. Also, instrumentation is more likely to impact the performance of the application. For more information, see [Understanding Instrumented Data Values](../vs140/Understanding-Instrumentation-Data-Values.md) and [Understanding Sampling Data Values](../vs140/Understanding-Sampling-Data-Values.md)  
 ...
 For managed code, the profiler APIs are in the Microsoft.VisualStudio.Profiler.dll. This DLL is found in the Microsoft Visual Studio 9\Team Tools\Performance Tools directory. For more information, see <xref:Microsoft.VisualStudio.Profiler?qualifyHint=False>.  
...
1.  Open the [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)] IDE. On to the **Analyze** menu, point to **Profiler**, and then select **New Performance Session.**  
...
## See Also  
 ...
 [Command-Line Profiling Tools](../vs140/Using-the-Profiling-Tools-From-the-Command-Line.md)