...
|[choice::unlink_targets Method](#choice__unlink_targets_method)|Unlinks all targets from this                                         `choice` messaging block. (Overrides                                         [ISource::unlink_targets](../vs140/ISource-Class.md#isource__unlink_targets_method).)|  
