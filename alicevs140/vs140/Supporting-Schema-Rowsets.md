...
-   [GetSchemas](../vs140/IDBSchemaRowsetImpl--GetSchemas.md) returns a list of schema rowsets accessible by `IDBSchemaRowsetImpl::GetRowset` (inherited from interface).  
