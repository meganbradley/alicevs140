...
## Comparison Method  
 The behavior of the `Like` operator depends on the [Option Compare Statement](../Topic/Option%20Compare%20Statement.md). The default string comparison method for each source file is `Option Compare Binary`.  
