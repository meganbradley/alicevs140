...
Converts the argument to signed 32-bit integer ([int](../vs140/Core.int-Type-Abbreviation--F#-.md)). This is a direct conversion for all primitive numeric types. The operation requires an appropriate static conversion method on the input type.  
