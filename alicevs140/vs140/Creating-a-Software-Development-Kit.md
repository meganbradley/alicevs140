...
-   Platform SDKs are mandatory components for developing apps for a platform. For example, the [!INCLUDE[win81](../vs140/includes/win81_md.md)] SDK is required to develop [!INCLUDE[win8_appname_long](../vs140/includes/win8_appname_long_md.md)] apps.  
...
##  <a name="PlatformSDKs"></a> Platform SDKs  
 Platform SDKs are required to develop apps for a platform. For example, the [!INCLUDE[win81](../vs140/includes/win81_md.md)] SDK is required to develop apps for [!INCLUDE[win81](../vs140/includes/win81_md.md)].  
  
### Installation  
 All platform SDKs will be installed at HKLM\Software\Microsoft\Microsoft SDKs\\[TPI]\v[TPV]\\@InstallationFolder = [SDK root]. Accordingly, the [!INCLUDE[win81](../vs140/includes/win81_md.md)] SDK is installed at HKLM\Software\Microsoft\Microsoft SDKs\Windows\v8.1.  
...
2.  ProductFamilyName: The overall SDK product name. For example, the [!INCLUDE[winjs_long](../vs140/includes/winjs_long_md.md)] SDK is named “Microsoft.WinJS.1.0” and “Microsoft.WinJS.2.0”, which belong to the same family of SDK products family, “Microsoft.WinJS”. This attribute allows Visual Studio and MSBuild to make that connection. If this attribute doesn’t exist, the SDK Name is used as the product family name.  
...
7.  AppliesTo: specifies the SDKs that are available in the Reference Manager by specifying applicable Visual Studio project types. Nine values are recognized: WindowsAppContainer, VisualC, VB, CSharp, WindowsXAML, JavaScript, Managed, and Native. The SDK author can use and (“+’), or (“&#124;”), not (“!”) operators to specify exactly the scope of project types that apply to the SDK.  
     ...
     WindowsAppContainer identifies projects for [!INCLUDE[win8_appname_long](../vs140/includes/win8_appname_long_md.md)] apps.  
  
8.  SupportPrefer32Bit: Supported values are “True” and “False”. The default is "True". If the value is set to “False”, MSBuild returns an error for [!INCLUDE[win8_appname_long](../vs140/includes/win8_appname_long_md.md)] projects (or a warning for desktop projects) if the project that references the SDK has Prefer32Bit enabled. For more information about Prefer32Bit, see [Build Page, Project Designer (C#)](../Topic/Build%20Page,%20Project%20Designer%20\(C%23\).md) or [Compile Page, Project Designer (Visual Basic)](../vs140/Compile-Page--Project-Designer--Visual-Basic-.md).  
...
## See Also  
 [Walkthrough: Creating an  SDK using C++](../Topic/Walkthrough:%20Creating%20an%20SDK%20using%20C++.md)   
 [Walkthrough: Creating an  SDK using C#](../vs140/Walkthrough--Creating-an-SDK-using-C#-or-Visual-Basic.md)   
