...
With the Store Viewer, you can examine the state of a *store* used by [!INCLUDE[dsl](../vs140/includes/dsl_md.md)]. The Store Viewer displays all of the domain model elements that are in a specific store, along with element properties and links between elements.  
  
## Opening Store Viewer  
 When you are in the [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)] experimental build, stop your code at a breakpoint where an instance of the store contains model information. Then, open the Store Viewer by typing the following command in the **Immediate** window:  
...
### Using Store Viewer  
 ...
 ![](../vs140/media/storeviewer2.png "storeviewer2")  
Store Viewer  
