...
## Shifts and Promotions  
 The expressions on both sides of a shift operator must be integral types. Integral promotions are performed according to the rules described in [Integral Promotions](../vs140/Integral-Promotions.md). The type of the result is the same as the type of the promoted `shift-expression`.  
