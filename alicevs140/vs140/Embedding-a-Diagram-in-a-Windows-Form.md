...
1.  In the form designer, add a **ListBox** named `listBox1`. This will display a list of the elements in the model. It will be kept in synchronism with the model using *store events*. For more information, see [Event Handlers Propagate Changes Outside the Model](../Topic/Event%20Handlers%20Propagate%20Changes%20Outside%20the%20Model.md).  
