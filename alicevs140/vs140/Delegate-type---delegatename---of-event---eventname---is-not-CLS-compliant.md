...
An [Event Statement](../vs140/Event-Statement.md) uses a delegate to specify its signature, but the [Delegate Statement](../vs140/Delegate-Statement.md) is marked as `<CLSCompliant(False)>` or is not marked.  
