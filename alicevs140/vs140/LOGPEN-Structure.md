...
---
# LOGPEN Structure
The `LOGPEN` structure defines the style, width, and color of a pen, a drawing object used to draw lines and borders. The [CPen::CreatePenIndirect](../vs140/CPen--CreatePenIndirect.md) function uses the `LOGPEN` structure.  
...
## Remarks  
 The **y** value in the [POINT](../vs140/POINT-Structure.md) structure for the **lopnWidth** member is not used.  
