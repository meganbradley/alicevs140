...
## How to Fix Violations  
 To investigate the kinds of system calls that your application makes, run the profile again and select the option to gather samples based on system calls. See [How to: Choose Sampling Events](../vs140/How-to--Choose-Sampling-Events.md) if you are running the profiling tools inside the IDE for more information. If you are running the profiling tools from the command line, see the **Sampling Interval Options** section of the [VSPerfCmd](../vs140/VSPerfCmd.md) topic in the Profiling Tools command line tools reference.