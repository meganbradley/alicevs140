...
|[join::reserve_message Method](#join__reserve_message_method)|Reserves a message previously offered by this                                         `join` messaging block. (Overrides                                         [source_block::reserve_message](../vs140/source_block-Class.md#source_block__reserve_message_method).)|  
