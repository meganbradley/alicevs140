...
In C#, a method in a derived class can have the same name as a method in the base class. You can specify how the methods interact by using the [new](../vs140/new--C#-Reference-.md) and [override](../vs140/override--C#-Reference-.md) keywords. The `override` modifier *extends* the base class method, and the `new` modifier *hides* it. The difference is illustrated in the examples in this topic.  
...
```  
 ...
 Run the program again to verify that the output has not changed. Also verify that the warning no longer appears. By using `new`, you are asserting that you are aware that the member that it modifies hides a member that is inherited from the base class. For more information about name hiding through inheritance, see [new Modifier (C# Reference)](../vs140/new-Modifier--C#-Reference-.md).  
...
## See Also  
 ...
 [Versioning with the Override and New Keywords (C#)](../vs140/Versioning-with-the-Override-and-New-Keywords--C#-Programming-Guide-.md)   
 [base (C# Reference)](../vs140/base--C#-Reference-.md)   
 [abstract (C# Reference)](../vs140/abstract--C#-Reference-.md)