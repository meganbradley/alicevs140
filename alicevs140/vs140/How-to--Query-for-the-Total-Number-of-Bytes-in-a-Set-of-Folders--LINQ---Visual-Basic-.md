...
## Example  
 The <xref:System.Linq.Enumerable.Sum?qualifyHint=False> method adds the values of all the items selected in the `select` clause. You can easily modify this query to retrieve the biggest or smallest file in the specified directory tree by calling the <xref:System.Linq.Enumerable.Min``1?qualifyHint=False> or <xref:System.Linq.Enumerable.Max``1?qualifyHint=False> method instead of <xref:System.Linq.Enumerable.Sum?qualifyHint=False>.  
