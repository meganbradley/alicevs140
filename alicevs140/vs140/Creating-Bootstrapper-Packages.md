...
## Creating Custom Packages  
 You can generate the manifests by using the XML Editor in Visual Studio. For more information, see [How to: Create a Product Manifest](../vs140/How-to--Create-a-Package-Manifest.md) and [How to: Create a Package Manifest](../vs140/How-to--Create-a-Product-Manifest.md). To see an example of creating a bootstrapper package, see [Walkthrough: Creating a Custom Bootstrapper to Show a Privacy Prompt](../vs140/Walkthrough--Creating-a-Custom-Bootstrapper-to-Show-a-Privacy-Prompt.md).  
...
-   The package manifest, package.xml, which contains language-specific metadata; it typically contains localized error messages. A component must have at least one package manifest for each localized version of that component.  
 ...
 Finally, copy the redistributable files into the bootstrapper folder location. For more information, see [How to: Create a Localized Bootstrapper Package](../vs140/How-to--Create-a-Localized-Bootstrapper-Package.md).  
