...
-   Enable validation for the DSL. In DSL Explorer, select Editor\Validation, and set the **Uses...** properties to `true`.  
     ...
     For more information, see [Validation](../Topic/Validation%20in%20a%20Domain-Specific%20Language.md).  
...
## See Also  
 [How to navigate and update a model](../Topic/Navigating%20and%20Updating%20a%20Model%20in%20Program%20Code.md)   
