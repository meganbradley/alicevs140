...
-   Defining a class with a method that can be called by the <xref:System.ComponentModel.BackgroundWorker?qualifyHint=False> component.  
  
-   Handling events raised by the <xref:System.ComponentModel.BackgroundWorker?qualifyHint=False> component.  
  
-   Starting a <xref:System.ComponentModel.BackgroundWorker?qualifyHint=False> component to run a method.  
  
-   Implementing a `Cancel` button that stops the <xref:System.ComponentModel.BackgroundWorker?qualifyHint=False> component.  
...
1.  Add a <xref:System.ComponentModel.BackgroundWorker?qualifyHint=False> component from the **Components** section of the **ToolBox** to the form. It will appear in the form's component tray.  
...
## See Also  
 ...
 [How To: Subscribe To and Unsubscribe from Events (C# Programming Guide)](../Topic/How%20to:%20Subscribe%20to%20and%20Unsubscribe%20from%20Events%20\(C%23%20Programming%20Guide\).md)