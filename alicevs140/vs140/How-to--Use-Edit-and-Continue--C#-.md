...
2.  From the **Debug** menu, click **Continue**, **Step**, or **Set Next Statement** or evaluate a function in a debugger window.  
     ...
     The new code is compiled and the debugging continues with the new code. Some changes are not supported by Edit and Continue. For more information, see [Supported Code Changes (C#)](../vs140/Supported-Code-Changes--C#-.md).  
...
## See Also  
 ...
 [Supported Code Changes (C#)](../vs140/Supported-Code-Changes--C#-.md)   
 [Edit and Continue Errors and Warnings (C#)](../vs140/Edit-and-Continue-Errors-and-Warnings--C#-.md)