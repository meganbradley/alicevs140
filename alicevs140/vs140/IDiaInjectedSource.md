...
## Example  
 This example displays the data available from the `IDiaInjectedSource` interface. For an alternative approach using the [IDiaPropertyStorage](../vs140/IDiaPropertyStorage.md) interface, see the example in the [IDiaEnumInjectedSources](../vs140/IDiaEnumInjectedSources.md) interface.  
