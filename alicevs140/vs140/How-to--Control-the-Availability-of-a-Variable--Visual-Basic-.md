...
1.  Place the [Dim Statement](../Topic/Dim%20Statement%20\(Visual%20Basic\).md) for the variable inside the module, class, or structure, but outside any procedure.  
...
2.  Include the [Friend](../Topic/Friend%20\(Visual%20Basic\).md) keyword in the `Dim` statement.  
