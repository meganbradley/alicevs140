...
2.  On the **Standard** toolbar, select one of the emulator options.  
     ...
     ![List of Windows Phone Emulator images](../vs140/media/WP_Emulator_list.png "WP_Emulator_list")  
...
###  <a name="BKMK_depltool"></a> Run an app with the Application Deployment tool  
 ...
 For more info, see [Deploy Windows Phone apps with the Application Deployment tool](assetId:///23700f82-1399-44d9-bc0c-714be4a48ee6).  
...
3.  The right image displays the emulator screen after tapping the **Volume Up** button to increase the volume.  
 ...
 ![Buttons on the Windows Phone emulator](../vs140/media/WP_Emulator_buttons.png "WP_Emulator_buttons")  
...
-   Click **Delete** to delete a snapshot that you no longer need.  
 ...
 ![Checkpoints tab of the Windows Phone Emulator](../vs140/media/WP_Emulator_checkpoints.png "WP_Emulator_checkpoints")  
...
##  <a name="BKMK_tasks_shot"></a> Capture screenshots in the emulator  
 ...
 ![Screenshots from the Windows Phone Emulator](../vs140/media/WP_Emulator_screenshots.png "WP_Emulator_screenshots")  
