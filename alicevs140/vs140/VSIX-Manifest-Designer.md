...
Modifies a VSIX package manifest file, which sets the installation behavior for a Visual Studio extension.  
 ...
 The **VSIX Manifest Designer** maps to the underlying VSIX schema. Every element in the schema can be set by using a corresponding control in the designer. For more information about the schema, see [VSIX Extension Schema 2.0 Reference](../Topic/VSIX%20Extension%20Schema%202.0%20Reference.md).  
...
## See Also  
 [VSIX Extension Schema 2.0 Reference](../Topic/VSIX%20Extension%20Schema%202.0%20Reference.md)   
