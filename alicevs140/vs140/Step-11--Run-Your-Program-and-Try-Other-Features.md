...
2.  Before you open a picture, choose the **Set the background color** button. The **Color** dialog box opens.  
     ...
     ![Color dialog box](../vs140/media/Express_ColorDialog.png "Express_ColorDialog")  
Color dialog box  
...
-   To learn more about programming in Visual Studio, see [Programming Concepts](../vs140/Programming-Concepts.md).  
  
-   To learn more about Visual Basic, see [Developing Applications with Visual Basic](../vs140/Developing-Applications-with-Visual-Basic.md).  
  
-   To learn more about Visual C#, see [Introduction to the C# Language and the .NET Framework](../vs140/Introduction-to-the-C#-Language-and-the-.NET-Framework.md).  
  
-   To go to the next tutorial, see [Tutorial 2: Create a Math Quiz](../vs140/Tutorial-2--Create-a-Timed-Math-Quiz.md).  
  
-   To return to the previous tutorial step, see [Step 10: Create Additional Buttons and a Check Box](../vs140/Step-10--Write-Code-for-Additional-Buttons-and-a-Check-Box.md).