...
-   LIBPATH, which specifies directories to search for metadata files referenced with [#using](../vs140/#using-Directive--C---.md). See `#using` for more information on LIBPATH.  
