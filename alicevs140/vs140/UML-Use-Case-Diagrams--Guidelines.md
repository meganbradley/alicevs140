...
-   Create **Actors** to represent classes of people, organizations, other systems, software or devices that interact with your system or subsystem.  
    ...
    -   To learn how to draw actors and other elements, see [How to: Draw Modeling Diagrams](../vs140/Edit-UML-models-and-diagrams.md).  
...
### Inheritance between Actors  
 ![Use case diagram showing inheritance](../vs140/media/UML_UCGuideInherit.png "UML_UCGuideInherit")  
...
### Multiplicities between Actors and Use Cases  
 ...
 ![Use case one to one with actor](../vs140/media/UML_UCGuideMulti1.png "UML_UCGuideMulti1")  
...
>  The multiplicities of an association on a use case diagram are hidden if they are both **1**.  
 ...
 ![Use case showing many to many multiplicity](../vs140/media/UML_UCGuideMulti2.png "UML_UCGuideMulti2")  
...
-   Link the use case to another diagram or diagrams in the project.  
    ...
    -   An activity diagram helps you explain a more complex process where there are loops, branches and parallel threads. It can also show the flow of data between parts of the process. For more information, see [Activity Diagrams: Guidelines](../vs140/UML-Activity-Diagrams--Guidelines.md).  
  
    -   A sequence diagram helps you explain a complex series of interactions between different actors. You can also use it to show what happens inside the system in response to each use case. For more information, see [Sequence Diagrams: Guidelines](../vs140/UML-Sequence-Diagrams--Guidelines.md).  
  
-   Link the use case to a OneNote page, section, or paragraph that describes the use case in detail.  
  
-   Link the use case to a Word document, in which you use text, screen shots, and so on to describe the use case's scenarios. For more information, see [Clarifying User Requirements](../vs140/Model-user-requirements.md).  
...
### Linking use cases to work items  
 If your project uses [!INCLUDE[vstsTfsRosarioLong](../vs140/includes/vstsTfsRosarioLong_md.md)] and you have [!INCLUDE[esprtfc](../vs140/includes/esprtfc_md.md)], you can link each use case to a work item in [!INCLUDE[esprfound](../vs140/includes/esprfound_md.md)]. To learn how to make these links, see [How to: Link Work Items to Model Elements](../vs140/Link-model-elements-and-work-items.md).  
...
>  You should not make loops of include relationships that result in a use case including itself. Loops can generate errors.  
 ...
 ![Use cases decomposed with include](../vs140/media/UML_UCGuideInclude.png "UML_UCGuideInclude")  
...
-   The actions in the activity diagram have the same names as the included use cases.  
 ...
 For more information, see [Activity Diagrams: Guidelines](../vs140/UML-Activity-Diagrams--Guidelines.md).  
  
 ![Use case steps shown in linked activity diagram](../vs140/media/UML_UCGuideSteps.png "UML_UCGuideSteps")  
...
###  <a name="Inheritance"></a> Sharing goals with Generalization  
 ...
 ![Use cases showing the generalization relation](../vs140/media/UML_UCGuideGeneral.png "UML_UCGuideGeneral")  
...
###  <a name="Extend"></a> Separating variant cases with Extend  
 ...
 ![One use case extending another](../vs140/media/UML_UCGuideExtend.png "UML_UCGuideExtend")  
...
### System versions  
 ...
 ![Subsystems show different versions of a system](../vs140/media/UML_UCGuideSystem.png "UML_UCGuideSystem")  
  
## See Also  
 [Clarifying User Requirements](../vs140/Model-user-requirements.md)   
 [Sequence Diagrams; Guidelines for Drawing](../vs140/UML-Sequence-Diagrams--Guidelines.md)   
 ...
 [Activity Diagrams: Overview](../vs140/UML-Activity-Diagrams--Guidelines.md)   
