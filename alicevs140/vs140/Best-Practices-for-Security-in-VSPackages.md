...
To install the [!INCLUDE[vsipsdk](../vs140/includes/vsipsdk_md.md)] on your computer, you must be running in a context with administrative credentials. The basic unit of security and deployment of a [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)] application is the [VSPackage](../vs140/VSPackages.md). A VSPackage must be registered by using [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)], which also requires administrative credentials.  
...
## See Also  
 [Add-In Security](assetId:///44a5c651-6246-4310-b371-65378917c799)   
 [DDEX Security](assetId:///44a52a70-5c98-450e-993d-4a3b32f69ba8)