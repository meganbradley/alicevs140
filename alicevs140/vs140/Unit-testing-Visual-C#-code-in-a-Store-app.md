...
6.  Open UnitTest1.cs in the Visual Studio editor.  
    ...
    3.  You can define special methods that are invoked before and after each module, class, or method. For more information, see [Using Microsoft.VisualStudio.TestTools.UnitTesting members in unit tests](../Topic/Using%20Microsoft.VisualStudio.TestTools.UnitTesting%20Members%20in%20Unit%20Tests.md) in the MSDN Library.  
