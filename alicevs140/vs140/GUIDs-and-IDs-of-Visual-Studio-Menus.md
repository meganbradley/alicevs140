...
This topic enumerates the GUID and ID values of the menus and groups on the Visual Studio menu bar. These values are defined in .vsct files that are installed as part of the Visual Studio SDK. For more information, see [IDE-Defined Menus, Groups, and Commands](../vs140/IDE-Defined-Commands--Menus--and-Groups.md).  
  
 For more information about how to work with integrated development environment (IDE) objects that are defined in .vsct files, see [Common Menu Tasks](../vs140/Extending-Menus-and-Commands.md).  
