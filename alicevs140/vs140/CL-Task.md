...
---
# CL Task
Wraps the Visual C++ compiler tool, cl.exe. The compiler produces executable (.exe) files, dynamic-link library (.dll) files, or code module (.netmodule) files. For more information, see [Compiler Options](../vs140/Compiler-Options.md).  
...
-   **AdditionalIncludeDirectories**  
     ...
     For more information, see [/I (Additional Include Directories)](../vs140/-I--Additional-Include-Directories-.md).  
...
-   **BasicRuntimeChecks**  
     ...
     Enables and disables the run-time error checks feature, in conjunction with the [runtime_checks](../vs140/runtime_checks.md) pragma.  
...
-   **BrowseInformation**  
     ...
     For more information, see the **/FR** option in [/FR, /Fr (Create .sbr File)](../vs140/-FR---Fr--Create-.Sbr-File-.md).  
...
-   **BrowseInformationFile**  
     ...
     For more information, see the **BrowseInformation** parameter in this table, and also see [/FR, /Fr (Create .sbr File)](../vs140/-FR---Fr--Create-.Sbr-File-.md).  
...
-   **CallingConvention**  
    ...
    -   **StdCall** -                          **/Gz**  
     ...
     For more information, see [/Gd, /Gr, /Gz (Calling Convention)](../Topic/-Gd,%20-Gr,%20-Gv,%20-Gz%20(Calling%20Convention).md).  
...
-   **CompileAs**  
    ...
    -   **CompileAsCpp** - **/TP**  
     ...
     For more information, see [/Tc, /Tp, /TC, /TP (Specify Source File Type)](../vs140/-Tc---Tp---TC---TP--Specify-Source-File-Type-.md).  
...
-   **DebugInformationFormat**  
    ...
    -   **EditAndContinue** - **/ZI**  
     ...
     For more information, see [/Z7, /Zi, /ZI (Debug Information Format)](../vs140/-Z7---Zi---ZI--Debug-Information-Format-.md).  
...
-   **DisableSpecificWarnings**  
     ...
     For more information, see the `/wd` option in [/w, /Wn, /WX, /Wall, /wln, /wdn, /wen, /won (Warning Level)](../Topic/-w,%20-W0,%20-W1,%20-W2,%20-W3,%20-W4,%20-w1,%20-w2,%20-w3,%20-w4,%20-Wall,%20-wd,%20-we,%20-wo,%20-Wv,%20-WX%20\(Warning%20Level\).md).  
...
-   **EnableEnhancedInstructionSet**  
    ...
    -   **StreamingSIMDExtensions2** - **/arch:SSE2**  
     ...
     For more information, see [/arch (Minimum CPU Architecture)](../vs140/-arch--x86-.md).  
...
-   **EnableFiberSafeOptimizations**  
     ...
     For more information, see [/GT (Support Fiber-Safe Thread-Local Storage)](../vs140/-GT--Support-Fiber-Safe-Thread-Local-Storage-.md).  
...
-   **EnablePREfast**  
     ...
     For more information, see [/analyze (Enterprise Code Analysis)](../Topic/-analyze%20\(Code%20Analysis\).md).  
...
-   **ErrorReporting**  
    ...
    -   **Send** - **/errorReport:send**  
     ...
     For more information, see [/errorReport (Report Internal Compiler Errors)](../vs140/-errorReport--Report-Internal-Compiler-Errors-.md).  
...
-   **ExceptionHandling**  
    ...
    -   **SyncCThrow** - **/EHs**  
     ...
     For more information, see [/EH (Exception Handling Model)](../vs140/-EH--Exception-Handling-Model-.md).  
...
-   **ExpandAttributedSource**  
     ...
     For more information, see [/Fx (Merge Injected Code)](../vs140/-Fx--Merge-Injected-Code-.md).  
...
-   **FavorSizeOrSpeed**  
    ...
    -   **Speed** - **/Ot**  
     ...
     For more information, see [/Os, /Ot (Favor Small Code, Favor Fast Code)](../vs140/-Os---Ot--Favor-Small-Code--Favor-Fast-Code-.md).  
...
-   **ForceConformanceInForLoopScope**  
     ...
     If `true`, implements standard C++ behavior in [for](../vs140/for-Statement--C---.md) loops that use Microsoft extensions ([/Ze](../Topic/-Za,%20-Ze%20\(Disable%20Language%20Extensions\).md)).  
...
-   **ForcedUsingFiles**  
     ...
     For more information, see [/FU (Name Forced #using File)](../vs140/-FU--Name-Forced-#using-File-.md).  
...
-   **FunctionLevelLinking**  
     ...
     For more information, see [/Gy (Enable Function-Level Linking)](../vs140/-Gy--Enable-Function-Level-Linking-.md).  
...
-   **IgnoreStandardIncludePath**  
     ...
     For more information, see [/X (Ignore Standard Include Paths)](../vs140/-X--Ignore-Standard-Include-Paths-.md).  
...
-   **IntrinsicFunctions**  
     ...
     For more information, see [/Oi (Generate Intrinsic Functions)](../vs140/-Oi--Generate-Intrinsic-Functions-.md).  
...
-   **MinimalRebuild**  
     ...
     For more information, see [/Gm (Enable Minimal Rebuild)](../vs140/-Gm--Enable-Minimal-Rebuild-.md).  
...
-   **MultiProcessorCompilation**  
     ...
     For more information, see [/MP (Build with Multiple Processes)](../vs140/-MP--Build-with-Multiple-Processes-.md). Also, see the **ProcessorNumber** parameter in this table.  
...
-   **OmitDefaultLibName**  
     ...
     For more information, see [/Zl (Omit Default Library Name)](../vs140/-Zl--Omit-Default-Library-Name-.md).  
...
-   **Optimization**  
    ...
    -   **Full** - **/Ox**  
     ...
     For more information, see [/O Options (Optimize Code)](../vs140/-O-Options--Optimize-Code-.md).  
...
-   **PrecompiledHeader**  
    ...
    -   **Use** - **/Yu**  
     ...
     For more information, see [/Yc (Create Precompiled Header File)](../vs140/-Yc--Create-Precompiled-Header-File-.md) and [/Yu (Use Precompiled Header File)](../vs140/-Yu--Use-Precompiled-Header-File-.md). Also, see the **PrecompiledHeaderFile** and **PrecompiledHeaderOutputFile** parameters in this table.  
...
-   **PrecompiledHeaderFile**  
     ...
     For more information, see [/Yc (Create Precompiled Header File)](../vs140/-Yc--Create-Precompiled-Header-File-.md) and [/Yu (Use Precompiled Header File)](../vs140/-Yu--Use-Precompiled-Header-File-.md).  
...
-   **PreprocessKeepComments**  
     ...
     For more information, see [/C (Preserve Comments During Preprocessing)](../vs140/-C--Preserve-Comments-During-Preprocessing-.md).  
...
-   **PreprocessOutputPath**  
     ...
     For more information, see [/Fi (Preprocess Output File Name)](../vs140/-Fi--Preprocess-Output-File-Name-.md).  
...
-   **PreprocessSuppressLineNumbers**  
     ...
     For more information, see [/EP (Preprocess to stdout Without #line Directives)](../vs140/-EP--Preprocess-to-stdout-Without-#line-Directives-.md).  
...
-   **PreprocessToFile**  
     ...
     For more information, see [/P (Preprocess to a File)](../vs140/-P--Preprocess-to-a-File-.md).  
...
-   **ProgramDataBaseFileName**  
     ...
     For more information, see [/Fd (Program Database File Name)](../vs140/-Fd--Program-Database-File-Name-.md).  
...
-   **SuppressStartupBanner**  
     ...
     For more information, see [/nologo (Suppress Startup Banner) (C/C++)](../vs140/-nologo--Suppress-Startup-Banner---C-C---.md).  
...
-   **TreatSpecificWarningsAsErrors**  
     ...
     For more information, see the **/we**`n` option in [/w, /Wn, /WX, /Wall, /wln, /wdn, /wen, /won (Warning Level)](../Topic/-w,%20-W0,%20-W1,%20-W2,%20-W3,%20-W4,%20-w1,%20-w2,%20-w3,%20-w4,%20-Wall,%20-wd,%20-we,%20-wo,%20-Wv,%20-WX%20\(Warning%20Level\).md).  
...
-   **TreatWarningAsError**  
     ...
     For more information, see **/WX** option in [/w, /Wn, /WX, /Wall, /wln, /wdn, /wen, /won (Warning Level)](../Topic/-w,%20-W0,%20-W1,%20-W2,%20-W3,%20-W4,%20-w1,%20-w2,%20-w3,%20-w4,%20-Wall,%20-wd,%20-we,%20-wo,%20-Wv,%20-WX%20\(Warning%20Level\).md).  
...
-   **UndefineAllPreprocessorDefinitions**  
     ...
     For more information, see the **/u** option in [/U, /u (Undefine Symbols)](../vs140/-U---u--Undefine-Symbols-.md).  
...
-   **UndefinePreprocessorDefinitions**  
     ...
     For more information, see **/U** option in [/U, /u (Undefine Symbols)](../vs140/-U---u--Undefine-Symbols-.md).  
...
-   **WarningLevel**  
    ...
    -   **EnableAllWarnings** - **/Wall**  
     ...
     For more information, see the **/W***n* option in [/w, /Wn, /WX, /Wall, /wln, /wdn, /wen, /won (Warning Level)](../Topic/-w,%20-W0,%20-W1,%20-W2,%20-W3,%20-W4,%20-w1,%20-w2,%20-w3,%20-w4,%20-Wall,%20-wd,%20-we,%20-wo,%20-Wv,%20-WX%20(Warning%20Level).md).  
