...
#### Parameters  
 ...
 `symtag`  
 [in] Specifies the symbol tag of the children to be retrieved. Values are taken from the [SymTagEnum Enumeration](../vs140/SymTagEnum.md) enumeration. Set to `SymTagNull` to retrieve all children.  
